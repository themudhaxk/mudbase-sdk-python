...
with mudbase.ApiClient(configuration) as api_client:
    ...
    project_id = 'project_id_example' # str | 
    function_id = 'function_id_example' # str | 
    simulate_function_trigger_request = {"trigger":{"type":"document","event":"create"},"eventContext":{"document":{"_id":"83b4c5d6e7f8a9b0c1d2e3f4","collectionId":"74a2b3c4d5e6f7a8b9c0d1e2","data":{"name":"John","email":"john@example.com"}}}} # SimulateFunctionTriggerRequest |  (optional)
