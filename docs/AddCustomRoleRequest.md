...
**default_permissions** | [**List[AddCustomRoleRequestDefaultPermissionsInner]**](AddCustomRoleRequestDefaultPermissionsInner.md) | Optional global/base permissions. For collection-level CRUD use &#x60;collectionPermissions&#x60;. | [optional] 
**collection_permissions** | [**Dict[str, CreateRoleRequestCollectionPermissionsValue]**](CreateRoleRequestCollectionPermissionsValue.md) | Per-collection CRUD map (collection slug &#x3D;&gt; actions or {actions,conditions}). | [optional] 
...
add_custom_role_request_instance = AddCustomRoleRequest.from_json(json)
# print the JSON string representation of the object
print(AddCustomRoleRequest.to_json())

# convert the object into a dict
add_custom_role_request_dict = add_custom_role_request_instance.to_dict()
# create an instance of AddCustomRoleRequest from a dict
add_custom_role_request_from_dict = AddCustomRoleRequest.from_dict(add_custom_role_request_dict)
```
