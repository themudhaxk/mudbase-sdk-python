...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    confirm_local_password_reset_with_otp_request = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","otp":"123456","newPassword":"NewSecurePass123!"} # ConfirmLocalPasswordResetWithOtpRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    create_anonymous_session_request = {"projectId":"65f1a2b3c4d5e6f7a8b9c0d1","deviceId":"device-uuid-123"} # CreateAnonymousSessionRequest |  (optional)
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    login_local_user_request = {"email":"sarah.chen@example.com","password":"SecurePass123!","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"} # LoginLocalUserRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    register_local_user_request = {"email":"sarah.chen@example.com","password":"SecurePass123!","firstName":"Sarah","lastName":"Chen","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"} # RegisterLocalUserRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    request_local_password_reset_request = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"} # RequestLocalPasswordResetRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    ...
    reset_local_password_request = {"password":"NewSecurePass123!","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"} # ResetLocalPasswordRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    magic_link_request = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","redirectUrl":"https://app.example.com/auth/callback"} # MagicLinkRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    otp_send_request = {"email":"user@example.com","projectId":"65f1a2b3c4d5e6f7a8b9c0d1","method":"email"} # OTPSendRequest | 
...
with mudbase.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mudbase.AuthenticationApi(api_client)
    otp_verify_request = {"identifier":"user@example.com","otp":"123456","projectId":"65f1a2b3c4d5e6f7a8b9c0d1"} # OTPVerifyRequest | 
