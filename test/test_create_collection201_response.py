...
class TestCreateCollection201Response(unittest.TestCase):
    """CreateCollection201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCollection201Response:
        """Test CreateCollection201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCollection201Response`
        """
        model = CreateCollection201Response()
        if include_optional:
            return CreateCollection201Response(
                message = '',
                collection = mudbase.models.collection.Collection(
                    _id = '', 
                    name = '', 
                    slug = '', 
                    project = '', 
                    fields = [
                        mudbase.models.field.Field(
                            name = '', 
                            type = 'string', 
                            required = True, 
                            unique = True, 
                            default = null, 
                            validation = mudbase.models.validation.validation(), 
                            ui = mudbase.models.ui.ui(), )
                        ], 
                    permissions = [
                        mudbase.models.permission.Permission(
                            role = '', 
                            actions = [
                                'create'
                                ], 
                            condition = mudbase.models.condition.condition(), )
                        ], 
    ...
    def testCreateCollection201Response(self):
        """Test CreateCollection201Response"""
