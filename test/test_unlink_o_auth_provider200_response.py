...
class TestUnlinkOAuthProvider200Response(unittest.TestCase):
    """UnlinkOAuthProvider200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnlinkOAuthProvider200Response:
        """Test UnlinkOAuthProvider200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnlinkOAuthProvider200Response`
        """
        model = UnlinkOAuthProvider200Response()
        if include_optional:
    ...
    def testUnlinkOAuthProvider200Response(self):
        """Test UnlinkOAuthProvider200Response"""
