...
class TestHealthResponseServices(unittest.TestCase):
    """HealthResponseServices unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthResponseServices:
        """Test HealthResponseServices
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthResponseServices`
        """
        model = HealthResponseServices()
        if include_optional:
            return HealthResponseServices(
                database = '',
                redis = '',
                storage = '',
                email = '',
    ...
    def testHealthResponseServices(self):
        """Test HealthResponseServices"""
