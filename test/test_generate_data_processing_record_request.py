...
class TestGenerateDataProcessingRecordRequest(unittest.TestCase):
    """GenerateDataProcessingRecordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateDataProcessingRecordRequest:
        """Test GenerateDataProcessingRecordRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateDataProcessingRecordRequest`
        """
        model = GenerateDataProcessingRecordRequest()
        if include_optional:
            return GenerateDataProcessingRecordRequest(
                org_id = '685acbe0e129932fbb7a0fc3',
                record_date = '2024-12-16T00:00Z'
            )
        else:
            return GenerateDataProcessingRecordRequest(
                org_id = '685acbe0e129932fbb7a0fc3',
    ...
    def testGenerateDataProcessingRecordRequest(self):
        """Test GenerateDataProcessingRecordRequest"""
