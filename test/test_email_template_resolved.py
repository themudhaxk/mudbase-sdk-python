...
class TestEmailTemplateResolved(unittest.TestCase):
    """EmailTemplateResolved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailTemplateResolved:
        """Test EmailTemplateResolved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailTemplateResolved`
        """
        model = EmailTemplateResolved()
        if include_optional:
            return EmailTemplateResolved(
                name = '',
                subject = '',
                html_body = '',
                text_body = '',
    ...
    def testEmailTemplateResolved(self):
        """Test EmailTemplateResolved"""
