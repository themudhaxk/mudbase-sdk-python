...
class TestCreateMonitoringAlertRequest(unittest.TestCase):
    """CreateMonitoringAlertRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMonitoringAlertRequest:
        """Test CreateMonitoringAlertRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMonitoringAlertRequest`
        """
        model = CreateMonitoringAlertRequest()
        if include_optional:
            return CreateMonitoringAlertRequest(
                name = '',
                condition = '',
                threshold = 1.337,
                action = '',
    ...
    def testCreateMonitoringAlertRequest(self):
        """Test CreateMonitoringAlertRequest"""
