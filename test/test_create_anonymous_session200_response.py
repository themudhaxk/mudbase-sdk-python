...
class TestCreateAnonymousSession200Response(unittest.TestCase):
    """CreateAnonymousSession200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnonymousSession200Response:
        """Test CreateAnonymousSession200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnonymousSession200Response`
        """
        model = CreateAnonymousSession200Response()
        if include_optional:
            return CreateAnonymousSession200Response(
                ...
                refresh_token = '',
                expires_in = 86400,
                user = mudbase.models.create_anonymous_session_200_response_user.createAnonymousSession_200_response_user(
                    id = '', 
                    email = '', 
                    first_name = '', 
                    last_name = '', 
    ...
    def testCreateAnonymousSession200Response(self):
        """Test CreateAnonymousSession200Response"""
