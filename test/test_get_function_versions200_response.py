...
class TestGetFunctionVersions200Response(unittest.TestCase):
    """GetFunctionVersions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFunctionVersions200Response:
        """Test GetFunctionVersions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFunctionVersions200Response`
        """
        model = GetFunctionVersions200Response()
        if include_optional:
            return GetFunctionVersions200Response(
                success = True,
                data = mudbase.models.get_function_versions_200_response_data.getFunctionVersions_200_response_data(
                    versions = [
                        mudbase.models.get_function_versions_200_response_data_versions_inner.getFunctionVersions_200_response_data_versions_inner(
                            _id = '', 
                            code = '', 
                            version = 56, 
    ...
    def testGetFunctionVersions200Response(self):
        """Test GetFunctionVersions200Response"""
