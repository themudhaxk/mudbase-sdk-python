...
class TestOrgOAuthCallback400Response(unittest.TestCase):
    """OrgOAuthCallback400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgOAuthCallback400Response:
        """Test OrgOAuthCallback400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgOAuthCallback400Response`
        """
        model = OrgOAuthCallback400Response()
        if include_optional:
            return OrgOAuthCallback400Response(
    ...
    def testOrgOAuthCallback400Response(self):
        """Test OrgOAuthCallback400Response"""
