...
class TestGetPlans200Response(unittest.TestCase):
    """GetPlans200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPlans200Response:
        """Test GetPlans200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPlans200Response`
        """
        model = GetPlans200Response()
        if include_optional:
    ...
    def testGetPlans200Response(self):
        """Test GetPlans200Response"""
