...
class TestTestWebhookTransformation200ResponseData(unittest.TestCase):
    """TestWebhookTransformation200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestWebhookTransformation200ResponseData:
        """Test TestWebhookTransformation200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestWebhookTransformation200ResponseData`
        """
        model = TestWebhookTransformation200ResponseData()
        if include_optional:
            return TestWebhookTransformation200ResponseData(
                original = None,
                transformed = None
            )
        else:
    ...
    def testTestWebhookTransformation200ResponseData(self):
        """Test TestWebhookTransformation200ResponseData"""
