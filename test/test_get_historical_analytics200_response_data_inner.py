...
class TestGetHistoricalAnalytics200ResponseDataInner(unittest.TestCase):
    """GetHistoricalAnalytics200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetHistoricalAnalytics200ResponseDataInner:
        """Test GetHistoricalAnalytics200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHistoricalAnalytics200ResponseDataInner`
        """
        model = GetHistoricalAnalytics200ResponseDataInner()
        if include_optional:
            return GetHistoricalAnalytics200ResponseDataInner(
    ...
    def testGetHistoricalAnalytics200ResponseDataInner(self):
        """Test GetHistoricalAnalytics200ResponseDataInner"""
