...
class TestValidatePasswordResetTokenRequest(unittest.TestCase):
    """ValidatePasswordResetTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatePasswordResetTokenRequest:
        """Test ValidatePasswordResetTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatePasswordResetTokenRequest`
        """
        model = ValidatePasswordResetTokenRequest()
        if include_optional:
            return ValidatePasswordResetTokenRequest(
                token = ''
            )
        else:
            return ValidatePasswordResetTokenRequest(
    ...
    def testValidatePasswordResetTokenRequest(self):
        """Test ValidatePasswordResetTokenRequest"""
