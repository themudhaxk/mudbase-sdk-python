...
class TestOrgCustomDomainPlatformReadyRequest(unittest.TestCase):
    """OrgCustomDomainPlatformReadyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgCustomDomainPlatformReadyRequest:
        """Test OrgCustomDomainPlatformReadyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgCustomDomainPlatformReadyRequest`
        """
        model = OrgCustomDomainPlatformReadyRequest()
        if include_optional:
            return OrgCustomDomainPlatformReadyRequest(
                note = ''
            )
        else:
            return OrgCustomDomainPlatformReadyRequest(
    ...
    def testOrgCustomDomainPlatformReadyRequest(self):
        """Test OrgCustomDomainPlatformReadyRequest"""
