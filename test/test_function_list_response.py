...
class TestFunctionListResponse(unittest.TestCase):
    """FunctionListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionListResponse:
        """Test FunctionListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionListResponse`
        """
        model = FunctionListResponse()
        if include_optional:
            return FunctionListResponse(
                success = True,
                data = mudbase.models.function_list_response_data.FunctionListResponse_data(
                    functions = [
                        mudbase.models.function.Function(
                            _id = '', 
                            name = '', 
                            description = '', 
                            project_id = '', 
                            trigger = mudbase.models.function_trigger.FunctionTrigger(
                                ...
                                collection_id = '', 
                                bucket_id = '', ), 
                            stats = mudbase.models.function_stats.FunctionStats(
                                total_executions = 56, 
                                successful_executions = 56, 
                                failed_executions = 56, 
                                avg_execution_time = 1.337, 
                    ...
                    pagination = mudbase.models.pagination.Pagination(
                        page = 56, 
                        limit = 56, 
                        total = 56, 
                        total_pages = 56, ), )
    ...
    def testFunctionListResponse(self):
        """Test FunctionListResponse"""
