...
class TestCreateApiKey400Response(unittest.TestCase):
    """CreateApiKey400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateApiKey400Response:
        """Test CreateApiKey400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateApiKey400Response`
        """
        model = CreateApiKey400Response()
        if include_optional:
            return CreateApiKey400Response(
    ...
    def testCreateApiKey400Response(self):
        """Test CreateApiKey400Response"""
