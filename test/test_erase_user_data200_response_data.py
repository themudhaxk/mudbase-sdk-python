...
class TestEraseUserData200ResponseData(unittest.TestCase):
    """EraseUserData200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EraseUserData200ResponseData:
        """Test EraseUserData200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EraseUserData200ResponseData`
        """
        model = EraseUserData200ResponseData()
        if include_optional:
            return EraseUserData200ResponseData(
    ...
    def testEraseUserData200ResponseData(self):
        """Test EraseUserData200ResponseData"""
