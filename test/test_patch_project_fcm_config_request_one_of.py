...
class TestPatchProjectFcmConfigRequestOneOf(unittest.TestCase):
    """PatchProjectFcmConfigRequestOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchProjectFcmConfigRequestOneOf:
        """Test PatchProjectFcmConfigRequestOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchProjectFcmConfigRequestOneOf`
        """
        model = PatchProjectFcmConfigRequestOneOf()
        if include_optional:
            return PatchProjectFcmConfigRequestOneOf(
    ...
    def testPatchProjectFcmConfigRequestOneOf(self):
        """Test PatchProjectFcmConfigRequestOneOf"""
