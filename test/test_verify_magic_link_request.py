...
class TestVerifyMagicLinkRequest(unittest.TestCase):
    """VerifyMagicLinkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyMagicLinkRequest:
        """Test VerifyMagicLinkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyMagicLinkRequest`
        """
    ...
    def testVerifyMagicLinkRequest(self):
        """Test VerifyMagicLinkRequest"""
