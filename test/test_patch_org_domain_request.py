...
class TestPatchOrgDomainRequest(unittest.TestCase):
    """PatchOrgDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchOrgDomainRequest:
        """Test PatchOrgDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchOrgDomainRequest`
        """
        model = PatchOrgDomainRequest()
        if include_optional:
            return PatchOrgDomainRequest(
                status = 'pending',
    ...
    def testPatchOrgDomainRequest(self):
        """Test PatchOrgDomainRequest"""
