...
class TestInviteSubOrganizationMember200Response(unittest.TestCase):
    """InviteSubOrganizationMember200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteSubOrganizationMember200Response:
        """Test InviteSubOrganizationMember200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteSubOrganizationMember200Response`
        """
        model = InviteSubOrganizationMember200Response()
        if include_optional:
    ...
    def testInviteSubOrganizationMember200Response(self):
        """Test InviteSubOrganizationMember200Response"""
