...
class TestMonitoringAnalyticsResponseTotals(unittest.TestCase):
    """MonitoringAnalyticsResponseTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringAnalyticsResponseTotals:
        """Test MonitoringAnalyticsResponseTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringAnalyticsResponseTotals`
        """
        model = MonitoringAnalyticsResponseTotals()
        if include_optional:
            return MonitoringAnalyticsResponseTotals(
                total_api_calls = 56,
                total_db_reads = 56,
                total_db_writes = 56,
                total_storage = 56,
    ...
    def testMonitoringAnalyticsResponseTotals(self):
        """Test MonitoringAnalyticsResponseTotals"""
