...
class TestGetComplianceSummary200ResponseCompliance(unittest.TestCase):
    """GetComplianceSummary200ResponseCompliance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetComplianceSummary200ResponseCompliance:
        """Test GetComplianceSummary200ResponseCompliance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetComplianceSummary200ResponseCompliance`
        """
        model = GetComplianceSummary200ResponseCompliance()
        if include_optional:
            return GetComplianceSummary200ResponseCompliance(
    ...
    def testGetComplianceSummary200ResponseCompliance(self):
        """Test GetComplianceSummary200ResponseCompliance"""
