...
class TestGetProjectSmsByo200Response(unittest.TestCase):
    """GetProjectSmsByo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectSmsByo200Response:
        """Test GetProjectSmsByo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectSmsByo200Response`
        """
        model = GetProjectSmsByo200Response()
        if include_optional:
            return GetProjectSmsByo200Response(
                success = True,
                data = mudbase.models.project_sms_byo_public.ProjectSmsByoPublic(
                    enabled = True, 
                    provider = 'twilio', 
                    default_from = '', 
    ...
    def testGetProjectSmsByo200Response(self):
        """Test GetProjectSmsByo200Response"""
