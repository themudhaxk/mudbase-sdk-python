...
class TestGetComplianceSummary200ResponseComplianceGdpr(unittest.TestCase):
    """GetComplianceSummary200ResponseComplianceGdpr unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetComplianceSummary200ResponseComplianceGdpr:
        """Test GetComplianceSummary200ResponseComplianceGdpr
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetComplianceSummary200ResponseComplianceGdpr`
        """
        model = GetComplianceSummary200ResponseComplianceGdpr()
        if include_optional:
            return GetComplianceSummary200ResponseComplianceGdpr(
    ...
    def testGetComplianceSummary200ResponseComplianceGdpr(self):
        """Test GetComplianceSummary200ResponseComplianceGdpr"""
