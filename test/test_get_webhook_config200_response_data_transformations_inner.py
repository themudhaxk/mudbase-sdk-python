...
class TestGetWebhookConfig200ResponseDataTransformationsInner(unittest.TestCase):
    """GetWebhookConfig200ResponseDataTransformationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebhookConfig200ResponseDataTransformationsInner:
        """Test GetWebhookConfig200ResponseDataTransformationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebhookConfig200ResponseDataTransformationsInner`
        """
        model = GetWebhookConfig200ResponseDataTransformationsInner()
        if include_optional:
            return GetWebhookConfig200ResponseDataTransformationsInner(
                type = 'jsonPath',
                config = None
            )
        else:
    ...
    def testGetWebhookConfig200ResponseDataTransformationsInner(self):
        """Test GetWebhookConfig200ResponseDataTransformationsInner"""
