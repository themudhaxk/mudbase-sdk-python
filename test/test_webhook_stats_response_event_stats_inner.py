...
class TestWebhookStatsResponseEventStatsInner(unittest.TestCase):
    """WebhookStatsResponseEventStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookStatsResponseEventStatsInner:
        """Test WebhookStatsResponseEventStatsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookStatsResponseEventStatsInner`
        """
        model = WebhookStatsResponseEventStatsInner()
        if include_optional:
            return WebhookStatsResponseEventStatsInner(
                id = '',
                count = 56,
                success_rate = 1.337
            )
    ...
    def testWebhookStatsResponseEventStatsInner(self):
        """Test WebhookStatsResponseEventStatsInner"""
