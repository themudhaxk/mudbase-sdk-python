...
class TestDownloadInvoice200Response(unittest.TestCase):
    """DownloadInvoice200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadInvoice200Response:
        """Test DownloadInvoice200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownloadInvoice200Response`
        """
        model = DownloadInvoice200Response()
        if include_optional:
    ...
    def testDownloadInvoice200Response(self):
        """Test DownloadInvoice200Response"""
