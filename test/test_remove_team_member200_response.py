...
class TestRemoveTeamMember200Response(unittest.TestCase):
    """RemoveTeamMember200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveTeamMember200Response:
        """Test RemoveTeamMember200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveTeamMember200Response`
        """
        model = RemoveTeamMember200Response()
        if include_optional:
    ...
    def testRemoveTeamMember200Response(self):
        """Test RemoveTeamMember200Response"""
