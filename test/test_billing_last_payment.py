...
class TestBillingLastPayment(unittest.TestCase):
    """BillingLastPayment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingLastPayment:
        """Test BillingLastPayment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingLastPayment`
        """
        model = BillingLastPayment()
        if include_optional:
            return BillingLastPayment(
                amount = 1.337,
    ...
    def testBillingLastPayment(self):
        """Test BillingLastPayment"""
