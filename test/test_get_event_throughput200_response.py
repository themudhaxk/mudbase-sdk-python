...
class TestGetEventThroughput200Response(unittest.TestCase):
    """GetEventThroughput200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetEventThroughput200Response:
        """Test GetEventThroughput200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetEventThroughput200Response`
        """
        model = GetEventThroughput200Response()
        if include_optional:
    ...
    def testGetEventThroughput200Response(self):
        """Test GetEventThroughput200Response"""
