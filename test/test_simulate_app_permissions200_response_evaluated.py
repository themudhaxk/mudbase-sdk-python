...
class TestSimulateAppPermissions200ResponseEvaluated(unittest.TestCase):
    """SimulateAppPermissions200ResponseEvaluated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimulateAppPermissions200ResponseEvaluated:
        """Test SimulateAppPermissions200ResponseEvaluated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimulateAppPermissions200ResponseEvaluated`
        """
        model = SimulateAppPermissions200ResponseEvaluated()
        if include_optional:
            return SimulateAppPermissions200ResponseEvaluated(
                role = '',
                method = '',
                pathname = '',
                operation_id = '',
    ...
    def testSimulateAppPermissions200ResponseEvaluated(self):
        """Test SimulateAppPermissions200ResponseEvaluated"""
