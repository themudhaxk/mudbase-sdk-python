...
class TestOTPVerifyRequest(unittest.TestCase):
    """OTPVerifyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OTPVerifyRequest:
