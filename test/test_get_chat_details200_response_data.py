...
class TestGetChatDetails200ResponseData(unittest.TestCase):
    """GetChatDetails200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatDetails200ResponseData:
        """Test GetChatDetails200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChatDetails200ResponseData`
        """
        model = GetChatDetails200ResponseData()
        if include_optional:
            return GetChatDetails200ResponseData(
                id = '',
                name = '',
                participants = [
    ...
    def testGetChatDetails200ResponseData(self):
        """Test GetChatDetails200ResponseData"""
