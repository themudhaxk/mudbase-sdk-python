...
class TestGetActiveUsers200Response(unittest.TestCase):
    """GetActiveUsers200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetActiveUsers200Response:
        """Test GetActiveUsers200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetActiveUsers200Response`
        """
        model = GetActiveUsers200Response()
        if include_optional:
            return GetActiveUsers200Response(
                users = [
                    mudbase.models.get_active_users_200_response_users_inner.getActiveUsers_200_response_users_inner(
                        user_id = '', 
    ...
    def testGetActiveUsers200Response(self):
        """Test GetActiveUsers200Response"""
