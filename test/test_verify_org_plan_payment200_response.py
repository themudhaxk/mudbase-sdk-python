...
class TestVerifyOrgPlanPayment200Response(unittest.TestCase):
    """VerifyOrgPlanPayment200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyOrgPlanPayment200Response:
        """Test VerifyOrgPlanPayment200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyOrgPlanPayment200Response`
        """
        model = VerifyOrgPlanPayment200Response()
        if include_optional:
            return VerifyOrgPlanPayment200Response(
                success = True,
                message = '',
                data = mudbase.models.verify_org_plan_payment_200_response_data.verifyOrgPlanPayment_200_response_data(
                    plan = '', 
                    billing_cycle = '', 
                    org_id = '', )
            )
    ...
    def testVerifyOrgPlanPayment200Response(self):
        """Test VerifyOrgPlanPayment200Response"""
