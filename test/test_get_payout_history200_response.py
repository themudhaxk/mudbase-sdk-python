...
class TestGetPayoutHistory200Response(unittest.TestCase):
    """GetPayoutHistory200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPayoutHistory200Response:
        """Test GetPayoutHistory200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPayoutHistory200Response`
        """
        model = GetPayoutHistory200Response()
        if include_optional:
            return GetPayoutHistory200Response(
                success = True,
                data = [
                    mudbase.models.get_payout_history_200_response_data_inner.getPayoutHistory_200_response_data_inner(
                        _id = '', 
                        currency = '', 
                        gross_amount = 1.337, 
                        network_fee = 1.337, 
                ...
                pagination = mudbase.models.get_payout_history_200_response_pagination.getPayoutHistory_200_response_pagination(
                    page = 56, 
                    limit = 56, 
                    count = 56, 
                    total = 56, 
    ...
    def testGetPayoutHistory200Response(self):
        """Test GetPayoutHistory200Response"""
