...
class TestConfirmLocalPasswordResetWithOtpRequest(unittest.TestCase):
    """ConfirmLocalPasswordResetWithOtpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmLocalPasswordResetWithOtpRequest:
        """Test ConfirmLocalPasswordResetWithOtpRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmLocalPasswordResetWithOtpRequest`
        """
        model = ConfirmLocalPasswordResetWithOtpRequest()
        if include_optional:
            return ConfirmLocalPasswordResetWithOtpRequest(
    ...
    def testConfirmLocalPasswordResetWithOtpRequest(self):
        """Test ConfirmLocalPasswordResetWithOtpRequest"""
