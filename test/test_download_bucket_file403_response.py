...
class TestDownloadBucketFile403Response(unittest.TestCase):
    """DownloadBucketFile403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadBucketFile403Response:
        """Test DownloadBucketFile403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownloadBucketFile403Response`
        """
        model = DownloadBucketFile403Response()
        if include_optional:
            return DownloadBucketFile403Response(
    ...
    def testDownloadBucketFile403Response(self):
        """Test DownloadBucketFile403Response"""
