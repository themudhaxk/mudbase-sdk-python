...
class TestResendVerificationAuthRequest(unittest.TestCase):
    """ResendVerificationAuthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResendVerificationAuthRequest:
        """Test ResendVerificationAuthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResendVerificationAuthRequest`
        """
        model = ResendVerificationAuthRequest()
        if include_optional:
            return ResendVerificationAuthRequest(
                email = '',
                project_id = ''
            )
        else:
    ...
    def testResendVerificationAuthRequest(self):
        """Test ResendVerificationAuthRequest"""
