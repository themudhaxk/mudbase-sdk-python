...
class TestGetPermissionsMatrix200ResponseData(unittest.TestCase):
    """GetPermissionsMatrix200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPermissionsMatrix200ResponseData:
        """Test GetPermissionsMatrix200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPermissionsMatrix200ResponseData`
        """
        model = GetPermissionsMatrix200ResponseData()
        if include_optional:
            return GetPermissionsMatrix200ResponseData(
                collections = [
                    None
                    ],
                roles = [
    ...
    def testGetPermissionsMatrix200ResponseData(self):
        """Test GetPermissionsMatrix200ResponseData"""
