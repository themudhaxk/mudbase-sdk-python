...
class TestGetOverage200Response(unittest.TestCase):
    """GetOverage200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOverage200Response:
        """Test GetOverage200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOverage200Response`
        """
        model = GetOverage200Response()
        if include_optional:
            return GetOverage200Response(
                overage = [
                    mudbase.models.get_overage_200_response_overage_inner.getOverage_200_response_overage_inner(
                        resource = '', 
                        units = 1.337, 
                        amount = 1.337, 
                        currency = '', 
    ...
    def testGetOverage200Response(self):
        """Test GetOverage200Response"""
