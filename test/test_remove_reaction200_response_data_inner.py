...
class TestRemoveReaction200ResponseDataInner(unittest.TestCase):
    """RemoveReaction200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveReaction200ResponseDataInner:
        """Test RemoveReaction200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveReaction200ResponseDataInner`
        """
        model = RemoveReaction200ResponseDataInner()
        if include_optional:
            return RemoveReaction200ResponseDataInner(
                emoji = '',
                count = 56,
                users = [
                    ''
    ...
    def testRemoveReaction200ResponseDataInner(self):
        """Test RemoveReaction200ResponseDataInner"""
