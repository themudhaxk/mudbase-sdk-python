...
class TestApplyRoleFeaturePreset200Response(unittest.TestCase):
    """ApplyRoleFeaturePreset200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplyRoleFeaturePreset200Response:
        """Test ApplyRoleFeaturePreset200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyRoleFeaturePreset200Response`
        """
        model = ApplyRoleFeaturePreset200Response()
        if include_optional:
    ...
    def testApplyRoleFeaturePreset200Response(self):
        """Test ApplyRoleFeaturePreset200Response"""
