...
class TestRegisterWithRole201ResponseRole(unittest.TestCase):
    """RegisterWithRole201ResponseRole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterWithRole201ResponseRole:
        """Test RegisterWithRole201ResponseRole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterWithRole201ResponseRole`
        """
        model = RegisterWithRole201ResponseRole()
        if include_optional:
            return RegisterWithRole201ResponseRole(
                slug = '',
                name = '',
                description = ''
            )
    ...
    def testRegisterWithRole201ResponseRole(self):
        """Test RegisterWithRole201ResponseRole"""
