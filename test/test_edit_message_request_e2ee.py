...
class TestEditMessageRequestE2ee(unittest.TestCase):
    """EditMessageRequestE2ee unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageRequestE2ee:
        """Test EditMessageRequestE2ee
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageRequestE2ee`
        """
        model = EditMessageRequestE2ee()
        if include_optional:
            return EditMessageRequestE2ee(
                version = 56,
                scheme = '',
                ciphertext = '',
                nonce = '',
    ...
    def testEditMessageRequestE2ee(self):
        """Test EditMessageRequestE2ee"""
