...
class TestWebPushUnsubscribeResponse(unittest.TestCase):
    """WebPushUnsubscribeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushUnsubscribeResponse:
        """Test WebPushUnsubscribeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushUnsubscribeResponse`
        """
        model = WebPushUnsubscribeResponse()
        if include_optional:
            return WebPushUnsubscribeResponse(
                success = True,
                data = mudbase.models.web_push_unsubscribe_response_data.WebPushUnsubscribeResponse_data(
                    removed = True, )
            )
        else:
            return WebPushUnsubscribeResponse(
    ...
    def testWebPushUnsubscribeResponse(self):
        """Test WebPushUnsubscribeResponse"""
