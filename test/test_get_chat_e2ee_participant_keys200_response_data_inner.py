...
class TestGetChatE2eeParticipantKeys200ResponseDataInner(unittest.TestCase):
    """GetChatE2eeParticipantKeys200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatE2eeParticipantKeys200ResponseDataInner:
        """Test GetChatE2eeParticipantKeys200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChatE2eeParticipantKeys200ResponseDataInner`
        """
        model = GetChatE2eeParticipantKeys200ResponseDataInner()
        if include_optional:
            return GetChatE2eeParticipantKeys200ResponseDataInner(
                user_id = '',
                identity_public_key = '',
                key_version = 56,
    ...
    def testGetChatE2eeParticipantKeys200ResponseDataInner(self):
        """Test GetChatE2eeParticipantKeys200ResponseDataInner"""
