...
class TestMessageStatsResponseData(unittest.TestCase):
    """MessageStatsResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageStatsResponseData:
        """Test MessageStatsResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageStatsResponseData`
        """
        model = MessageStatsResponseData()
        if include_optional:
            return MessageStatsResponseData(
                total_messages = 56,
    ...
    def testMessageStatsResponseData(self):
        """Test MessageStatsResponseData"""
