...
class TestMonitoringPerformanceResponse(unittest.TestCase):
    """MonitoringPerformanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringPerformanceResponse:
        """Test MonitoringPerformanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringPerformanceResponse`
        """
        model = MonitoringPerformanceResponse()
        if include_optional:
            return MonitoringPerformanceResponse(
                period = '',
                metrics = mudbase.models.monitoring_performance_response_metrics.MonitoringPerformanceResponse_metrics(
                    total_requests = 56, 
                    avg_response_time = 1.337, 
                    min_response_time = 1.337, 
                    max_response_time = 1.337, 
                    error_count = 56, 
                    success_count = 56, 
                    success_rate = 1.337, 
                    error_rate = 1.337, 
    ...
    def testMonitoringPerformanceResponse(self):
        """Test MonitoringPerformanceResponse"""
