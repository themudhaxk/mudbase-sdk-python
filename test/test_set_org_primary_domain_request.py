...
class TestSetOrgPrimaryDomainRequest(unittest.TestCase):
    """SetOrgPrimaryDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetOrgPrimaryDomainRequest:
        """Test SetOrgPrimaryDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetOrgPrimaryDomainRequest`
        """
        model = SetOrgPrimaryDomainRequest()
        if include_optional:
            return SetOrgPrimaryDomainRequest(
                hostname = ''
            )
        else:
            return SetOrgPrimaryDomainRequest(
    ...
    def testSetOrgPrimaryDomainRequest(self):
        """Test SetOrgPrimaryDomainRequest"""
