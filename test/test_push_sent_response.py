...
class TestPushSentResponse(unittest.TestCase):
    """PushSentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushSentResponse:
        """Test PushSentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushSentResponse`
        """
        model = PushSentResponse()
        if include_optional:
            return PushSentResponse(
                success = True,
                data = mudbase.models.push_sent_response_data.PushSentResponse_data(
                    success = True, 
                    message_id = '', 
                    success_count = 56, 
                    failure_count = 56, 
                    channels = mudbase.models.push_sent_response_data_channels.PushSentResponse_data_channels(
                        fcm = mudbase.models.push_sent_response_data_channels_fcm.PushSentResponse_data_channels_fcm(
                            success_count = 56, 
                            failure_count = 56, ), 
                        web_push = mudbase.models.push_sent_response_data_channels_web_push.PushSentResponse_data_channels_webPush(
                            success_count = 56, 
                            failure_count = 56, 
                            pruned = 56, ), ), 
                    rejected_tokens = [
