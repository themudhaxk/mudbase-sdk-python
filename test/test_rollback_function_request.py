...
class TestRollbackFunctionRequest(unittest.TestCase):
    """RollbackFunctionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollbackFunctionRequest:
        """Test RollbackFunctionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollbackFunctionRequest`
        """
        model = RollbackFunctionRequest()
        if include_optional:
            return RollbackFunctionRequest(
                version = 56
            )
        else:
            return RollbackFunctionRequest(
    ...
    def testRollbackFunctionRequest(self):
        """Test RollbackFunctionRequest"""
