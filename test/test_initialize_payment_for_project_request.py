...
class TestInitializePaymentForProjectRequest(unittest.TestCase):
    """InitializePaymentForProjectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitializePaymentForProjectRequest:
        """Test InitializePaymentForProjectRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitializePaymentForProjectRequest`
        """
        model = InitializePaymentForProjectRequest()
        if include_optional:
            return InitializePaymentForProjectRequest(
                amount = 0.01,
                currency = 'USD',
                customer = mudbase.models.initialize_payment_request_customer.initializePayment_request_customer(
                    email = '', 
                    name = '', ),
                metadata = None
            )
    ...
    def testInitializePaymentForProjectRequest(self):
        """Test InitializePaymentForProjectRequest"""
