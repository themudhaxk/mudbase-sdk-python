...
class TestGetFeeBalances200ResponseDataInner(unittest.TestCase):
    """GetFeeBalances200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeeBalances200ResponseDataInner:
        """Test GetFeeBalances200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeeBalances200ResponseDataInner`
        """
        model = GetFeeBalances200ResponseDataInner()
        if include_optional:
            return GetFeeBalances200ResponseDataInner(
                currency = '',
                collected_amount = 1.337,
                threshold = 1.337,
                status = '',
                total_collected = 1.337,
                total_paid_out = 1.337
            )
        else:
            return GetFeeBalances200ResponseDataInner(
        )
    ...
    def testGetFeeBalances200ResponseDataInner(self):
        """Test GetFeeBalances200ResponseDataInner"""
