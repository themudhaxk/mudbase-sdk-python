...
class TestGetActiveUsers200ResponseUsersInner(unittest.TestCase):
    """GetActiveUsers200ResponseUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetActiveUsers200ResponseUsersInner:
        """Test GetActiveUsers200ResponseUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetActiveUsers200ResponseUsersInner`
        """
        model = GetActiveUsers200ResponseUsersInner()
        if include_optional:
            return GetActiveUsers200ResponseUsersInner(
                user_id = '',
    ...
    def testGetActiveUsers200ResponseUsersInner(self):
        """Test GetActiveUsers200ResponseUsersInner"""
