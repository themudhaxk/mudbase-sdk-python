...
class TestGetPaymentRecords200Response(unittest.TestCase):
    """GetPaymentRecords200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentRecords200Response:
        """Test GetPaymentRecords200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentRecords200Response`
        """
        model = GetPaymentRecords200Response()
        if include_optional:
            return GetPaymentRecords200Response(
                success = True,
                data = mudbase.models.get_payment_records_200_response_data.getPaymentRecords_200_response_data(
                    records = [
                        mudbase.models.get_payment_records_200_response_data_records_inner.getPaymentRecords_200_response_data_records_inner(
                            tx_ref = '', 
                            amount = 1.337, 
                            org_receives = 1.337, 
                            status = '', 
                    ...
                    pagination = mudbase.models.get_payment_records_200_response_data_pagination.getPaymentRecords_200_response_data_pagination(
                        page = 56, 
                        limit = 56, 
                        total = 56, 
                        pages = 56, ), )
    ...
    def testGetPaymentRecords200Response(self):
        """Test GetPaymentRecords200Response"""
