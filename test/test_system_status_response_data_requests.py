...
class TestSystemStatusResponseDataRequests(unittest.TestCase):
    """SystemStatusResponseDataRequests unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemStatusResponseDataRequests:
        """Test SystemStatusResponseDataRequests
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemStatusResponseDataRequests`
        """
        model = SystemStatusResponseDataRequests()
        if include_optional:
            return SystemStatusResponseDataRequests(
                total = 56,
                successful = 56,
                errors = 56,
                error_rate = 1.337
    ...
    def testSystemStatusResponseDataRequests(self):
        """Test SystemStatusResponseDataRequests"""
