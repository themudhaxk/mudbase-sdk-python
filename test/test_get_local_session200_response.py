...
class TestGetLocalSession200Response(unittest.TestCase):
    """GetLocalSession200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLocalSession200Response:
        """Test GetLocalSession200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLocalSession200Response`
        """
        model = GetLocalSession200Response()
        if include_optional:
    ...
    def testGetLocalSession200Response(self):
        """Test GetLocalSession200Response"""
