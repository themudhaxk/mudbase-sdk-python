...
class TestOrgPatchDomainResponse(unittest.TestCase):
    """OrgPatchDomainResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgPatchDomainResponse:
        """Test OrgPatchDomainResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgPatchDomainResponse`
        """
        model = OrgPatchDomainResponse()
        if include_optional:
    ...
    def testOrgPatchDomainResponse(self):
        """Test OrgPatchDomainResponse"""
