...
class TestLogSecurityEventRequestDetails(unittest.TestCase):
    """LogSecurityEventRequestDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogSecurityEventRequestDetails:
        """Test LogSecurityEventRequestDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogSecurityEventRequestDetails`
        """
        model = LogSecurityEventRequestDetails()
        if include_optional:
            return LogSecurityEventRequestDetails(
                user_id = '',
                resource = '',
                ip_address = '',
                user_agent = '',
    ...
    def testLogSecurityEventRequestDetails(self):
        """Test LogSecurityEventRequestDetails"""
