...
class TestDeviceRegisteredResponse(unittest.TestCase):
    """DeviceRegisteredResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceRegisteredResponse:
        """Test DeviceRegisteredResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceRegisteredResponse`
        """
        model = DeviceRegisteredResponse()
        if include_optional:
            return DeviceRegisteredResponse(
                success = True,
                data = mudbase.models.device_registered_response_data.DeviceRegisteredResponse_data(
                    token = '', 
                    platform = 'ios', 
    ...
    def testDeviceRegisteredResponse(self):
        """Test DeviceRegisteredResponse"""
