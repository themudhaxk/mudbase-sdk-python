...
class TestProjectUsageStatsResponse(unittest.TestCase):
    """ProjectUsageStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectUsageStatsResponse:
        """Test ProjectUsageStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectUsageStatsResponse`
        """
        model = ProjectUsageStatsResponse()
        if include_optional:
            return ProjectUsageStatsResponse(
                project = mudbase.models.project_usage_stats_response_project.ProjectUsageStatsResponse_project(
                    id = '', 
                    name = '', ),
    ...
    def testProjectUsageStatsResponse(self):
        """Test ProjectUsageStatsResponse"""
