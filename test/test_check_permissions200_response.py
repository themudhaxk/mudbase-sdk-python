...
class TestCheckPermissions200Response(unittest.TestCase):
    """CheckPermissions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPermissions200Response:
        """Test CheckPermissions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPermissions200Response`
        """
        model = CheckPermissions200Response()
        if include_optional:
            return CheckPermissions200Response(
                user = None,
                permissions = mudbase.models.check_permissions_200_response_permissions.checkPermissions_200_response_permissions(
                    system = [
                        ''
                        ], 
                    custom = [
    ...
    def testCheckPermissions200Response(self):
        """Test CheckPermissions200Response"""
