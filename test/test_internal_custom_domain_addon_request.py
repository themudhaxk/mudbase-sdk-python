...
class TestInternalCustomDomainAddonRequest(unittest.TestCase):
    """InternalCustomDomainAddonRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalCustomDomainAddonRequest:
        """Test InternalCustomDomainAddonRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalCustomDomainAddonRequest`
        """
        model = InternalCustomDomainAddonRequest()
        if include_optional:
            return InternalCustomDomainAddonRequest(
                org_id = '',
                enabled = True
            )
        else:
    ...
    def testInternalCustomDomainAddonRequest(self):
        """Test InternalCustomDomainAddonRequest"""
