...
class TestLogSecurityEventRequest(unittest.TestCase):
    """LogSecurityEventRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogSecurityEventRequest:
        """Test LogSecurityEventRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogSecurityEventRequest`
        """
        model = LogSecurityEventRequest()
        if include_optional:
            return LogSecurityEventRequest(
                event_type = 'unauthorized_access_attempt',
                severity = 'high',
                details = mudbase.models.log_security_event_request_details.logSecurityEvent_request_details(
                    user_id = '', 
                    resource = '', 
                    ip_address = '', 
                    user_agent = '', 
    ...
    def testLogSecurityEventRequest(self):
        """Test LogSecurityEventRequest"""
