...
class TestDeviceUnregisterRequest(unittest.TestCase):
    """DeviceUnregisterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceUnregisterRequest:
        """Test DeviceUnregisterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceUnregisterRequest`
        """
        model = DeviceUnregisterRequest()
        if include_optional:
            return DeviceUnregisterRequest(
                token = ''
            )
        else:
            return DeviceUnregisterRequest(
    ...
    def testDeviceUnregisterRequest(self):
        """Test DeviceUnregisterRequest"""
