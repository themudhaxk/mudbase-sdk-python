...
class TestConfirmAddressVerification200Response(unittest.TestCase):
    """ConfirmAddressVerification200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmAddressVerification200Response:
        """Test ConfirmAddressVerification200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmAddressVerification200Response`
        """
        model = ConfirmAddressVerification200Response()
        if include_optional:
    ...
    def testConfirmAddressVerification200Response(self):
        """Test ConfirmAddressVerification200Response"""
