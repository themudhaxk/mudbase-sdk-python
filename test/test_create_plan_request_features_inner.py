...
class TestCreatePlanRequestFeaturesInner(unittest.TestCase):
    """CreatePlanRequestFeaturesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePlanRequestFeaturesInner:
        """Test CreatePlanRequestFeaturesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePlanRequestFeaturesInner`
        """
        model = CreatePlanRequestFeaturesInner()
        if include_optional:
    ...
    def testCreatePlanRequestFeaturesInner(self):
        """Test CreatePlanRequestFeaturesInner"""
