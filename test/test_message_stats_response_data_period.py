...
class TestMessageStatsResponseDataPeriod(unittest.TestCase):
    """MessageStatsResponseDataPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageStatsResponseDataPeriod:
        """Test MessageStatsResponseDataPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageStatsResponseDataPeriod`
        """
        model = MessageStatsResponseDataPeriod()
        if include_optional:
            return MessageStatsResponseDataPeriod(
    ...
    def testMessageStatsResponseDataPeriod(self):
        """Test MessageStatsResponseDataPeriod"""
