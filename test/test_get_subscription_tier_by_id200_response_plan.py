...
class TestGetSubscriptionTierById200ResponsePlan(unittest.TestCase):
    """GetSubscriptionTierById200ResponsePlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSubscriptionTierById200ResponsePlan:
        """Test GetSubscriptionTierById200ResponsePlan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSubscriptionTierById200ResponsePlan`
        """
        model = GetSubscriptionTierById200ResponsePlan()
        if include_optional:
            return GetSubscriptionTierById200ResponsePlan(
                id = '',
                name = '',
                description = '',
                price = 1.337,
    ...
    def testGetSubscriptionTierById200ResponsePlan(self):
        """Test GetSubscriptionTierById200ResponsePlan"""
