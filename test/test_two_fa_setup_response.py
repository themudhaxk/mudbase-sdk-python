...
class TestTwoFASetupResponse(unittest.TestCase):
    """TwoFASetupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TwoFASetupResponse:
        """Test TwoFASetupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TwoFASetupResponse`
        """
        model = TwoFASetupResponse()
        if include_optional:
    ...
    def testTwoFASetupResponse(self):
        """Test TwoFASetupResponse"""
