...
class TestListCollections200Response(unittest.TestCase):
    """ListCollections200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCollections200Response:
        """Test ListCollections200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCollections200Response`
        """
        model = ListCollections200Response()
        if include_optional:
            return ListCollections200Response(
                collections = [
                    mudbase.models.collection.Collection(
                        _id = '', 
                        name = '', 
                        slug = '', 
                        project = '', 
    ...
    def testListCollections200Response(self):
        """Test ListCollections200Response"""
