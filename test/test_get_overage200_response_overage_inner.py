...
class TestGetOverage200ResponseOverageInner(unittest.TestCase):
    """GetOverage200ResponseOverageInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOverage200ResponseOverageInner:
        """Test GetOverage200ResponseOverageInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOverage200ResponseOverageInner`
        """
        model = GetOverage200ResponseOverageInner()
        if include_optional:
            return GetOverage200ResponseOverageInner(
                resource = '',
                units = 1.337,
                amount = 1.337,
                currency = '',
    ...
    def testGetOverage200ResponseOverageInner(self):
        """Test GetOverage200ResponseOverageInner"""
