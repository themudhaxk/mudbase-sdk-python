...
class TestUpdateMultiRoleSettingsRequestSettings(unittest.TestCase):
    """UpdateMultiRoleSettingsRequestSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMultiRoleSettingsRequestSettings:
        """Test UpdateMultiRoleSettingsRequestSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMultiRoleSettingsRequestSettings`
        """
        model = UpdateMultiRoleSettingsRequestSettings()
        if include_optional:
            return UpdateMultiRoleSettingsRequestSettings(
    ...
    def testUpdateMultiRoleSettingsRequestSettings(self):
        """Test UpdateMultiRoleSettingsRequestSettings"""
