...
class TestFunctionExecutionResponseData(unittest.TestCase):
    """FunctionExecutionResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionExecutionResponseData:
        """Test FunctionExecutionResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionExecutionResponseData`
        """
        model = FunctionExecutionResponseData()
        if include_optional:
            return FunctionExecutionResponseData(
                execution_id = '',
                status = 'queued'
            )
        else:
    ...
    def testFunctionExecutionResponseData(self):
        """Test FunctionExecutionResponseData"""
