...
class TestPutChatE2eeKeyRequest(unittest.TestCase):
    """PutChatE2eeKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutChatE2eeKeyRequest:
        """Test PutChatE2eeKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutChatE2eeKeyRequest`
        """
        model = PutChatE2eeKeyRequest()
        if include_optional:
            return PutChatE2eeKeyRequest(
                identity_public_key = '',
                key_version = 56
            )
        else:
    ...
    def testPutChatE2eeKeyRequest(self):
        """Test PutChatE2eeKeyRequest"""
