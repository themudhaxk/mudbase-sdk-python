...
class TestValidatePasswordResetToken400Response(unittest.TestCase):
    """ValidatePasswordResetToken400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatePasswordResetToken400Response:
        """Test ValidatePasswordResetToken400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatePasswordResetToken400Response`
        """
        model = ValidatePasswordResetToken400Response()
        if include_optional:
            return ValidatePasswordResetToken400Response(
                valid = False,
    ...
    def testValidatePasswordResetToken400Response(self):
        """Test ValidatePasswordResetToken400Response"""
