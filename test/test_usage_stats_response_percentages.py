...
class TestUsageStatsResponsePercentages(unittest.TestCase):
    """UsageStatsResponsePercentages unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageStatsResponsePercentages:
        """Test UsageStatsResponsePercentages
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageStatsResponsePercentages`
        """
        model = UsageStatsResponsePercentages()
        if include_optional:
            return UsageStatsResponsePercentages(
                api_calls = 1.337,
                storage = 1.337,
                bandwidth = 1.337
            )
    ...
    def testUsageStatsResponsePercentages(self):
        """Test UsageStatsResponsePercentages"""
