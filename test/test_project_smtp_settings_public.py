...
class TestProjectSmtpSettingsPublic(unittest.TestCase):
    """ProjectSmtpSettingsPublic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSmtpSettingsPublic:
        """Test ProjectSmtpSettingsPublic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectSmtpSettingsPublic`
        """
        model = ProjectSmtpSettingsPublic()
        if include_optional:
            return ProjectSmtpSettingsPublic(
                enabled = True,
                host = '',
                port = 56,
                secure = True,
    ...
    def testProjectSmtpSettingsPublic(self):
        """Test ProjectSmtpSettingsPublic"""
