...
class TestAddParticipant200ResponseDataParticipantsInner(unittest.TestCase):
    """AddParticipant200ResponseDataParticipantsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddParticipant200ResponseDataParticipantsInner:
        """Test AddParticipant200ResponseDataParticipantsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddParticipant200ResponseDataParticipantsInner`
        """
        model = AddParticipant200ResponseDataParticipantsInner()
        if include_optional:
            return AddParticipant200ResponseDataParticipantsInner(
                user_id = '',
                role = '',
    ...
    def testAddParticipant200ResponseDataParticipantsInner(self):
        """Test AddParticipant200ResponseDataParticipantsInner"""
