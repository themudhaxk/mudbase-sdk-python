...
class TestGetRole200Response(unittest.TestCase):
    """GetRole200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRole200Response:
        """Test GetRole200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRole200Response`
        """
        model = GetRole200Response()
        if include_optional:
    ...
    def testGetRole200Response(self):
        """Test GetRole200Response"""
