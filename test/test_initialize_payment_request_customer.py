...
class TestInitializePaymentRequestCustomer(unittest.TestCase):
    """InitializePaymentRequestCustomer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitializePaymentRequestCustomer:
        """Test InitializePaymentRequestCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitializePaymentRequestCustomer`
        """
        model = InitializePaymentRequestCustomer()
        if include_optional:
            return InitializePaymentRequestCustomer(
                email = '',
                name = ''
            )
        else:
    ...
    def testInitializePaymentRequestCustomer(self):
        """Test InitializePaymentRequestCustomer"""
