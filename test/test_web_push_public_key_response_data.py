...
class TestWebPushPublicKeyResponseData(unittest.TestCase):
    """WebPushPublicKeyResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushPublicKeyResponseData:
        """Test WebPushPublicKeyResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushPublicKeyResponseData`
        """
        model = WebPushPublicKeyResponseData()
        if include_optional:
            return WebPushPublicKeyResponseData(
                enabled = True,
                public_key = ''
            )
        else:
    ...
    def testWebPushPublicKeyResponseData(self):
        """Test WebPushPublicKeyResponseData"""
