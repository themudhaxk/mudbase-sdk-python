...
class TestCreateRoleRequestPermissionsInner(unittest.TestCase):
    """CreateRoleRequestPermissionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRoleRequestPermissionsInner:
        """Test CreateRoleRequestPermissionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRoleRequestPermissionsInner`
        """
        model = CreateRoleRequestPermissionsInner()
        if include_optional:
            return CreateRoleRequestPermissionsInner(
                resource = 'project',
                actions = [
                    'create'
                    ],
    ...
    def testCreateRoleRequestPermissionsInner(self):
        """Test CreateRoleRequestPermissionsInner"""
