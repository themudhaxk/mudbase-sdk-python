...
class TestMonitoringAnalyticsResponseStatsInner(unittest.TestCase):
    """MonitoringAnalyticsResponseStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringAnalyticsResponseStatsInner:
        """Test MonitoringAnalyticsResponseStatsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringAnalyticsResponseStatsInner`
        """
        model = MonitoringAnalyticsResponseStatsInner()
        if include_optional:
            return MonitoringAnalyticsResponseStatsInner(
                var_date = '',
                api_calls = 56,
                db_reads = 56,
                db_writes = 56,
    ...
    def testMonitoringAnalyticsResponseStatsInner(self):
        """Test MonitoringAnalyticsResponseStatsInner"""
