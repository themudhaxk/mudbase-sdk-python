...
class TestEditMessage200Response(unittest.TestCase):
    """EditMessage200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessage200Response:
        """Test EditMessage200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessage200Response`
        """
        model = EditMessage200Response()
        if include_optional:
            return EditMessage200Response(
                success = True,
                data = mudbase.models.edit_message_200_response_data.editMessage_200_response_data(
                    _id = '', 
                    content = '', 
                    is_e2ee = True, 
                    e2ee = mudbase.models.e2ee.e2ee(), 
                    edited_at = '', )
            )
        else:
            return EditMessage200Response(
    ...
    def testEditMessage200Response(self):
        """Test EditMessage200Response"""
