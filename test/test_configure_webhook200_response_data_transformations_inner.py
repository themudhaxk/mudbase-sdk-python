...
class TestConfigureWebhook200ResponseDataTransformationsInner(unittest.TestCase):
    """ConfigureWebhook200ResponseDataTransformationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureWebhook200ResponseDataTransformationsInner:
        """Test ConfigureWebhook200ResponseDataTransformationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureWebhook200ResponseDataTransformationsInner`
        """
        model = ConfigureWebhook200ResponseDataTransformationsInner()
        if include_optional:
            return ConfigureWebhook200ResponseDataTransformationsInner(
                type = 'jsonPath',
                config = None
            )
        else:
    ...
    def testConfigureWebhook200ResponseDataTransformationsInner(self):
        """Test ConfigureWebhook200ResponseDataTransformationsInner"""
