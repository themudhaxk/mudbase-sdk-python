...
class TestMarkMessagesAsRead200ResponseData(unittest.TestCase):
    """MarkMessagesAsRead200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkMessagesAsRead200ResponseData:
        """Test MarkMessagesAsRead200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkMessagesAsRead200ResponseData`
        """
        model = MarkMessagesAsRead200ResponseData()
        if include_optional:
            return MarkMessagesAsRead200ResponseData(
                modified_count = 56
            )
        else:
            return MarkMessagesAsRead200ResponseData(
    ...
    def testMarkMessagesAsRead200ResponseData(self):
        """Test MarkMessagesAsRead200ResponseData"""
