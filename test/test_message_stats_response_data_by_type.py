...
class TestMessageStatsResponseDataByType(unittest.TestCase):
    """MessageStatsResponseDataByType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageStatsResponseDataByType:
        """Test MessageStatsResponseDataByType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageStatsResponseDataByType`
        """
        model = MessageStatsResponseDataByType()
        if include_optional:
            return MessageStatsResponseDataByType(
                push = 56,
                email = 56,
                sms = 56
            )
    ...
    def testMessageStatsResponseDataByType(self):
        """Test MessageStatsResponseDataByType"""
