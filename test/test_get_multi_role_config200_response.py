...
class TestGetMultiRoleConfig200Response(unittest.TestCase):
    """GetMultiRoleConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMultiRoleConfig200Response:
        """Test GetMultiRoleConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMultiRoleConfig200Response`
        """
        model = GetMultiRoleConfig200Response()
        if include_optional:
            return GetMultiRoleConfig200Response(
                success = True,
                data = mudbase.models.get_multi_role_config_200_response_data.getMultiRoleConfig_200_response_data(
                    is_enabled = True, 
                    default_role = '', 
    ...
    def testGetMultiRoleConfig200Response(self):
        """Test GetMultiRoleConfig200Response"""
