...
class TestConfirmUploadResponseScan(unittest.TestCase):
    """ConfirmUploadResponseScan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmUploadResponseScan:
        """Test ConfirmUploadResponseScan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmUploadResponseScan`
        """
        model = ConfirmUploadResponseScan()
        if include_optional:
            return ConfirmUploadResponseScan(
                status = '',
                provider = '',
                detections = 56,
                analysis = mudbase.models.analysis.analysis()
            )
        else:
            return ConfirmUploadResponseScan(
        )
    ...
    def testConfirmUploadResponseScan(self):
        """Test ConfirmUploadResponseScan"""
