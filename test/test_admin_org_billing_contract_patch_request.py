...
class TestAdminOrgBillingContractPatchRequest(unittest.TestCase):
    """AdminOrgBillingContractPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminOrgBillingContractPatchRequest:
        """Test AdminOrgBillingContractPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminOrgBillingContractPatchRequest`
        """
        model = AdminOrgBillingContractPatchRequest()
        if include_optional:
            return AdminOrgBillingContractPatchRequest(
                contract_amount_cents = 0,
                contract_currency = '',
                contract_billing_interval = 'monthly',
                contract_effective_from = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                contract_notes = '',
                reason = ''
            )
        else:
    ...
    def testAdminOrgBillingContractPatchRequest(self):
        """Test AdminOrgBillingContractPatchRequest"""
