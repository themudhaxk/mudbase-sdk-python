...
class TestAcceptInvite201Response(unittest.TestCase):
    """AcceptInvite201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptInvite201Response:
        """Test AcceptInvite201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptInvite201Response`
        """
        model = AcceptInvite201Response()
        if include_optional:
            return AcceptInvite201Response(
                message = '',
                token = '',
                user = mudbase.models.accept_invite_201_response_user.acceptInvite_201_response_user(
                    id = '', 
                    email = '', 
                    first_name = '', 
                    last_name = '', 
    ...
    def testAcceptInvite201Response(self):
        """Test AcceptInvite201Response"""
