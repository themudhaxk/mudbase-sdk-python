...
class TestCheckFeatureAccess200Response(unittest.TestCase):
    """CheckFeatureAccess200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckFeatureAccess200Response:
        """Test CheckFeatureAccess200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckFeatureAccess200Response`
        """
        model = CheckFeatureAccess200Response()
        if include_optional:
    ...
    def testCheckFeatureAccess200Response(self):
        """Test CheckFeatureAccess200Response"""
