...
class TestCreateOrUpdateFeeSettingsRequest(unittest.TestCase):
    """CreateOrUpdateFeeSettingsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrUpdateFeeSettingsRequest:
        """Test CreateOrUpdateFeeSettingsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrUpdateFeeSettingsRequest`
        """
        model = CreateOrUpdateFeeSettingsRequest()
        if include_optional:
            return CreateOrUpdateFeeSettingsRequest(
                currency = 'BTC',
                enabled = True,
                fee_amount = 0,
                payout_address = '',
    ...
    def testCreateOrUpdateFeeSettingsRequest(self):
        """Test CreateOrUpdateFeeSettingsRequest"""
