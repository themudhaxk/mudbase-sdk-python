...
class TestTriggerFunctionWebhook200Response(unittest.TestCase):
    """TriggerFunctionWebhook200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerFunctionWebhook200Response:
        """Test TriggerFunctionWebhook200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerFunctionWebhook200Response`
        """
        model = TriggerFunctionWebhook200Response()
        if include_optional:
    ...
    def testTriggerFunctionWebhook200Response(self):
        """Test TriggerFunctionWebhook200Response"""
