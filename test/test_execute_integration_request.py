...
class TestExecuteIntegrationRequest(unittest.TestCase):
    """ExecuteIntegrationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteIntegrationRequest:
        """Test ExecuteIntegrationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteIntegrationRequest`
        """
    ...
    def testExecuteIntegrationRequest(self):
        """Test ExecuteIntegrationRequest"""
