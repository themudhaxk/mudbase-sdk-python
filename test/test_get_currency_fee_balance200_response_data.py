...
class TestGetCurrencyFeeBalance200ResponseData(unittest.TestCase):
    """GetCurrencyFeeBalance200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCurrencyFeeBalance200ResponseData:
        """Test GetCurrencyFeeBalance200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCurrencyFeeBalance200ResponseData`
        """
        model = GetCurrencyFeeBalance200ResponseData()
        if include_optional:
            return GetCurrencyFeeBalance200ResponseData(
                currency = '',
    ...
    def testGetCurrencyFeeBalance200ResponseData(self):
        """Test GetCurrencyFeeBalance200ResponseData"""
