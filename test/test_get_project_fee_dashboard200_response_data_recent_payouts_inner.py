...
class TestGetProjectFeeDashboard200ResponseDataRecentPayoutsInner(unittest.TestCase):
    """GetProjectFeeDashboard200ResponseDataRecentPayoutsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectFeeDashboard200ResponseDataRecentPayoutsInner:
        """Test GetProjectFeeDashboard200ResponseDataRecentPayoutsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectFeeDashboard200ResponseDataRecentPayoutsInner`
        """
        model = GetProjectFeeDashboard200ResponseDataRecentPayoutsInner()
        if include_optional:
            return GetProjectFeeDashboard200ResponseDataRecentPayoutsInner(
                id = '',
                amount = '',
                currency = '',
                status = '',
    ...
    def testGetProjectFeeDashboard200ResponseDataRecentPayoutsInner(self):
        """Test GetProjectFeeDashboard200ResponseDataRecentPayoutsInner"""
