...
class TestApiAddonsGet200Response(unittest.TestCase):
    """ApiAddonsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiAddonsGet200Response:
        """Test ApiAddonsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiAddonsGet200Response`
        """
        model = ApiAddonsGet200Response()
        if include_optional:
    ...
    def testApiAddonsGet200Response(self):
        """Test ApiAddonsGet200Response"""
