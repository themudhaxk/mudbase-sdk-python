...
class TestCreateRoleRequestCollectionPermissionsValue(unittest.TestCase):
    """CreateRoleRequestCollectionPermissionsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRoleRequestCollectionPermissionsValue:
        """Test CreateRoleRequestCollectionPermissionsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRoleRequestCollectionPermissionsValue`
        """
        model = CreateRoleRequestCollectionPermissionsValue()
        if include_optional:
    ...
    def testCreateRoleRequestCollectionPermissionsValue(self):
        """Test CreateRoleRequestCollectionPermissionsValue"""
