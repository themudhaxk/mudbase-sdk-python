...
class TestDashboardOverviewDataRequests(unittest.TestCase):
    """DashboardOverviewDataRequests unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardOverviewDataRequests:
        """Test DashboardOverviewDataRequests
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardOverviewDataRequests`
        """
        model = DashboardOverviewDataRequests()
        if include_optional:
            return DashboardOverviewDataRequests(
                today = 56,
                yesterday = 56,
    ...
    def testDashboardOverviewDataRequests(self):
        """Test DashboardOverviewDataRequests"""
