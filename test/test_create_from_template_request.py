...
class TestCreateFromTemplateRequest(unittest.TestCase):
    """CreateFromTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFromTemplateRequest:
        """Test CreateFromTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFromTemplateRequest`
        """
        model = CreateFromTemplateRequest()
        if include_optional:
            return CreateFromTemplateRequest(
                template_id = '',
                credentials = None,
                name = ''
            )
    ...
    def testCreateFromTemplateRequest(self):
        """Test CreateFromTemplateRequest"""
