...
class TestMessageHistoryResponseData(unittest.TestCase):
    """MessageHistoryResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageHistoryResponseData:
        """Test MessageHistoryResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageHistoryResponseData`
        """
        model = MessageHistoryResponseData()
        if include_optional:
    ...
    def testMessageHistoryResponseData(self):
        """Test MessageHistoryResponseData"""
