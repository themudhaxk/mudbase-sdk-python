...
class TestDownloadBucketFile404Response(unittest.TestCase):
    """DownloadBucketFile404Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadBucketFile404Response:
        """Test DownloadBucketFile404Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownloadBucketFile404Response`
        """
        model = DownloadBucketFile404Response()
        if include_optional:
            return DownloadBucketFile404Response(
    ...
    def testDownloadBucketFile404Response(self):
        """Test DownloadBucketFile404Response"""
