...
class TestGetSearchAnalytics200ResponseTopQueriesInner(unittest.TestCase):
    """GetSearchAnalytics200ResponseTopQueriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSearchAnalytics200ResponseTopQueriesInner:
        """Test GetSearchAnalytics200ResponseTopQueriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSearchAnalytics200ResponseTopQueriesInner`
        """
        model = GetSearchAnalytics200ResponseTopQueriesInner()
        if include_optional:
            return GetSearchAnalytics200ResponseTopQueriesInner(
                query = '',
                count = 56
            )
        else:
    ...
    def testGetSearchAnalytics200ResponseTopQueriesInner(self):
        """Test GetSearchAnalytics200ResponseTopQueriesInner"""
