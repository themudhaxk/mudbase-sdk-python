...
class TestGetChatDetails200ResponseDataParticipantsInner(unittest.TestCase):
    """GetChatDetails200ResponseDataParticipantsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatDetails200ResponseDataParticipantsInner:
        """Test GetChatDetails200ResponseDataParticipantsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChatDetails200ResponseDataParticipantsInner`
        """
        model = GetChatDetails200ResponseDataParticipantsInner()
        if include_optional:
            return GetChatDetails200ResponseDataParticipantsInner(
                user_id = '',
                role = ''
            )
        else:
    ...
    def testGetChatDetails200ResponseDataParticipantsInner(self):
        """Test GetChatDetails200ResponseDataParticipantsInner"""
