...
class TestCreateRole201ResponseRolePermissionsInner(unittest.TestCase):
    """CreateRole201ResponseRolePermissionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRole201ResponseRolePermissionsInner:
        """Test CreateRole201ResponseRolePermissionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRole201ResponseRolePermissionsInner`
        """
        model = CreateRole201ResponseRolePermissionsInner()
        if include_optional:
            return CreateRole201ResponseRolePermissionsInner(
                resource = '',
                actions = [
                    ''
                    ],
    ...
    def testCreateRole201ResponseRolePermissionsInner(self):
        """Test CreateRole201ResponseRolePermissionsInner"""
