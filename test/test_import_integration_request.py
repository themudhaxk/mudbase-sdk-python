...
class TestImportIntegrationRequest(unittest.TestCase):
    """ImportIntegrationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportIntegrationRequest:
        """Test ImportIntegrationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportIntegrationRequest`
        """
        model = ImportIntegrationRequest()
        if include_optional:
            return ImportIntegrationRequest(
    ...
    def testImportIntegrationRequest(self):
        """Test ImportIntegrationRequest"""
