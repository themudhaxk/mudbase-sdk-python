...
class TestUpdateCurrencyFeeSettingsRequest(unittest.TestCase):
    """UpdateCurrencyFeeSettingsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCurrencyFeeSettingsRequest:
        """Test UpdateCurrencyFeeSettingsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCurrencyFeeSettingsRequest`
        """
        model = UpdateCurrencyFeeSettingsRequest()
        if include_optional:
            return UpdateCurrencyFeeSettingsRequest(
                enabled = True,
                fee_amount = 1.337,
                payout_address = '',
                payout_threshold = 1.337
            )
        else:
            return UpdateCurrencyFeeSettingsRequest(
        )
    ...
    def testUpdateCurrencyFeeSettingsRequest(self):
        """Test UpdateCurrencyFeeSettingsRequest"""
