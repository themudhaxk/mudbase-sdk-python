...
class TestEraseUserDataRequest(unittest.TestCase):
    """EraseUserDataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EraseUserDataRequest:
        """Test EraseUserDataRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EraseUserDataRequest`
        """
        model = EraseUserDataRequest()
        if include_optional:
            return EraseUserDataRequest(
                confirm = 'DELETE',
    ...
    def testEraseUserDataRequest(self):
        """Test EraseUserDataRequest"""
