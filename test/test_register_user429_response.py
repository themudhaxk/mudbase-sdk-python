...
class TestRegisterUser429Response(unittest.TestCase):
    """RegisterUser429Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterUser429Response:
        """Test RegisterUser429Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterUser429Response`
        """
        model = RegisterUser429Response()
        if include_optional:
            return RegisterUser429Response(
                error = '',
                code = '',
                details = None,
    ...
    def testRegisterUser429Response(self):
        """Test RegisterUser429Response"""
