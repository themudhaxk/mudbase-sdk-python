...
class TestGetPermissionsMatrix200Response(unittest.TestCase):
    """GetPermissionsMatrix200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPermissionsMatrix200Response:
        """Test GetPermissionsMatrix200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPermissionsMatrix200Response`
        """
        model = GetPermissionsMatrix200Response()
        if include_optional:
            return GetPermissionsMatrix200Response(
                success = True,
                data = mudbase.models.get_permissions_matrix_200_response_data.getPermissionsMatrix_200_response_data(
                    collections = [
                        None
                        ], 
                    roles = [
    ...
    def testGetPermissionsMatrix200Response(self):
        """Test GetPermissionsMatrix200Response"""
