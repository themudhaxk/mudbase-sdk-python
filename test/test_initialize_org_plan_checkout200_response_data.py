...
class TestInitializeOrgPlanCheckout200ResponseData(unittest.TestCase):
    """InitializeOrgPlanCheckout200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitializeOrgPlanCheckout200ResponseData:
        """Test InitializeOrgPlanCheckout200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitializeOrgPlanCheckout200ResponseData`
        """
        model = InitializeOrgPlanCheckout200ResponseData()
        if include_optional:
            return InitializeOrgPlanCheckout200ResponseData(
                link = '',
                tx_ref = '',
                provider_ref = '',
                billing_cycle = '',
    ...
    def testInitializeOrgPlanCheckout200ResponseData(self):
        """Test InitializeOrgPlanCheckout200ResponseData"""
