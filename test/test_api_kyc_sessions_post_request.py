...
class TestApiKycSessionsPostRequest(unittest.TestCase):
    """ApiKycSessionsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycSessionsPostRequest:
        """Test ApiKycSessionsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycSessionsPostRequest`
        """
        model = ApiKycSessionsPostRequest()
        if include_optional:
            return ApiKycSessionsPostRequest(
                language = ''
            )
        else:
            return ApiKycSessionsPostRequest(
    ...
    def testApiKycSessionsPostRequest(self):
        """Test ApiKycSessionsPostRequest"""
