...
class TestMonitoringPerformanceResponseMetrics(unittest.TestCase):
    """MonitoringPerformanceResponseMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringPerformanceResponseMetrics:
        """Test MonitoringPerformanceResponseMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringPerformanceResponseMetrics`
        """
        model = MonitoringPerformanceResponseMetrics()
        if include_optional:
            return MonitoringPerformanceResponseMetrics(
                total_requests = 56,
    ...
    def testMonitoringPerformanceResponseMetrics(self):
        """Test MonitoringPerformanceResponseMetrics"""
