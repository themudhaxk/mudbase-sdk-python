...
class TestFunctionListResponseData(unittest.TestCase):
    """FunctionListResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionListResponseData:
        """Test FunctionListResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionListResponseData`
        """
        model = FunctionListResponseData()
        if include_optional:
            return FunctionListResponseData(
                functions = [
    ...
    def testFunctionListResponseData(self):
        """Test FunctionListResponseData"""
