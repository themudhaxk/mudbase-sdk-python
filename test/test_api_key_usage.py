...
class TestApiKeyUsage(unittest.TestCase):
    """ApiKeyUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyUsage:
        """Test ApiKeyUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyUsage`
        """
        model = ApiKeyUsage()
        if include_optional:
            return ApiKeyUsage(
