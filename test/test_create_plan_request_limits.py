...
class TestCreatePlanRequestLimits(unittest.TestCase):
    """CreatePlanRequestLimits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePlanRequestLimits:
        """Test CreatePlanRequestLimits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePlanRequestLimits`
        """
        model = CreatePlanRequestLimits()
        if include_optional:
            return CreatePlanRequestLimits(
                api_calls = 1.337,
                storage = 1.337,
                bandwidth = 1.337,
                users = 1.337,
    ...
    def testCreatePlanRequestLimits(self):
        """Test CreatePlanRequestLimits"""
