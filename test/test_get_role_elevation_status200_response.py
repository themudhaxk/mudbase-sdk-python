...
class TestGetRoleElevationStatus200Response(unittest.TestCase):
    """GetRoleElevationStatus200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRoleElevationStatus200Response:
        """Test GetRoleElevationStatus200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRoleElevationStatus200Response`
        """
        model = GetRoleElevationStatus200Response()
        if include_optional:
    ...
    def testGetRoleElevationStatus200Response(self):
        """Test GetRoleElevationStatus200Response"""
