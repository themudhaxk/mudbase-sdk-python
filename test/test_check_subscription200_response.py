...
class TestCheckSubscription200Response(unittest.TestCase):
    """CheckSubscription200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckSubscription200Response:
        """Test CheckSubscription200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckSubscription200Response`
        """
        model = CheckSubscription200Response()
        if include_optional:
            return CheckSubscription200Response(
                has_subscription = True,
                subscription = mudbase.models.check_subscription_200_response_subscription.checkSubscription_200_response_subscription(
                    status = '', 
                    plan = '', )
            )
        else:
    ...
    def testCheckSubscription200Response(self):
        """Test CheckSubscription200Response"""
