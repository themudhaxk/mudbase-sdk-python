...
class TestGetFunctionVersions200ResponseDataVersionsInner(unittest.TestCase):
    """GetFunctionVersions200ResponseDataVersionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFunctionVersions200ResponseDataVersionsInner:
        """Test GetFunctionVersions200ResponseDataVersionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFunctionVersions200ResponseDataVersionsInner`
        """
        model = GetFunctionVersions200ResponseDataVersionsInner()
        if include_optional:
            return GetFunctionVersions200ResponseDataVersionsInner(
                id = '',
                code = '',
                version = 56,
    ...
    def testGetFunctionVersions200ResponseDataVersionsInner(self):
        """Test GetFunctionVersions200ResponseDataVersionsInner"""
