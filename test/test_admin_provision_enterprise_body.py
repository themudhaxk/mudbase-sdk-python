...
class TestAdminProvisionEnterpriseBody(unittest.TestCase):
    """AdminProvisionEnterpriseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminProvisionEnterpriseBody:
        """Test AdminProvisionEnterpriseBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminProvisionEnterpriseBody`
        """
        model = AdminProvisionEnterpriseBody()
        if include_optional:
            return AdminProvisionEnterpriseBody(
    ...
    def testAdminProvisionEnterpriseBody(self):
        """Test AdminProvisionEnterpriseBody"""
