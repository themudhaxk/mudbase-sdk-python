...
class TestGetWebhookConfig404Response(unittest.TestCase):
    """GetWebhookConfig404Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebhookConfig404Response:
        """Test GetWebhookConfig404Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebhookConfig404Response`
        """
        model = GetWebhookConfig404Response()
        if include_optional:
            return GetWebhookConfig404Response(
                success = True,
                error = ''
            )
        else:
    ...
    def testGetWebhookConfig404Response(self):
        """Test GetWebhookConfig404Response"""
