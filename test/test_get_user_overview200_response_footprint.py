...
class TestGetUserOverview200ResponseFootprint(unittest.TestCase):
    """GetUserOverview200ResponseFootprint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserOverview200ResponseFootprint:
        """Test GetUserOverview200ResponseFootprint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserOverview200ResponseFootprint`
        """
        model = GetUserOverview200ResponseFootprint()
        if include_optional:
            return GetUserOverview200ResponseFootprint(
                file_count = 56,
                storage_used = 56,
                session_count = 56,
                api_key_count = 56,
    ...
    def testGetUserOverview200ResponseFootprint(self):
        """Test GetUserOverview200ResponseFootprint"""
