...
class TestDashboardOverviewDataProject(unittest.TestCase):
    """DashboardOverviewDataProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardOverviewDataProject:
        """Test DashboardOverviewDataProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardOverviewDataProject`
        """
        model = DashboardOverviewDataProject()
        if include_optional:
            return DashboardOverviewDataProject(
                id = '',
                name = '',
                slug = ''
            )
    ...
    def testDashboardOverviewDataProject(self):
        """Test DashboardOverviewDataProject"""
