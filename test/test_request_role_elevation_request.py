...
class TestRequestRoleElevationRequest(unittest.TestCase):
    """RequestRoleElevationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestRoleElevationRequest:
        """Test RequestRoleElevationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestRoleElevationRequest`
        """
        model = RequestRoleElevationRequest()
        if include_optional:
            return RequestRoleElevationRequest(
                role_slug = 'seller'
            )
        else:
            return RequestRoleElevationRequest(
    ...
    def testRequestRoleElevationRequest(self):
        """Test RequestRoleElevationRequest"""
