...
class TestApiKycWebhookConfigPut200Response(unittest.TestCase):
    """ApiKycWebhookConfigPut200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycWebhookConfigPut200Response:
        """Test ApiKycWebhookConfigPut200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycWebhookConfigPut200Response`
        """
        model = ApiKycWebhookConfigPut200Response()
        if include_optional:
    ...
    def testApiKycWebhookConfigPut200Response(self):
        """Test ApiKycWebhookConfigPut200Response"""
