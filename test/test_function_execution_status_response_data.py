...
class TestFunctionExecutionStatusResponseData(unittest.TestCase):
    """FunctionExecutionStatusResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionExecutionStatusResponseData:
        """Test FunctionExecutionStatusResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionExecutionStatusResponseData`
        """
        model = FunctionExecutionStatusResponseData()
        if include_optional:
            return FunctionExecutionStatusResponseData(
                execution_id = '',
                status = 'queued',
                duration_ms = 56,
    ...
    def testFunctionExecutionStatusResponseData(self):
        """Test FunctionExecutionStatusResponseData"""
