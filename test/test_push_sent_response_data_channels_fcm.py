...
class TestPushSentResponseDataChannelsFcm(unittest.TestCase):
    """PushSentResponseDataChannelsFcm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushSentResponseDataChannelsFcm:
        """Test PushSentResponseDataChannelsFcm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushSentResponseDataChannelsFcm`
        """
        model = PushSentResponseDataChannelsFcm()
        if include_optional:
            return PushSentResponseDataChannelsFcm(
                success_count = 56,
                failure_count = 56
            )
        else:
    ...
    def testPushSentResponseDataChannelsFcm(self):
        """Test PushSentResponseDataChannelsFcm"""
