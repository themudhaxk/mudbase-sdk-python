...
class TestMarkMessagesAsRead200Response(unittest.TestCase):
    """MarkMessagesAsRead200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkMessagesAsRead200Response:
        """Test MarkMessagesAsRead200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkMessagesAsRead200Response`
        """
        model = MarkMessagesAsRead200Response()
        if include_optional:
            return MarkMessagesAsRead200Response(
                success = True,
                data = mudbase.models.mark_messages_as_read_200_response_data.markMessagesAsRead_200_response_data(
                    modified_count = 56, )
            )
        else:
            return MarkMessagesAsRead200Response(
    ...
    def testMarkMessagesAsRead200Response(self):
        """Test MarkMessagesAsRead200Response"""
