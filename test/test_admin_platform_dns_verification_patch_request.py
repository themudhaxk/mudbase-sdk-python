...
class TestAdminPlatformDnsVerificationPatchRequest(unittest.TestCase):
    """AdminPlatformDnsVerificationPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminPlatformDnsVerificationPatchRequest:
        """Test AdminPlatformDnsVerificationPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminPlatformDnsVerificationPatchRequest`
        """
        model = AdminPlatformDnsVerificationPatchRequest()
        if include_optional:
            return AdminPlatformDnsVerificationPatchRequest(
                record_type = '',
                record_name = '',
                record_value = '',
                ttl_seconds = 0,
                staff_note = '',
                reset_customer_platform_dns_submission = True,
                notify_org = True
            )
        else:
            return AdminPlatformDnsVerificationPatchRequest(
    ...
    def testAdminPlatformDnsVerificationPatchRequest(self):
        """Test AdminPlatformDnsVerificationPatchRequest"""
