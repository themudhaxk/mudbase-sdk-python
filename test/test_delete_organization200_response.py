...
class TestDeleteOrganization200Response(unittest.TestCase):
    """DeleteOrganization200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteOrganization200Response:
        """Test DeleteOrganization200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteOrganization200Response`
        """
        model = DeleteOrganization200Response()
        if include_optional:
    ...
    def testDeleteOrganization200Response(self):
        """Test DeleteOrganization200Response"""
