...
class TestFeatureNotAllowedError(unittest.TestCase):
    """FeatureNotAllowedError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureNotAllowedError:
        """Test FeatureNotAllowedError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureNotAllowedError`
        """
        model = FeatureNotAllowedError()
        if include_optional:
            return FeatureNotAllowedError(
                success = False,
    ...
    def testFeatureNotAllowedError(self):
        """Test FeatureNotAllowedError"""
