...
class TestRetryWebhookResponse(unittest.TestCase):
    """RetryWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetryWebhookResponse:
        """Test RetryWebhookResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetryWebhookResponse`
        """
        model = RetryWebhookResponse()
        if include_optional:
    ...
    def testRetryWebhookResponse(self):
        """Test RetryWebhookResponse"""
