...
class TestConfigureWebhook403Response(unittest.TestCase):
    """ConfigureWebhook403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureWebhook403Response:
        """Test ConfigureWebhook403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureWebhook403Response`
        """
        model = ConfigureWebhook403Response()
        if include_optional:
            return ConfigureWebhook403Response(
                success = True,
                error = '',
                limit = 1.337
            )
    ...
    def testConfigureWebhook403Response(self):
        """Test ConfigureWebhook403Response"""
