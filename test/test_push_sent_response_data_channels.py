...
class TestPushSentResponseDataChannels(unittest.TestCase):
    """PushSentResponseDataChannels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushSentResponseDataChannels:
        """Test PushSentResponseDataChannels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushSentResponseDataChannels`
        """
        model = PushSentResponseDataChannels()
        if include_optional:
            return PushSentResponseDataChannels(
    ...
    def testPushSentResponseDataChannels(self):
        """Test PushSentResponseDataChannels"""
