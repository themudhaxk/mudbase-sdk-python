...
class TestGenerateAccessReviewRequestReviewPeriod(unittest.TestCase):
    """GenerateAccessReviewRequestReviewPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateAccessReviewRequestReviewPeriod:
        """Test GenerateAccessReviewRequestReviewPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateAccessReviewRequestReviewPeriod`
        """
        model = GenerateAccessReviewRequestReviewPeriod()
        if include_optional:
            return GenerateAccessReviewRequestReviewPeriod(
    ...
    def testGenerateAccessReviewRequestReviewPeriod(self):
        """Test GenerateAccessReviewRequestReviewPeriod"""
