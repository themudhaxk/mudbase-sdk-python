...
class TestGetOrganizationMembers200Response(unittest.TestCase):
    """GetOrganizationMembers200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrganizationMembers200Response:
        """Test GetOrganizationMembers200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrganizationMembers200Response`
        """
        model = GetOrganizationMembers200Response()
        if include_optional:
            return GetOrganizationMembers200Response(
                members = [
                    mudbase.models.user.User(
                        _id = '', 
                        email = '', 
                        first_name = '', 
                        last_name = '', 
    ...
    def testGetOrganizationMembers200Response(self):
        """Test GetOrganizationMembers200Response"""
