...
class TestGetIntegrations200ResponseIntegrationsInner(unittest.TestCase):
    """GetIntegrations200ResponseIntegrationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIntegrations200ResponseIntegrationsInner:
        """Test GetIntegrations200ResponseIntegrationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIntegrations200ResponseIntegrationsInner`
        """
        model = GetIntegrations200ResponseIntegrationsInner()
        if include_optional:
            return GetIntegrations200ResponseIntegrationsInner(
                id = '',
                name = '',
                provider = '',
                status = ''
    ...
    def testGetIntegrations200ResponseIntegrationsInner(self):
        """Test GetIntegrations200ResponseIntegrationsInner"""
