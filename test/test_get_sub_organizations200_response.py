...
class TestGetSubOrganizations200Response(unittest.TestCase):
    """GetSubOrganizations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSubOrganizations200Response:
        """Test GetSubOrganizations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSubOrganizations200Response`
        """
        model = GetSubOrganizations200Response()
        if include_optional:
            return GetSubOrganizations200Response(
                suborgs = [
                    mudbase.models.organization.Organization(
                        _id = '', 
                        name = '', 
                        slug = '', 
                        description = '', 
    ...
    def testGetSubOrganizations200Response(self):
        """Test GetSubOrganizations200Response"""
