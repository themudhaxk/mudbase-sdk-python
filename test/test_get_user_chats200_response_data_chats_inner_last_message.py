...
class TestGetUserChats200ResponseDataChatsInnerLastMessage(unittest.TestCase):
    """GetUserChats200ResponseDataChatsInnerLastMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserChats200ResponseDataChatsInnerLastMessage:
        """Test GetUserChats200ResponseDataChatsInnerLastMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserChats200ResponseDataChatsInnerLastMessage`
        """
        model = GetUserChats200ResponseDataChatsInnerLastMessage()
        if include_optional:
            return GetUserChats200ResponseDataChatsInnerLastMessage(
                content = ''
            )
        else:
            return GetUserChats200ResponseDataChatsInnerLastMessage(
    ...
    def testGetUserChats200ResponseDataChatsInnerLastMessage(self):
        """Test GetUserChats200ResponseDataChatsInnerLastMessage"""
