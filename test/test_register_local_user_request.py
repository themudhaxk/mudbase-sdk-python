...
class TestRegisterLocalUserRequest(unittest.TestCase):
    """RegisterLocalUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterLocalUserRequest:
        """Test RegisterLocalUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterLocalUserRequest`
        """
        model = RegisterLocalUserRequest()
        if include_optional:
            return RegisterLocalUserRequest(
                email = '',
                password = '01234567',
                first_name = '',
                last_name = '',
    ...
    def testRegisterLocalUserRequest(self):
        """Test RegisterLocalUserRequest"""
