...
class TestGetTemplates200ResponseTemplatesInner(unittest.TestCase):
    """GetTemplates200ResponseTemplatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTemplates200ResponseTemplatesInner:
        """Test GetTemplates200ResponseTemplatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTemplates200ResponseTemplatesInner`
        """
        model = GetTemplates200ResponseTemplatesInner()
        if include_optional:
            return GetTemplates200ResponseTemplatesInner(
                id = '',
                name = '',
                provider = '',
                description = ''
    ...
    def testGetTemplates200ResponseTemplatesInner(self):
        """Test GetTemplates200ResponseTemplatesInner"""
