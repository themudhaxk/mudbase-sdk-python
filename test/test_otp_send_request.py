...
class TestOTPSendRequest(unittest.TestCase):
    """OTPSendRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OTPSendRequest:
        """Test OTPSendRequest
