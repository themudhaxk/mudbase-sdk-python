...
class TestGetProjectEmailAnalytics200Response(unittest.TestCase):
    """GetProjectEmailAnalytics200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectEmailAnalytics200Response:
        """Test GetProjectEmailAnalytics200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectEmailAnalytics200Response`
        """
        model = GetProjectEmailAnalytics200Response()
        if include_optional:
    ...
    def testGetProjectEmailAnalytics200Response(self):
        """Test GetProjectEmailAnalytics200Response"""
