...
class TestDashboardOverviewDataLatencyInstanceRollup(unittest.TestCase):
    """DashboardOverviewDataLatencyInstanceRollup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardOverviewDataLatencyInstanceRollup:
        """Test DashboardOverviewDataLatencyInstanceRollup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardOverviewDataLatencyInstanceRollup`
        """
        model = DashboardOverviewDataLatencyInstanceRollup()
        if include_optional:
            return DashboardOverviewDataLatencyInstanceRollup(
    ...
    def testDashboardOverviewDataLatencyInstanceRollup(self):
        """Test DashboardOverviewDataLatencyInstanceRollup"""
