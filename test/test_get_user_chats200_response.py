...
class TestGetUserChats200Response(unittest.TestCase):
    """GetUserChats200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserChats200Response:
        """Test GetUserChats200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserChats200Response`
        """
        model = GetUserChats200Response()
        if include_optional:
            return GetUserChats200Response(
                success = True,
                data = mudbase.models.get_user_chats_200_response_data.getUserChats_200_response_data(
                    chats = [
                        mudbase.models.get_user_chats_200_response_data_chats_inner.getUserChats_200_response_data_chats_inner(
                            _id = '', 
                            name = '', 
                            type = '', 
                            last_message = mudbase.models.get_user_chats_200_response_data_chats_inner_last_message.getUserChats_200_response_data_chats_inner_lastMessage(
                                content = '', ), 
                            unread_count = 56, )
                        ], 
                    total = 56, )
    ...
    def testGetUserChats200Response(self):
        """Test GetUserChats200Response"""
