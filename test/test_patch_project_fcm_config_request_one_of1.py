...
class TestPatchProjectFcmConfigRequestOneOf1(unittest.TestCase):
    """PatchProjectFcmConfigRequestOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchProjectFcmConfigRequestOneOf1:
        """Test PatchProjectFcmConfigRequestOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchProjectFcmConfigRequestOneOf1`
        """
        model = PatchProjectFcmConfigRequestOneOf1()
        if include_optional:
            return PatchProjectFcmConfigRequestOneOf1(
                clear = True
            )
        else:
            return PatchProjectFcmConfigRequestOneOf1(
    ...
    def testPatchProjectFcmConfigRequestOneOf1(self):
        """Test PatchProjectFcmConfigRequestOneOf1"""
