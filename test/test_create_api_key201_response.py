...
class TestCreateApiKey201Response(unittest.TestCase):
    """CreateApiKey201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateApiKey201Response:
        """Test CreateApiKey201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateApiKey201Response`
        """
        model = CreateApiKey201Response()
        if include_optional:
    ...
    def testCreateApiKey201Response(self):
        """Test CreateApiKey201Response"""
