...
class TestPushSentResponseDataChannelsWebPush(unittest.TestCase):
    """PushSentResponseDataChannelsWebPush unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushSentResponseDataChannelsWebPush:
        """Test PushSentResponseDataChannelsWebPush
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushSentResponseDataChannelsWebPush`
        """
        model = PushSentResponseDataChannelsWebPush()
        if include_optional:
            return PushSentResponseDataChannelsWebPush(
                success_count = 56,
                failure_count = 56,
                pruned = 56
            )
    ...
    def testPushSentResponseDataChannelsWebPush(self):
        """Test PushSentResponseDataChannelsWebPush"""
