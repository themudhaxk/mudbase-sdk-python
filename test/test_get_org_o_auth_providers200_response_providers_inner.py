...
class TestGetOrgOAuthProviders200ResponseProvidersInner(unittest.TestCase):
    """GetOrgOAuthProviders200ResponseProvidersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrgOAuthProviders200ResponseProvidersInner:
        """Test GetOrgOAuthProviders200ResponseProvidersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrgOAuthProviders200ResponseProvidersInner`
        """
        model = GetOrgOAuthProviders200ResponseProvidersInner()
        if include_optional:
            return GetOrgOAuthProviders200ResponseProvidersInner(
                name = 'google',
                display_name = 'Google',
                strategy = 'google',
    ...
    def testGetOrgOAuthProviders200ResponseProvidersInner(self):
        """Test GetOrgOAuthProviders200ResponseProvidersInner"""
