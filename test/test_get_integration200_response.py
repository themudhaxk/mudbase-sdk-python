...
class TestGetIntegration200Response(unittest.TestCase):
    """GetIntegration200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIntegration200Response:
        """Test GetIntegration200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIntegration200Response`
        """
        model = GetIntegration200Response()
        if include_optional:
            return GetIntegration200Response(
                integration = mudbase.models.get_integration_200_response_integration.getIntegration_200_response_integration(
                    _id = '', 
                    name = '', 
                    provider = '', 
                    project = '', 
    ...
    def testGetIntegration200Response(self):
        """Test GetIntegration200Response"""
