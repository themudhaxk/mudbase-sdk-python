...
class TestApplyRoleFeaturePresetRequest(unittest.TestCase):
    """ApplyRoleFeaturePresetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplyRoleFeaturePresetRequest:
        """Test ApplyRoleFeaturePresetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyRoleFeaturePresetRequest`
        """
        model = ApplyRoleFeaturePresetRequest()
        if include_optional:
            return ApplyRoleFeaturePresetRequest(
                preset = 'admin'
            )
        else:
            return ApplyRoleFeaturePresetRequest(
    ...
    def testApplyRoleFeaturePresetRequest(self):
        """Test ApplyRoleFeaturePresetRequest"""
