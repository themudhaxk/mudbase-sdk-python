...
class TestVerifiedRoleUpgradeRequest(unittest.TestCase):
    """VerifiedRoleUpgradeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifiedRoleUpgradeRequest:
        """Test VerifiedRoleUpgradeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifiedRoleUpgradeRequest`
        """
        model = VerifiedRoleUpgradeRequest()
        if include_optional:
            return VerifiedRoleUpgradeRequest(
                target_role = 'seller',
                payment_intent_id = '',
                verification_id = ''
            )
    ...
    def testVerifiedRoleUpgradeRequest(self):
        """Test VerifiedRoleUpgradeRequest"""
