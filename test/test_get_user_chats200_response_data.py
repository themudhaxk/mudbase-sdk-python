...
class TestGetUserChats200ResponseData(unittest.TestCase):
    """GetUserChats200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserChats200ResponseData:
        """Test GetUserChats200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserChats200ResponseData`
        """
        model = GetUserChats200ResponseData()
        if include_optional:
            return GetUserChats200ResponseData(
                chats = [
    ...
    def testGetUserChats200ResponseData(self):
        """Test GetUserChats200ResponseData"""
