...
class TestGetUsersByRole200Response(unittest.TestCase):
    """GetUsersByRole200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUsersByRole200Response:
        """Test GetUsersByRole200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsersByRole200Response`
        """
        model = GetUsersByRole200Response()
        if include_optional:
    ...
    def testGetUsersByRole200Response(self):
        """Test GetUsersByRole200Response"""
