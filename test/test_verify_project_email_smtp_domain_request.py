...
class TestVerifyProjectEmailSmtpDomainRequest(unittest.TestCase):
    """VerifyProjectEmailSmtpDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyProjectEmailSmtpDomainRequest:
        """Test VerifyProjectEmailSmtpDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyProjectEmailSmtpDomainRequest`
        """
        model = VerifyProjectEmailSmtpDomainRequest()
        if include_optional:
            return VerifyProjectEmailSmtpDomainRequest(
                domain = '',
                from_email = '',
                persist = True
            )
    ...
    def testVerifyProjectEmailSmtpDomainRequest(self):
        """Test VerifyProjectEmailSmtpDomainRequest"""
