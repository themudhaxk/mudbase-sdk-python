...
class TestRegisterWithRole201ResponseUser(unittest.TestCase):
    """RegisterWithRole201ResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterWithRole201ResponseUser:
        """Test RegisterWithRole201ResponseUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterWithRole201ResponseUser`
        """
        model = RegisterWithRole201ResponseUser()
        if include_optional:
            return RegisterWithRole201ResponseUser(
                id = '',
                email = '',
                first_name = '',
                last_name = '',
    ...
    def testRegisterWithRole201ResponseUser(self):
        """Test RegisterWithRole201ResponseUser"""
