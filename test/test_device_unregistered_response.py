...
class TestDeviceUnregisteredResponse(unittest.TestCase):
    """DeviceUnregisteredResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceUnregisteredResponse:
        """Test DeviceUnregisteredResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceUnregisteredResponse`
        """
        model = DeviceUnregisteredResponse()
        if include_optional:
            return DeviceUnregisteredResponse(
                success = True,
                data = mudbase.models.device_unregistered_response_data.DeviceUnregisteredResponse_data(
                    removed = True, )
            )
        else:
            return DeviceUnregisteredResponse(
    ...
    def testDeviceUnregisteredResponse(self):
        """Test DeviceUnregisteredResponse"""
