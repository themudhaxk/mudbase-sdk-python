...
class TestGetPayoutHistory200ResponsePagination(unittest.TestCase):
    """GetPayoutHistory200ResponsePagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPayoutHistory200ResponsePagination:
        """Test GetPayoutHistory200ResponsePagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPayoutHistory200ResponsePagination`
        """
        model = GetPayoutHistory200ResponsePagination()
        if include_optional:
            return GetPayoutHistory200ResponsePagination(
                page = 56,
                limit = 56,
                count = 56,
                total = 56,
    ...
    def testGetPayoutHistory200ResponsePagination(self):
        """Test GetPayoutHistory200ResponsePagination"""
