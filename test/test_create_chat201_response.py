...
class TestCreateChat201Response(unittest.TestCase):
    """CreateChat201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateChat201Response:
        """Test CreateChat201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateChat201Response`
        """
        model = CreateChat201Response()
        if include_optional:
            return CreateChat201Response(
                success = True,
                data = mudbase.models.create_chat_201_response_data.createChat_201_response_data(
                    _id = '', 
                    name = '', 
                    type = '', 
                    participants = [
    ...
    def testCreateChat201Response(self):
        """Test CreateChat201Response"""
