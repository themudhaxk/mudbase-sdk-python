...
class TestGetAvailableRoles200ResponseDataInner(unittest.TestCase):
    """GetAvailableRoles200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAvailableRoles200ResponseDataInner:
        """Test GetAvailableRoles200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAvailableRoles200ResponseDataInner`
        """
        model = GetAvailableRoles200ResponseDataInner()
        if include_optional:
            return GetAvailableRoles200ResponseDataInner(
                slug = '',
                name = '',
                description = '',
                signup_endpoint = '',
    ...
    def testGetAvailableRoles200ResponseDataInner(self):
        """Test GetAvailableRoles200ResponseDataInner"""
