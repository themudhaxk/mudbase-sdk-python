...
class TestLoginLocalUser200Response(unittest.TestCase):
    """LoginLocalUser200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoginLocalUser200Response:
        """Test LoginLocalUser200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoginLocalUser200Response`
        """
        model = LoginLocalUser200Response()
        if include_optional:
            return LoginLocalUser200Response(
                ...
                refresh_token = '',
                expires_in = 56,
                user = mudbase.models.login_local_user_200_response_user.loginLocalUser_200_response_user(
                    id = '', 
                    email = '', 
                    first_name = '', 
                    last_name = '', 
    ...
    def testLoginLocalUser200Response(self):
        """Test LoginLocalUser200Response"""
