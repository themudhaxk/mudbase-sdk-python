...
class TestConfigureOAuthProvider200ResponseProvider(unittest.TestCase):
    """ConfigureOAuthProvider200ResponseProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureOAuthProvider200ResponseProvider:
        """Test ConfigureOAuthProvider200ResponseProvider
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureOAuthProvider200ResponseProvider`
        """
        model = ConfigureOAuthProvider200ResponseProvider()
        if include_optional:
            return ConfigureOAuthProvider200ResponseProvider(
                name = 'google',
                enabled = True,
    ...
    def testConfigureOAuthProvider200ResponseProvider(self):
        """Test ConfigureOAuthProvider200ResponseProvider"""
