...
class TestApiMeBootstrapGet200Response(unittest.TestCase):
    """ApiMeBootstrapGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiMeBootstrapGet200Response:
        """Test ApiMeBootstrapGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiMeBootstrapGet200Response`
        """
        model = ApiMeBootstrapGet200Response()
        if include_optional:
    ...
    def testApiMeBootstrapGet200Response(self):
        """Test ApiMeBootstrapGet200Response"""
