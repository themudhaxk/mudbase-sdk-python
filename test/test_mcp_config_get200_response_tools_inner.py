...
class TestMcpConfigGet200ResponseToolsInner(unittest.TestCase):
    """McpConfigGet200ResponseToolsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> McpConfigGet200ResponseToolsInner:
        """Test McpConfigGet200ResponseToolsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `McpConfigGet200ResponseToolsInner`
        """
        model = McpConfigGet200ResponseToolsInner()
        if include_optional:
            return McpConfigGet200ResponseToolsInner(
                name = '',
                description = ''
            )
        else:
    ...
    def testMcpConfigGet200ResponseToolsInner(self):
        """Test McpConfigGet200ResponseToolsInner"""
