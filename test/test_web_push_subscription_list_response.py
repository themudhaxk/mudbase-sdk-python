...
class TestWebPushSubscriptionListResponse(unittest.TestCase):
    """WebPushSubscriptionListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushSubscriptionListResponse:
        """Test WebPushSubscriptionListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushSubscriptionListResponse`
        """
        model = WebPushSubscriptionListResponse()
        if include_optional:
            return WebPushSubscriptionListResponse(
                success = True,
                data = [
                    mudbase.models.web_push_subscription_summary.WebPushSubscriptionSummary(
                        endpoint = '', 
                        user_id = '', 
                        device_id = '', 
                        user_agent = '', 
    ...
    def testWebPushSubscriptionListResponse(self):
        """Test WebPushSubscriptionListResponse"""
