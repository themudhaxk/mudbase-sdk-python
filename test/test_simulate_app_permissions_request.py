...
class TestSimulateAppPermissionsRequest(unittest.TestCase):
    """SimulateAppPermissionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimulateAppPermissionsRequest:
        """Test SimulateAppPermissionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimulateAppPermissionsRequest`
        """
        model = SimulateAppPermissionsRequest()
        if include_optional:
            return SimulateAppPermissionsRequest(
                role = 'customer',
                role_slug = '',
    ...
    def testSimulateAppPermissionsRequest(self):
        """Test SimulateAppPermissionsRequest"""
