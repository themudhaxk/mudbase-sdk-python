...
class TestProjectUsageSummaryResponse(unittest.TestCase):
    """ProjectUsageSummaryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectUsageSummaryResponse:
        """Test ProjectUsageSummaryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectUsageSummaryResponse`
        """
        model = ProjectUsageSummaryResponse()
        if include_optional:
    ...
    def testProjectUsageSummaryResponse(self):
        """Test ProjectUsageSummaryResponse"""
