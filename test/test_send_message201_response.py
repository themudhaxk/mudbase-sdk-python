...
class TestSendMessage201Response(unittest.TestCase):
    """SendMessage201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessage201Response:
        """Test SendMessage201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessage201Response`
        """
        model = SendMessage201Response()
        if include_optional:
            return SendMessage201Response(
                success = True,
                data = mudbase.models.send_message_201_response_data.sendMessage_201_response_data(
                    _id = '', 
                    content = '', 
                    sender = '', 
    ...
    def testSendMessage201Response(self):
        """Test SendMessage201Response"""
