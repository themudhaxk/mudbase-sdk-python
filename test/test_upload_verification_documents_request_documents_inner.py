...
class TestUploadVerificationDocumentsRequestDocumentsInner(unittest.TestCase):
    """UploadVerificationDocumentsRequestDocumentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadVerificationDocumentsRequestDocumentsInner:
        """Test UploadVerificationDocumentsRequestDocumentsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadVerificationDocumentsRequestDocumentsInner`
        """
        model = UploadVerificationDocumentsRequestDocumentsInner()
        if include_optional:
            return UploadVerificationDocumentsRequestDocumentsInner(
                type = '',
                url = ''
            )
        else:
    ...
    def testUploadVerificationDocumentsRequestDocumentsInner(self):
        """Test UploadVerificationDocumentsRequestDocumentsInner"""
