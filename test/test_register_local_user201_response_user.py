...
class TestRegisterLocalUser201ResponseUser(unittest.TestCase):
    """RegisterLocalUser201ResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterLocalUser201ResponseUser:
        """Test RegisterLocalUser201ResponseUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterLocalUser201ResponseUser`
        """
        model = RegisterLocalUser201ResponseUser()
        if include_optional:
            return RegisterLocalUser201ResponseUser(
                id = '',
                email = '',
                first_name = '',
                last_name = '',
    ...
    def testRegisterLocalUser201ResponseUser(self):
        """Test RegisterLocalUser201ResponseUser"""
