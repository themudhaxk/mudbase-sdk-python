...
class TestSimulateAppPermissions200Response(unittest.TestCase):
    """SimulateAppPermissions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimulateAppPermissions200Response:
        """Test SimulateAppPermissions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimulateAppPermissions200Response`
        """
        model = SimulateAppPermissions200Response()
        if include_optional:
    ...
    def testSimulateAppPermissions200Response(self):
        """Test SimulateAppPermissions200Response"""
