...
class TestUpdateCollectionPermissionsRequest(unittest.TestCase):
    """UpdateCollectionPermissionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCollectionPermissionsRequest:
        """Test UpdateCollectionPermissionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCollectionPermissionsRequest`
        """
        model = UpdateCollectionPermissionsRequest()
        if include_optional:
            return UpdateCollectionPermissionsRequest(
    ...
    def testUpdateCollectionPermissionsRequest(self):
        """Test UpdateCollectionPermissionsRequest"""
