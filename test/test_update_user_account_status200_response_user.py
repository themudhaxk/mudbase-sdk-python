...
class TestUpdateUserAccountStatus200ResponseUser(unittest.TestCase):
    """UpdateUserAccountStatus200ResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateUserAccountStatus200ResponseUser:
        """Test UpdateUserAccountStatus200ResponseUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateUserAccountStatus200ResponseUser`
        """
        model = UpdateUserAccountStatus200ResponseUser()
        if include_optional:
            return UpdateUserAccountStatus200ResponseUser(
                id = '',
                email = '',
                first_name = '',
                last_name = '',
    ...
    def testUpdateUserAccountStatus200ResponseUser(self):
        """Test UpdateUserAccountStatus200ResponseUser"""
