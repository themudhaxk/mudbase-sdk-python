...
class TestAdminProjectPatchRequest(unittest.TestCase):
    """AdminProjectPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminProjectPatchRequest:
        """Test AdminProjectPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminProjectPatchRequest`
        """
        model = AdminProjectPatchRequest()
        if include_optional:
            return AdminProjectPatchRequest(
                name = '0',
                slug = 'p01',
                is_archived = True
            )
    ...
    def testAdminProjectPatchRequest(self):
        """Test AdminProjectPatchRequest"""
