...
class TestGetPendingRoleElevationRequests200Response(unittest.TestCase):
    """GetPendingRoleElevationRequests200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPendingRoleElevationRequests200Response:
        """Test GetPendingRoleElevationRequests200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPendingRoleElevationRequests200Response`
        """
        model = GetPendingRoleElevationRequests200Response()
        if include_optional:
    ...
    def testGetPendingRoleElevationRequests200Response(self):
        """Test GetPendingRoleElevationRequests200Response"""
