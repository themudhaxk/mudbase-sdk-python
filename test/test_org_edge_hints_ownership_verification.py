...
class TestOrgEdgeHintsOwnershipVerification(unittest.TestCase):
    """OrgEdgeHintsOwnershipVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgEdgeHintsOwnershipVerification:
        """Test OrgEdgeHintsOwnershipVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgEdgeHintsOwnershipVerification`
        """
        model = OrgEdgeHintsOwnershipVerification()
        if include_optional:
            return OrgEdgeHintsOwnershipVerification(
                name = '',
                type = '',
                value = ''
            )
    ...
    def testOrgEdgeHintsOwnershipVerification(self):
        """Test OrgEdgeHintsOwnershipVerification"""
