...
class TestRequestLocalPasswordResetRequest(unittest.TestCase):
    """RequestLocalPasswordResetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestLocalPasswordResetRequest:
        """Test RequestLocalPasswordResetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestLocalPasswordResetRequest`
        """
        model = RequestLocalPasswordResetRequest()
        if include_optional:
            return RequestLocalPasswordResetRequest(
    ...
    def testRequestLocalPasswordResetRequest(self):
        """Test RequestLocalPasswordResetRequest"""
