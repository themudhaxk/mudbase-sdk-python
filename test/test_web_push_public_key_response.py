...
class TestWebPushPublicKeyResponse(unittest.TestCase):
    """WebPushPublicKeyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushPublicKeyResponse:
        """Test WebPushPublicKeyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushPublicKeyResponse`
        """
        model = WebPushPublicKeyResponse()
        if include_optional:
            return WebPushPublicKeyResponse(
                success = True,
                data = mudbase.models.web_push_public_key_response_data.WebPushPublicKeyResponse_data(
                    enabled = True, 
                    public_key = '', )
            )
        else:
    ...
    def testWebPushPublicKeyResponse(self):
        """Test WebPushPublicKeyResponse"""
