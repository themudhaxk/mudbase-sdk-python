...
class TestGetPublicPlans200Response(unittest.TestCase):
    """GetPublicPlans200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPublicPlans200Response:
        """Test GetPublicPlans200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPublicPlans200Response`
        """
        model = GetPublicPlans200Response()
        if include_optional:
            return GetPublicPlans200Response(
                plans = [
                    mudbase.models.plan.Plan(
                        name = '', 
                        price = 1.337, 
                        currency = '', 
                        interval = '', 
    ...
    def testGetPublicPlans200Response(self):
        """Test GetPublicPlans200Response"""
