...
class TestCreatePlanRequestFeaturesInnerOneOf(unittest.TestCase):
    """CreatePlanRequestFeaturesInnerOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePlanRequestFeaturesInnerOneOf:
        """Test CreatePlanRequestFeaturesInnerOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePlanRequestFeaturesInnerOneOf`
        """
        model = CreatePlanRequestFeaturesInnerOneOf()
        if include_optional:
            return CreatePlanRequestFeaturesInnerOneOf(
                name = '',
                description = '',
                included = True,
                limit = 1.337
    ...
    def testCreatePlanRequestFeaturesInnerOneOf(self):
        """Test CreatePlanRequestFeaturesInnerOneOf"""
