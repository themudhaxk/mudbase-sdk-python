...
class TestGetChatMessages200ResponseDataMessagesInnerSender(unittest.TestCase):
    """GetChatMessages200ResponseDataMessagesInnerSender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatMessages200ResponseDataMessagesInnerSender:
        """Test GetChatMessages200ResponseDataMessagesInnerSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChatMessages200ResponseDataMessagesInnerSender`
        """
        model = GetChatMessages200ResponseDataMessagesInnerSender()
        if include_optional:
            return GetChatMessages200ResponseDataMessagesInnerSender(
                id = '',
                first_name = ''
            )
        else:
    ...
    def testGetChatMessages200ResponseDataMessagesInnerSender(self):
        """Test GetChatMessages200ResponseDataMessagesInnerSender"""
