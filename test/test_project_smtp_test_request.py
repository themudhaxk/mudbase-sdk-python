...
class TestProjectSmtpTestRequest(unittest.TestCase):
    """ProjectSmtpTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSmtpTestRequest:
        """Test ProjectSmtpTestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectSmtpTestRequest`
        """
        model = ProjectSmtpTestRequest()
        if include_optional:
            return ProjectSmtpTestRequest(
                to = '',
                use_saved = True,
                host = '',
                port = 56,
    ...
    def testProjectSmtpTestRequest(self):
        """Test ProjectSmtpTestRequest"""
