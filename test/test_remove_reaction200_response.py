...
class TestRemoveReaction200Response(unittest.TestCase):
    """RemoveReaction200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveReaction200Response:
        """Test RemoveReaction200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveReaction200Response`
        """
        model = RemoveReaction200Response()
        if include_optional:
            return RemoveReaction200Response(
                success = True,
                data = [
                    mudbase.models.remove_reaction_200_response_data_inner.removeReaction_200_response_data_inner(
                        emoji = '', 
                        count = 56, 
                        users = [
                            ''
    ...
    def testRemoveReaction200Response(self):
        """Test RemoveReaction200Response"""
