...
class TestApiKycWorkflowsGet200ResponseWorkflowsInner(unittest.TestCase):
    """ApiKycWorkflowsGet200ResponseWorkflowsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycWorkflowsGet200ResponseWorkflowsInner:
        """Test ApiKycWorkflowsGet200ResponseWorkflowsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycWorkflowsGet200ResponseWorkflowsInner`
        """
        model = ApiKycWorkflowsGet200ResponseWorkflowsInner()
        if include_optional:
            return ApiKycWorkflowsGet200ResponseWorkflowsInner(
                id = '',
                name = '',
                type = 'kyc',
                is_default = True
    ...
    def testApiKycWorkflowsGet200ResponseWorkflowsInner(self):
        """Test ApiKycWorkflowsGet200ResponseWorkflowsInner"""
