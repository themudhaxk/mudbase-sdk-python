...
class TestLoginLocalUserRequest(unittest.TestCase):
    """LoginLocalUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoginLocalUserRequest:
        """Test LoginLocalUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoginLocalUserRequest`
        """
        model = LoginLocalUserRequest()
        if include_optional:
            return LoginLocalUserRequest(
                email = '',
                password = '',
                project_id = ''
            )
    ...
    def testLoginLocalUserRequest(self):
        """Test LoginLocalUserRequest"""
