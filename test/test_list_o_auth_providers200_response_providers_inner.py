...
class TestListOAuthProviders200ResponseProvidersInner(unittest.TestCase):
    """ListOAuthProviders200ResponseProvidersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOAuthProviders200ResponseProvidersInner:
        """Test ListOAuthProviders200ResponseProvidersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOAuthProviders200ResponseProvidersInner`
        """
        model = ListOAuthProviders200ResponseProvidersInner()
        if include_optional:
            return ListOAuthProviders200ResponseProvidersInner(
                provider = 'google',
    ...
    def testListOAuthProviders200ResponseProvidersInner(self):
        """Test ListOAuthProviders200ResponseProvidersInner"""
