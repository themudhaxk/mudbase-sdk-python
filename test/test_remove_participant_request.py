...
class TestRemoveParticipantRequest(unittest.TestCase):
    """RemoveParticipantRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveParticipantRequest:
        """Test RemoveParticipantRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveParticipantRequest`
        """
        model = RemoveParticipantRequest()
        if include_optional:
    ...
    def testRemoveParticipantRequest(self):
        """Test RemoveParticipantRequest"""
