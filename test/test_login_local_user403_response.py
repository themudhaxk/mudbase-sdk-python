...
class TestLoginLocalUser403Response(unittest.TestCase):
    """LoginLocalUser403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoginLocalUser403Response:
        """Test LoginLocalUser403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoginLocalUser403Response`
        """
        model = LoginLocalUser403Response()
        if include_optional:
            return LoginLocalUser403Response(
                error = '',
                code = '',
                message = ''
            )
    ...
    def testLoginLocalUser403Response(self):
        """Test LoginLocalUser403Response"""
