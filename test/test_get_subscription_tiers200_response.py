...
class TestGetSubscriptionTiers200Response(unittest.TestCase):
    """GetSubscriptionTiers200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSubscriptionTiers200Response:
        """Test GetSubscriptionTiers200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSubscriptionTiers200Response`
        """
        model = GetSubscriptionTiers200Response()
        if include_optional:
            return GetSubscriptionTiers200Response(
                plans = [
                    mudbase.models.get_subscription_tiers_200_response_plans_inner.getSubscriptionTiers_200_response_plans_inner(
                        id = 'starter', 
                        name = 'Starter', 
                        description = '', 
                        price = 2900, 
                        ...
                        enforcement = mudbase.models.enforcement.enforcement(), )
                    ]
            )
        else:
            return GetSubscriptionTiers200Response(
    ...
    def testGetSubscriptionTiers200Response(self):
        """Test GetSubscriptionTiers200Response"""
