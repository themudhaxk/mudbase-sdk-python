...
class TestApproveRoleElevationRequest(unittest.TestCase):
    """ApproveRoleElevationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApproveRoleElevationRequest:
        """Test ApproveRoleElevationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApproveRoleElevationRequest`
        """
        model = ApproveRoleElevationRequest()
        if include_optional:
            return ApproveRoleElevationRequest(
                approved = True,
                reason = ''
            )
        else:
    ...
    def testApproveRoleElevationRequest(self):
        """Test ApproveRoleElevationRequest"""
