...
class TestListOAuthProviders200Response(unittest.TestCase):
    """ListOAuthProviders200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOAuthProviders200Response:
        """Test ListOAuthProviders200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOAuthProviders200Response`
        """
        model = ListOAuthProviders200Response()
        if include_optional:
            return ListOAuthProviders200Response(
                providers = [
                    mudbase.models.list_o_auth_providers_200_response_providers_inner.listOAuthProviders_200_response_providers_inner(
                        provider = 'google', 
    ...
    def testListOAuthProviders200Response(self):
        """Test ListOAuthProviders200Response"""
