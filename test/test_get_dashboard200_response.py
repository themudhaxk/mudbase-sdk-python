...
class TestGetDashboard200Response(unittest.TestCase):
    """GetDashboard200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboard200Response:
        """Test GetDashboard200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboard200Response`
        """
        model = GetDashboard200Response()
        if include_optional:
    ...
    def testGetDashboard200Response(self):
        """Test GetDashboard200Response"""
