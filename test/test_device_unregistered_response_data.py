...
class TestDeviceUnregisteredResponseData(unittest.TestCase):
    """DeviceUnregisteredResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceUnregisteredResponseData:
        """Test DeviceUnregisteredResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceUnregisteredResponseData`
        """
        model = DeviceUnregisteredResponseData()
        if include_optional:
            return DeviceUnregisteredResponseData(
                removed = True
            )
        else:
            return DeviceUnregisteredResponseData(
    ...
    def testDeviceUnregisteredResponseData(self):
        """Test DeviceUnregisteredResponseData"""
