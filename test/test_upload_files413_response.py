...
class TestUploadFiles413Response(unittest.TestCase):
    """UploadFiles413Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadFiles413Response:
        """Test UploadFiles413Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadFiles413Response`
        """
        model = UploadFiles413Response()
        if include_optional:
            return UploadFiles413Response(
                error = '',
                max_file_upload_bytes = 56
            )
        else:
            return UploadFiles413Response(
        )
    ...
    def testUploadFiles413Response(self):
        """Test UploadFiles413Response"""
