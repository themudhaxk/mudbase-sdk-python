...
class TestLogSecurityEvent200ResponseEvent(unittest.TestCase):
    """LogSecurityEvent200ResponseEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogSecurityEvent200ResponseEvent:
        """Test LogSecurityEvent200ResponseEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogSecurityEvent200ResponseEvent`
        """
        model = LogSecurityEvent200ResponseEvent()
        if include_optional:
            return LogSecurityEvent200ResponseEvent(
                id = '',
                event_type = '',
                severity = '',
    ...
    def testLogSecurityEvent200ResponseEvent(self):
        """Test LogSecurityEvent200ResponseEvent"""
