...
class TestSystemStatusResponseDataMemory(unittest.TestCase):
    """SystemStatusResponseDataMemory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemStatusResponseDataMemory:
        """Test SystemStatusResponseDataMemory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemStatusResponseDataMemory`
        """
        model = SystemStatusResponseDataMemory()
        if include_optional:
            return SystemStatusResponseDataMemory(
                used = 56,
                total = 56,
                percentage = 1.337
            )
    ...
    def testSystemStatusResponseDataMemory(self):
        """Test SystemStatusResponseDataMemory"""
