...
class TestGetWebhookConfig200ResponseData(unittest.TestCase):
    """GetWebhookConfig200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebhookConfig200ResponseData:
        """Test GetWebhookConfig200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebhookConfig200ResponseData`
        """
        model = GetWebhookConfig200ResponseData()
        if include_optional:
            return GetWebhookConfig200ResponseData(
                webhook_url = '',
                webhook_events = [
                    ''
                    ],
    ...
    def testGetWebhookConfig200ResponseData(self):
        """Test GetWebhookConfig200ResponseData"""
