...
class TestGetProjectOAuthProviders200ResponseProvidersInner(unittest.TestCase):
    """GetProjectOAuthProviders200ResponseProvidersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectOAuthProviders200ResponseProvidersInner:
        """Test GetProjectOAuthProviders200ResponseProvidersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectOAuthProviders200ResponseProvidersInner`
        """
        model = GetProjectOAuthProviders200ResponseProvidersInner()
        if include_optional:
            return GetProjectOAuthProviders200ResponseProvidersInner(
                name = 'google',
    ...
    def testGetProjectOAuthProviders200ResponseProvidersInner(self):
        """Test GetProjectOAuthProviders200ResponseProvidersInner"""
