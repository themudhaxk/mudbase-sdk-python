...
class TestUpdateMultiRoleSettings200Response(unittest.TestCase):
    """UpdateMultiRoleSettings200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMultiRoleSettings200Response:
        """Test UpdateMultiRoleSettings200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMultiRoleSettings200Response`
        """
        model = UpdateMultiRoleSettings200Response()
        if include_optional:
    ...
    def testUpdateMultiRoleSettings200Response(self):
        """Test UpdateMultiRoleSettings200Response"""
