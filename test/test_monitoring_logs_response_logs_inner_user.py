...
class TestMonitoringLogsResponseLogsInnerUser(unittest.TestCase):
    """MonitoringLogsResponseLogsInnerUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringLogsResponseLogsInnerUser:
        """Test MonitoringLogsResponseLogsInnerUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringLogsResponseLogsInnerUser`
        """
        model = MonitoringLogsResponseLogsInnerUser()
        if include_optional:
            return MonitoringLogsResponseLogsInnerUser(
                id = '',
                email = ''
            )
        else:
    ...
    def testMonitoringLogsResponseLogsInnerUser(self):
        """Test MonitoringLogsResponseLogsInnerUser"""
