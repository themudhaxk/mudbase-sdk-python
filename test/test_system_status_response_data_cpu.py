...
class TestSystemStatusResponseDataCpu(unittest.TestCase):
    """SystemStatusResponseDataCpu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemStatusResponseDataCpu:
        """Test SystemStatusResponseDataCpu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemStatusResponseDataCpu`
        """
        model = SystemStatusResponseDataCpu()
        if include_optional:
            return SystemStatusResponseDataCpu(
                usage = 1.337,
                cores = 56
            )
        else:
    ...
    def testSystemStatusResponseDataCpu(self):
        """Test SystemStatusResponseDataCpu"""
