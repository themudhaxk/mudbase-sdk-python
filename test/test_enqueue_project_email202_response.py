...
class TestEnqueueProjectEmail202Response(unittest.TestCase):
    """EnqueueProjectEmail202Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnqueueProjectEmail202Response:
        """Test EnqueueProjectEmail202Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnqueueProjectEmail202Response`
        """
        model = EnqueueProjectEmail202Response()
        if include_optional:
    ...
    def testEnqueueProjectEmail202Response(self):
        """Test EnqueueProjectEmail202Response"""
