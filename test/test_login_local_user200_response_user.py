...
class TestLoginLocalUser200ResponseUser(unittest.TestCase):
    """LoginLocalUser200ResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoginLocalUser200ResponseUser:
        """Test LoginLocalUser200ResponseUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoginLocalUser200ResponseUser`
        """
        model = LoginLocalUser200ResponseUser()
        if include_optional:
            return LoginLocalUser200ResponseUser(
                id = '',
                email = '',
                first_name = '',
                last_name = '',
    ...
    def testLoginLocalUser200ResponseUser(self):
        """Test LoginLocalUser200ResponseUser"""
