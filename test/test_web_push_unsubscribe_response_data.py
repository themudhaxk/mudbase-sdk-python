...
class TestWebPushUnsubscribeResponseData(unittest.TestCase):
    """WebPushUnsubscribeResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushUnsubscribeResponseData:
        """Test WebPushUnsubscribeResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushUnsubscribeResponseData`
        """
        model = WebPushUnsubscribeResponseData()
        if include_optional:
            return WebPushUnsubscribeResponseData(
                removed = True
            )
        else:
            return WebPushUnsubscribeResponseData(
    ...
    def testWebPushUnsubscribeResponseData(self):
        """Test WebPushUnsubscribeResponseData"""
