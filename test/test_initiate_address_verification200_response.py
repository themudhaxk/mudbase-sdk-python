...
class TestInitiateAddressVerification200Response(unittest.TestCase):
    """InitiateAddressVerification200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitiateAddressVerification200Response:
        """Test InitiateAddressVerification200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitiateAddressVerification200Response`
        """
        model = InitiateAddressVerification200Response()
        if include_optional:
    ...
    def testInitiateAddressVerification200Response(self):
        """Test InitiateAddressVerification200Response"""
