...
class TestConfigureWebhook200ResponseData(unittest.TestCase):
    """ConfigureWebhook200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureWebhook200ResponseData:
        """Test ConfigureWebhook200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureWebhook200ResponseData`
        """
        model = ConfigureWebhook200ResponseData()
        if include_optional:
            return ConfigureWebhook200ResponseData(
                webhook_url = '',
                webhook_events = [
                    ''
                    ],
    ...
    def testConfigureWebhook200ResponseData(self):
        """Test ConfigureWebhook200ResponseData"""
