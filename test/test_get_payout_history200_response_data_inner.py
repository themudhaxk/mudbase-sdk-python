...
class TestGetPayoutHistory200ResponseDataInner(unittest.TestCase):
    """GetPayoutHistory200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPayoutHistory200ResponseDataInner:
        """Test GetPayoutHistory200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPayoutHistory200ResponseDataInner`
        """
        model = GetPayoutHistory200ResponseDataInner()
        if include_optional:
            return GetPayoutHistory200ResponseDataInner(
                id = '',
                currency = '',
                gross_amount = 1.337,
                network_fee = 1.337,
    ...
    def testGetPayoutHistory200ResponseDataInner(self):
        """Test GetPayoutHistory200ResponseDataInner"""
