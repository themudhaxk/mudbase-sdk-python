...
class TestAddReactionRequest(unittest.TestCase):
    """AddReactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddReactionRequest:
        """Test AddReactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddReactionRequest`
        """
    ...
    def testAddReactionRequest(self):
        """Test AddReactionRequest"""
