...
class TestEditMessageRequest(unittest.TestCase):
    """EditMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageRequest:
        """Test EditMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageRequest`
        """
        model = EditMessageRequest()
        if include_optional:
            return EditMessageRequest(
                content = '',
                e2ee = mudbase.models.edit_message_request_e2ee.editMessage_request_e2ee(
                    version = 56, 
                    scheme = '', 
                    ciphertext = '', 
                    nonce = '', 
    ...
    def testEditMessageRequest(self):
        """Test EditMessageRequest"""
