...
class TestGetUsageWarnings200Response(unittest.TestCase):
    """GetUsageWarnings200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUsageWarnings200Response:
        """Test GetUsageWarnings200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsageWarnings200Response`
        """
        model = GetUsageWarnings200Response()
        if include_optional:
            return GetUsageWarnings200Response(
                warnings = [
                    mudbase.models.get_usage_warnings_200_response_warnings_inner.getUsageWarnings_200_response_warnings_inner(
                        resource = '', 
                        threshold = 1.337, 
                        current = 1.337, 
                        limit = 1.337, 
    ...
    def testGetUsageWarnings200Response(self):
        """Test GetUsageWarnings200Response"""
