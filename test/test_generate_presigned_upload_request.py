...
class TestGeneratePresignedUploadRequest(unittest.TestCase):
    """GeneratePresignedUploadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratePresignedUploadRequest:
        """Test GeneratePresignedUploadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratePresignedUploadRequest`
        """
        model = GeneratePresignedUploadRequest()
        if include_optional:
            return GeneratePresignedUploadRequest(
                project_id = '',
                bucket = 'default',
                original_name = '',
                content_type = '',
    ...
    def testGeneratePresignedUploadRequest(self):
        """Test GeneratePresignedUploadRequest"""
