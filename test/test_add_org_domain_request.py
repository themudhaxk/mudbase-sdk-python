...
class TestAddOrgDomainRequest(unittest.TestCase):
    """AddOrgDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddOrgDomainRequest:
        """Test AddOrgDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddOrgDomainRequest`
        """
        model = AddOrgDomainRequest()
        if include_optional:
            return AddOrgDomainRequest(
                hostname = '',
                set_primary = True
            )
        else:
    ...
    def testAddOrgDomainRequest(self):
        """Test AddOrgDomainRequest"""
