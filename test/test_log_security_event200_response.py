...
class TestLogSecurityEvent200Response(unittest.TestCase):
    """LogSecurityEvent200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogSecurityEvent200Response:
        """Test LogSecurityEvent200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogSecurityEvent200Response`
        """
        model = LogSecurityEvent200Response()
        if include_optional:
            return LogSecurityEvent200Response(
                message = 'Security event logged',
                event = mudbase.models.log_security_event_200_response_event.logSecurityEvent_200_response_event(
                    _id = '', 
                    event_type = '', 
                    severity = '', 
    ...
    def testLogSecurityEvent200Response(self):
        """Test LogSecurityEvent200Response"""
