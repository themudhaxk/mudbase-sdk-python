...
class TestUploadVerificationDocumentsRequest(unittest.TestCase):
    """UploadVerificationDocumentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadVerificationDocumentsRequest:
        """Test UploadVerificationDocumentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadVerificationDocumentsRequest`
        """
        model = UploadVerificationDocumentsRequest()
        if include_optional:
            return UploadVerificationDocumentsRequest(
                role_slug = '',
                documents = [
                    mudbase.models.upload_verification_documents_request_documents_inner.uploadVerificationDocuments_request_documents_inner(
                        type = '', 
                        url = '', )
                    ]
            )
    ...
    def testUploadVerificationDocumentsRequest(self):
        """Test UploadVerificationDocumentsRequest"""
