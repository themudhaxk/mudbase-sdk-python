...
class TestUpdateUserAccountStatusRequest(unittest.TestCase):
    """UpdateUserAccountStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateUserAccountStatusRequest:
        """Test UpdateUserAccountStatusRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateUserAccountStatusRequest`
        """
        model = UpdateUserAccountStatusRequest()
        if include_optional:
            return UpdateUserAccountStatusRequest(
    ...
    def testUpdateUserAccountStatusRequest(self):
        """Test UpdateUserAccountStatusRequest"""
