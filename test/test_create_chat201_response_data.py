...
class TestCreateChat201ResponseData(unittest.TestCase):
    """CreateChat201ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateChat201ResponseData:
        """Test CreateChat201ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateChat201ResponseData`
        """
        model = CreateChat201ResponseData()
        if include_optional:
            return CreateChat201ResponseData(
                id = '',
                name = '',
                type = '',
                participants = [
    ...
    def testCreateChat201ResponseData(self):
        """Test CreateChat201ResponseData"""
