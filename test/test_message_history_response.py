...
class TestMessageHistoryResponse(unittest.TestCase):
    """MessageHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageHistoryResponse:
        """Test MessageHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageHistoryResponse`
        """
        model = MessageHistoryResponse()
        if include_optional:
            return MessageHistoryResponse(
                success = True,
                data = mudbase.models.message_history_response_data.MessageHistoryResponse_data(
                    messages = [
                        mudbase.models.message.Message(
                            _id = '', 
                            type = 'push', 
                            title = '', 
                            body = '', 
    ...
    def testMessageHistoryResponse(self):
        """Test MessageHistoryResponse"""
