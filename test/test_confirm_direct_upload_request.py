...
class TestConfirmDirectUploadRequest(unittest.TestCase):
    """ConfirmDirectUploadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmDirectUploadRequest:
        """Test ConfirmDirectUploadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmDirectUploadRequest`
        """
        model = ConfirmDirectUploadRequest()
        if include_optional:
            return ConfirmDirectUploadRequest(
                key = '',
                project_id = '',
                original_name = '',
                content_type = '',
    ...
    def testConfirmDirectUploadRequest(self):
        """Test ConfirmDirectUploadRequest"""
