...
class TestGetProjectFeeDashboard200ResponseDataBalancesInner(unittest.TestCase):
    """GetProjectFeeDashboard200ResponseDataBalancesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectFeeDashboard200ResponseDataBalancesInner:
        """Test GetProjectFeeDashboard200ResponseDataBalancesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectFeeDashboard200ResponseDataBalancesInner`
        """
        model = GetProjectFeeDashboard200ResponseDataBalancesInner()
        if include_optional:
            return GetProjectFeeDashboard200ResponseDataBalancesInner(
                currency = '',
                balance = '',
                pending = ''
            )
    ...
    def testGetProjectFeeDashboard200ResponseDataBalancesInner(self):
        """Test GetProjectFeeDashboard200ResponseDataBalancesInner"""
