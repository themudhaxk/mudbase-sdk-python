...
class TestGetChatE2eeParticipantKeys200Response(unittest.TestCase):
    """GetChatE2eeParticipantKeys200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatE2eeParticipantKeys200Response:
        """Test GetChatE2eeParticipantKeys200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChatE2eeParticipantKeys200Response`
        """
        model = GetChatE2eeParticipantKeys200Response()
        if include_optional:
            return GetChatE2eeParticipantKeys200Response(
                success = True,
                data = [
                    mudbase.models.get_chat_e2ee_participant_keys_200_response_data_inner.getChatE2eeParticipantKeys_200_response_data_inner(
                        user_id = '', 
                        identity_public_key = '', 
                        key_version = 56, 
    ...
    def testGetChatE2eeParticipantKeys200Response(self):
        """Test GetChatE2eeParticipantKeys200Response"""
