...
class TestConfirmDirectUpload400Response(unittest.TestCase):
    """ConfirmDirectUpload400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmDirectUpload400Response:
        """Test ConfirmDirectUpload400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmDirectUpload400Response`
        """
        model = ConfirmDirectUpload400Response()
        if include_optional:
            return ConfirmDirectUpload400Response(
                message = '',
                details = None
            )
        else:
    ...
    def testConfirmDirectUpload400Response(self):
        """Test ConfirmDirectUpload400Response"""
