...
class TestToggleRoleRequest(unittest.TestCase):
    """ToggleRoleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToggleRoleRequest:
        """Test ToggleRoleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToggleRoleRequest`
        """
        model = ToggleRoleRequest()
        if include_optional:
            return ToggleRoleRequest(
                is_enabled = True
            )
        else:
            return ToggleRoleRequest(
    ...
    def testToggleRoleRequest(self):
        """Test ToggleRoleRequest"""
