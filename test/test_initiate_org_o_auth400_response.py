...
class TestInitiateOrgOAuth400Response(unittest.TestCase):
    """InitiateOrgOAuth400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitiateOrgOAuth400Response:
        """Test InitiateOrgOAuth400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitiateOrgOAuth400Response`
        """
        model = InitiateOrgOAuth400Response()
        if include_optional:
            return InitiateOrgOAuth400Response(
                error = '',
                message = ''
            )
        else:
    ...
    def testInitiateOrgOAuth400Response(self):
        """Test InitiateOrgOAuth400Response"""
