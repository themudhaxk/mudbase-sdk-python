...
class TestGetProjectCaptchaConfig200ResponseCaptcha(unittest.TestCase):
    """GetProjectCaptchaConfig200ResponseCaptcha unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectCaptchaConfig200ResponseCaptcha:
        """Test GetProjectCaptchaConfig200ResponseCaptcha
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectCaptchaConfig200ResponseCaptcha`
        """
        model = GetProjectCaptchaConfig200ResponseCaptcha()
        if include_optional:
            return GetProjectCaptchaConfig200ResponseCaptcha(
                enabled = True,
                version = 'v2',
                site_key = '',
                min_score = 0
    ...
    def testGetProjectCaptchaConfig200ResponseCaptcha(self):
        """Test GetProjectCaptchaConfig200ResponseCaptcha"""
