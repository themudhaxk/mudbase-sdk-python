...
class TestGetUserChats200ResponseDataChatsInner(unittest.TestCase):
    """GetUserChats200ResponseDataChatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserChats200ResponseDataChatsInner:
        """Test GetUserChats200ResponseDataChatsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserChats200ResponseDataChatsInner`
        """
        model = GetUserChats200ResponseDataChatsInner()
        if include_optional:
            return GetUserChats200ResponseDataChatsInner(
                id = '',
                name = '',
                type = '',
    ...
    def testGetUserChats200ResponseDataChatsInner(self):
        """Test GetUserChats200ResponseDataChatsInner"""
