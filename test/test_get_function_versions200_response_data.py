...
class TestGetFunctionVersions200ResponseData(unittest.TestCase):
    """GetFunctionVersions200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFunctionVersions200ResponseData:
        """Test GetFunctionVersions200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFunctionVersions200ResponseData`
        """
        model = GetFunctionVersions200ResponseData()
        if include_optional:
            return GetFunctionVersions200ResponseData(
                versions = [
    ...
    def testGetFunctionVersions200ResponseData(self):
        """Test GetFunctionVersions200ResponseData"""
