...
class TestCheckSubscription200ResponseSubscription(unittest.TestCase):
    """CheckSubscription200ResponseSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckSubscription200ResponseSubscription:
        """Test CheckSubscription200ResponseSubscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckSubscription200ResponseSubscription`
        """
        model = CheckSubscription200ResponseSubscription()
        if include_optional:
            return CheckSubscription200ResponseSubscription(
                status = '',
                plan = ''
            )
        else:
    ...
    def testCheckSubscription200ResponseSubscription(self):
        """Test CheckSubscription200ResponseSubscription"""
