...
class TestCollectionPermissionRule(unittest.TestCase):
    """CollectionPermissionRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPermissionRule:
        """Test CollectionPermissionRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPermissionRule`
        """
        model = CollectionPermissionRule()
        if include_optional:
    ...
    def testCollectionPermissionRule(self):
        """Test CollectionPermissionRule"""
