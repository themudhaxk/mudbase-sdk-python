...
class TestGetUsageWarnings200ResponseWarningsInner(unittest.TestCase):
    """GetUsageWarnings200ResponseWarningsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUsageWarnings200ResponseWarningsInner:
        """Test GetUsageWarnings200ResponseWarningsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsageWarnings200ResponseWarningsInner`
        """
        model = GetUsageWarnings200ResponseWarningsInner()
        if include_optional:
            return GetUsageWarnings200ResponseWarningsInner(
                resource = '',
                threshold = 1.337,
                current = 1.337,
                limit = 1.337,
    ...
    def testGetUsageWarnings200ResponseWarningsInner(self):
        """Test GetUsageWarnings200ResponseWarningsInner"""
