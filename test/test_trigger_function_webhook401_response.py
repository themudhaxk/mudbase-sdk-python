...
class TestTriggerFunctionWebhook401Response(unittest.TestCase):
    """TriggerFunctionWebhook401Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerFunctionWebhook401Response:
        """Test TriggerFunctionWebhook401Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerFunctionWebhook401Response`
        """
        model = TriggerFunctionWebhook401Response()
        if include_optional:
            return TriggerFunctionWebhook401Response(
                success = False,
    ...
    def testTriggerFunctionWebhook401Response(self):
        """Test TriggerFunctionWebhook401Response"""
