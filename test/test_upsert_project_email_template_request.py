...
class TestUpsertProjectEmailTemplateRequest(unittest.TestCase):
    """UpsertProjectEmailTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertProjectEmailTemplateRequest:
        """Test UpsertProjectEmailTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertProjectEmailTemplateRequest`
        """
        model = UpsertProjectEmailTemplateRequest()
        if include_optional:
            return UpsertProjectEmailTemplateRequest(
                subject = '',
                html_body = '',
                text_body = '',
                variables = [
    ...
    def testUpsertProjectEmailTemplateRequest(self):
        """Test UpsertProjectEmailTemplateRequest"""
