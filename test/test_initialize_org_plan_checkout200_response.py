...
class TestInitializeOrgPlanCheckout200Response(unittest.TestCase):
    """InitializeOrgPlanCheckout200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitializeOrgPlanCheckout200Response:
        """Test InitializeOrgPlanCheckout200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitializeOrgPlanCheckout200Response`
        """
        model = InitializeOrgPlanCheckout200Response()
        if include_optional:
            return InitializeOrgPlanCheckout200Response(
                success = True,
                data = mudbase.models.initialize_org_plan_checkout_200_response_data.initializeOrgPlanCheckout_200_response_data(
                    link = '', 
                    tx_ref = '', 
                    provider_ref = '', 
                    billing_cycle = '', 
    ...
    def testInitializeOrgPlanCheckout200Response(self):
        """Test InitializeOrgPlanCheckout200Response"""
