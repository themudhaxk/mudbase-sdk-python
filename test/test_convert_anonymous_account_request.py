...
class TestConvertAnonymousAccountRequest(unittest.TestCase):
    """ConvertAnonymousAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConvertAnonymousAccountRequest:
        """Test ConvertAnonymousAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConvertAnonymousAccountRequest`
        """
        model = ConvertAnonymousAccountRequest()
        if include_optional:
            return ConvertAnonymousAccountRequest(
    ...
    def testConvertAnonymousAccountRequest(self):
        """Test ConvertAnonymousAccountRequest"""
