...
class TestPreviewProjectEmailTemplateRequest(unittest.TestCase):
    """PreviewProjectEmailTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreviewProjectEmailTemplateRequest:
        """Test PreviewProjectEmailTemplateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreviewProjectEmailTemplateRequest`
        """
        model = PreviewProjectEmailTemplateRequest()
        if include_optional:
            return PreviewProjectEmailTemplateRequest(
                sample_data = { }
            )
        else:
            return PreviewProjectEmailTemplateRequest(
    ...
    def testPreviewProjectEmailTemplateRequest(self):
        """Test PreviewProjectEmailTemplateRequest"""
