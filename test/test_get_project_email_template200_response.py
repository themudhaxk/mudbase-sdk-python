...
class TestGetProjectEmailTemplate200Response(unittest.TestCase):
    """GetProjectEmailTemplate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectEmailTemplate200Response:
        """Test GetProjectEmailTemplate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectEmailTemplate200Response`
        """
        model = GetProjectEmailTemplate200Response()
        if include_optional:
            return GetProjectEmailTemplate200Response(
                success = True,
                data = mudbase.models.email_template_resolved.EmailTemplateResolved(
                    name = '', 
                    subject = '', 
                    html_body = '', 
                    text_body = '', 
    ...
    def testGetProjectEmailTemplate200Response(self):
        """Test GetProjectEmailTemplate200Response"""
