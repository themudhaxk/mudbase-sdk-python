...
class TestPresignedPostResponse(unittest.TestCase):
    """PresignedPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresignedPostResponse:
        """Test PresignedPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresignedPostResponse`
        """
        model = PresignedPostResponse()
        if include_optional:
    ...
    def testPresignedPostResponse(self):
        """Test PresignedPostResponse"""
