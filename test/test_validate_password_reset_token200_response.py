...
class TestValidatePasswordResetToken200Response(unittest.TestCase):
    """ValidatePasswordResetToken200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatePasswordResetToken200Response:
        """Test ValidatePasswordResetToken200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatePasswordResetToken200Response`
        """
        model = ValidatePasswordResetToken200Response()
        if include_optional:
    ...
    def testValidatePasswordResetToken200Response(self):
        """Test ValidatePasswordResetToken200Response"""
