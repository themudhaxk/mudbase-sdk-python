...
class TestGetIntegration200ResponseIntegration(unittest.TestCase):
    """GetIntegration200ResponseIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIntegration200ResponseIntegration:
        """Test GetIntegration200ResponseIntegration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIntegration200ResponseIntegration`
        """
        model = GetIntegration200ResponseIntegration()
        if include_optional:
            return GetIntegration200ResponseIntegration(
                id = '',
                name = '',
                provider = '',
                project = '',
    ...
    def testGetIntegration200ResponseIntegration(self):
        """Test GetIntegration200ResponseIntegration"""
