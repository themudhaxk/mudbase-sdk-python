...
class TestMarkMessagesAsReadRequest(unittest.TestCase):
    """MarkMessagesAsReadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarkMessagesAsReadRequest:
        """Test MarkMessagesAsReadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarkMessagesAsReadRequest`
        """
        model = MarkMessagesAsReadRequest()
        if include_optional:
    ...
    def testMarkMessagesAsReadRequest(self):
        """Test MarkMessagesAsReadRequest"""
