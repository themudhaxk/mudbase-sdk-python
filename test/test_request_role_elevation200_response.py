...
class TestRequestRoleElevation200Response(unittest.TestCase):
    """RequestRoleElevation200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestRoleElevation200Response:
        """Test RequestRoleElevation200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestRoleElevation200Response`
        """
        model = RequestRoleElevation200Response()
        if include_optional:
    ...
    def testRequestRoleElevation200Response(self):
        """Test RequestRoleElevation200Response"""
