...
class TestWebhookStatsResponseStatusStatsInner(unittest.TestCase):
    """WebhookStatsResponseStatusStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookStatsResponseStatusStatsInner:
        """Test WebhookStatsResponseStatusStatsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookStatsResponseStatusStatsInner`
        """
        model = WebhookStatsResponseStatusStatsInner()
        if include_optional:
            return WebhookStatsResponseStatusStatsInner(
                id = '',
                count = 56,
                avg_duration = 1.337
            )
    ...
    def testWebhookStatsResponseStatusStatsInner(self):
        """Test WebhookStatsResponseStatusStatsInner"""
