...
class TestMonitoringLogsResponseLogsInner(unittest.TestCase):
    """MonitoringLogsResponseLogsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringLogsResponseLogsInner:
        """Test MonitoringLogsResponseLogsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringLogsResponseLogsInner`
        """
        model = MonitoringLogsResponseLogsInner()
        if include_optional:
            return MonitoringLogsResponseLogsInner(
                id = '',
    ...
    def testMonitoringLogsResponseLogsInner(self):
        """Test MonitoringLogsResponseLogsInner"""
