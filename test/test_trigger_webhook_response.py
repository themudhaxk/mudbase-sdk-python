...
class TestTriggerWebhookResponse(unittest.TestCase):
    """TriggerWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerWebhookResponse:
        """Test TriggerWebhookResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerWebhookResponse`
        """
        model = TriggerWebhookResponse()
        if include_optional:
    ...
    def testTriggerWebhookResponse(self):
        """Test TriggerWebhookResponse"""
