...
class TestGenerateAccessReview200Response(unittest.TestCase):
    """GenerateAccessReview200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateAccessReview200Response:
        """Test GenerateAccessReview200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateAccessReview200Response`
        """
        model = GenerateAccessReview200Response()
        if include_optional:
            return GenerateAccessReview200Response(
                report = mudbase.models.generate_access_review_200_response_report.generateAccessReview_200_response_report(
                    org_id = '', 
                    review_period = mudbase.models.review_period.reviewPeriod(), 
                    users = [
                        None
                        ], 
                    summary = mudbase.models.summary.summary(), 
                    recommendations = [
                        ''
                        ], 
    ...
    def testGenerateAccessReview200Response(self):
        """Test GenerateAccessReview200Response"""
