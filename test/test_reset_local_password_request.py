...
class TestResetLocalPasswordRequest(unittest.TestCase):
    """ResetLocalPasswordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResetLocalPasswordRequest:
        """Test ResetLocalPasswordRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResetLocalPasswordRequest`
        """
        model = ResetLocalPasswordRequest()
        if include_optional:
            return ResetLocalPasswordRequest(
    ...
    def testResetLocalPasswordRequest(self):
        """Test ResetLocalPasswordRequest"""
