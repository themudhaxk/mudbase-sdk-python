...
class TestGetPaymentRecords200ResponseDataRecordsInner(unittest.TestCase):
    """GetPaymentRecords200ResponseDataRecordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentRecords200ResponseDataRecordsInner:
        """Test GetPaymentRecords200ResponseDataRecordsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentRecords200ResponseDataRecordsInner`
        """
        model = GetPaymentRecords200ResponseDataRecordsInner()
        if include_optional:
            return GetPaymentRecords200ResponseDataRecordsInner(
                tx_ref = '',
                amount = 1.337,
                org_receives = 1.337,
                status = '',
    ...
    def testGetPaymentRecords200ResponseDataRecordsInner(self):
        """Test GetPaymentRecords200ResponseDataRecordsInner"""
