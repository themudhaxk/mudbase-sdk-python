...
class TestAdminApproveOrgDomainCnameRequest(unittest.TestCase):
    """AdminApproveOrgDomainCnameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminApproveOrgDomainCnameRequest:
        """Test AdminApproveOrgDomainCnameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminApproveOrgDomainCnameRequest`
        """
        model = AdminApproveOrgDomainCnameRequest()
        if include_optional:
            return AdminApproveOrgDomainCnameRequest(
                verify_dns = True
            )
        else:
            return AdminApproveOrgDomainCnameRequest(
    ...
    def testAdminApproveOrgDomainCnameRequest(self):
        """Test AdminApproveOrgDomainCnameRequest"""
