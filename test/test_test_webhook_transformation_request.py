...
class TestTestWebhookTransformationRequest(unittest.TestCase):
    """TestWebhookTransformationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestWebhookTransformationRequest:
        """Test TestWebhookTransformationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestWebhookTransformationRequest`
        """
        model = TestWebhookTransformationRequest()
        if include_optional:
            return TestWebhookTransformationRequest(
                payload = None,
                transformations = [
    ...
    def testTestWebhookTransformationRequest(self):
        """Test TestWebhookTransformationRequest"""
