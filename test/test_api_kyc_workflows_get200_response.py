...
class TestApiKycWorkflowsGet200Response(unittest.TestCase):
    """ApiKycWorkflowsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycWorkflowsGet200Response:
        """Test ApiKycWorkflowsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycWorkflowsGet200Response`
        """
        model = ApiKycWorkflowsGet200Response()
        if include_optional:
            return ApiKycWorkflowsGet200Response(
                workflows = [
                    mudbase.models._api_kyc_workflows_get_200_response_workflows_inner._api_kyc_workflows_get_200_response_workflows_inner(
                        id = '', 
                        name = '', 
                        type = 'kyc', 
                        is_default = True, )
    ...
    def testApiKycWorkflowsGet200Response(self):
        """Test ApiKycWorkflowsGet200Response"""
