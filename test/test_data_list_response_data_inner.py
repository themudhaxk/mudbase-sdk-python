...
class TestDataListResponseDataInner(unittest.TestCase):
    """DataListResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataListResponseDataInner:
        """Test DataListResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataListResponseDataInner`
        """
        model = DataListResponseDataInner()
        if include_optional:
            return DataListResponseDataInner(
                id = '696bbe5b99eeb7f929a93e0b',
    ...
    def testDataListResponseDataInner(self):
        """Test DataListResponseDataInner"""
