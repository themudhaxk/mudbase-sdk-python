...
class TestRetryWebhook400Response(unittest.TestCase):
    """RetryWebhook400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetryWebhook400Response:
        """Test RetryWebhook400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetryWebhook400Response`
        """
        model = RetryWebhook400Response()
        if include_optional:
            return RetryWebhook400Response(
    ...
    def testRetryWebhook400Response(self):
        """Test RetryWebhook400Response"""
