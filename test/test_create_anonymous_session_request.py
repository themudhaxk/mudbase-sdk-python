...
class TestCreateAnonymousSessionRequest(unittest.TestCase):
    """CreateAnonymousSessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAnonymousSessionRequest:
        """Test CreateAnonymousSessionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAnonymousSessionRequest`
        """
        model = CreateAnonymousSessionRequest()
        if include_optional:
            return CreateAnonymousSessionRequest(
    ...
    def testCreateAnonymousSessionRequest(self):
        """Test CreateAnonymousSessionRequest"""
