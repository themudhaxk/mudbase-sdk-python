...
class TestUpdateOAuthProviderConfigRequest(unittest.TestCase):
    """UpdateOAuthProviderConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOAuthProviderConfigRequest:
        """Test UpdateOAuthProviderConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOAuthProviderConfigRequest`
        """
        model = UpdateOAuthProviderConfigRequest()
        if include_optional:
            return UpdateOAuthProviderConfigRequest(
                enabled = True,
    ...
    def testUpdateOAuthProviderConfigRequest(self):
        """Test UpdateOAuthProviderConfigRequest"""
