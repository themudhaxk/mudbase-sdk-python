...
class TestOrgVerifyCustomDomainDnsFailureResponse(unittest.TestCase):
    """OrgVerifyCustomDomainDnsFailureResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgVerifyCustomDomainDnsFailureResponse:
        """Test OrgVerifyCustomDomainDnsFailureResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgVerifyCustomDomainDnsFailureResponse`
        """
        model = OrgVerifyCustomDomainDnsFailureResponse()
        if include_optional:
            return OrgVerifyCustomDomainDnsFailureResponse(
                success = True,
    ...
    def testOrgVerifyCustomDomainDnsFailureResponse(self):
        """Test OrgVerifyCustomDomainDnsFailureResponse"""
