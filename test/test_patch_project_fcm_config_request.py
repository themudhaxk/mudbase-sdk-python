...
class TestPatchProjectFcmConfigRequest(unittest.TestCase):
    """PatchProjectFcmConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchProjectFcmConfigRequest:
        """Test PatchProjectFcmConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchProjectFcmConfigRequest`
        """
        model = PatchProjectFcmConfigRequest()
        if include_optional:
            return PatchProjectFcmConfigRequest(
                service_account_json = mudbase.models.service_account_json.serviceAccountJson(),
                clear = True
            )
        else:
            return PatchProjectFcmConfigRequest(
    ...
    def testPatchProjectFcmConfigRequest(self):
        """Test PatchProjectFcmConfigRequest"""
