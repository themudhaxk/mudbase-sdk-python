...
class TestGetGlobalAnalytics200Response(unittest.TestCase):
    """GetGlobalAnalytics200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGlobalAnalytics200Response:
        """Test GetGlobalAnalytics200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGlobalAnalytics200Response`
        """
        model = GetGlobalAnalytics200Response()
        if include_optional:
            return GetGlobalAnalytics200Response(
                active_connections = 56,
                peak_connections = 56,
                total_events = 56,
                events_per_minute = 56
            )
        else:
            return GetGlobalAnalytics200Response(
        )
    ...
    def testGetGlobalAnalytics200Response(self):
        """Test GetGlobalAnalytics200Response"""
