...
class TestAdminMemberRolePatchRequest(unittest.TestCase):
    """AdminMemberRolePatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminMemberRolePatchRequest:
        """Test AdminMemberRolePatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminMemberRolePatchRequest`
        """
        model = AdminMemberRolePatchRequest()
        if include_optional:
            return AdminMemberRolePatchRequest(
                role = 'owner',
                reason = ''
            )
        else:
    ...
    def testAdminMemberRolePatchRequest(self):
        """Test AdminMemberRolePatchRequest"""
