...
class TestProjectSmtpPatchRequest(unittest.TestCase):
    """ProjectSmtpPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSmtpPatchRequest:
        """Test ProjectSmtpPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectSmtpPatchRequest`
        """
        model = ProjectSmtpPatchRequest()
        if include_optional:
            return ProjectSmtpPatchRequest(
                enabled = True,
                host = '',
                port = 56,
                secure = True,
    ...
    def testProjectSmtpPatchRequest(self):
        """Test ProjectSmtpPatchRequest"""
