...
class TestProjectUsageResponse(unittest.TestCase):
    """ProjectUsageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectUsageResponse:
        """Test ProjectUsageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectUsageResponse`
        """
        model = ProjectUsageResponse()
        if include_optional:
    ...
    def testProjectUsageResponse(self):
        """Test ProjectUsageResponse"""
