...
class TestApiKycWebhookConfigPutRequest(unittest.TestCase):
    """ApiKycWebhookConfigPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycWebhookConfigPutRequest:
        """Test ApiKycWebhookConfigPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycWebhookConfigPutRequest`
        """
        model = ApiKycWebhookConfigPutRequest()
        if include_optional:
            return ApiKycWebhookConfigPutRequest(
                webhook_url = '',
    ...
    def testApiKycWebhookConfigPutRequest(self):
        """Test ApiKycWebhookConfigPutRequest"""
