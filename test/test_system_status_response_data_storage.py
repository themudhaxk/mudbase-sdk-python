...
class TestSystemStatusResponseDataStorage(unittest.TestCase):
    """SystemStatusResponseDataStorage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemStatusResponseDataStorage:
        """Test SystemStatusResponseDataStorage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemStatusResponseDataStorage`
        """
        model = SystemStatusResponseDataStorage()
        if include_optional:
            return SystemStatusResponseDataStorage(
                used = 56,
                available = 56,
                percentage = 1.337
            )
    ...
    def testSystemStatusResponseDataStorage(self):
        """Test SystemStatusResponseDataStorage"""
