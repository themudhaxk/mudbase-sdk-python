...
class TestGetProjectFcmConfig200ResponseData(unittest.TestCase):
    """GetProjectFcmConfig200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectFcmConfig200ResponseData:
        """Test GetProjectFcmConfig200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectFcmConfig200ResponseData`
        """
        model = GetProjectFcmConfig200ResponseData()
        if include_optional:
            return GetProjectFcmConfig200ResponseData(
    ...
    def testGetProjectFcmConfig200ResponseData(self):
        """Test GetProjectFcmConfig200ResponseData"""
