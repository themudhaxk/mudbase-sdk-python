...
class TestListProjectEmailTemplates200Response(unittest.TestCase):
    """ListProjectEmailTemplates200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListProjectEmailTemplates200Response:
        """Test ListProjectEmailTemplates200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListProjectEmailTemplates200Response`
        """
        model = ListProjectEmailTemplates200Response()
        if include_optional:
            return ListProjectEmailTemplates200Response(
                success = True,
                data = [
                    mudbase.models.email_template_catalog_item.EmailTemplateCatalogItem(
                        name = '', 
                        is_customized = True, 
    ...
    def testListProjectEmailTemplates200Response(self):
        """Test ListProjectEmailTemplates200Response"""
