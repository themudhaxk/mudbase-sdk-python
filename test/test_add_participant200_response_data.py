...
class TestAddParticipant200ResponseData(unittest.TestCase):
    """AddParticipant200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddParticipant200ResponseData:
        """Test AddParticipant200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddParticipant200ResponseData`
        """
        model = AddParticipant200ResponseData()
        if include_optional:
            return AddParticipant200ResponseData(
                participants = [
                    mudbase.models.add_participant_200_response_data_participants_inner.addParticipant_200_response_data_participants_inner(
                        user_id = '', 
                        role = '', 
    ...
    def testAddParticipant200ResponseData(self):
        """Test AddParticipant200ResponseData"""
