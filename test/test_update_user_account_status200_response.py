...
class TestUpdateUserAccountStatus200Response(unittest.TestCase):
    """UpdateUserAccountStatus200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateUserAccountStatus200Response:
        """Test UpdateUserAccountStatus200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateUserAccountStatus200Response`
        """
        model = UpdateUserAccountStatus200Response()
        if include_optional:
            return UpdateUserAccountStatus200Response(
                message = '',
                user = mudbase.models.update_user_account_status_200_response_user.updateUserAccountStatus_200_response_user(
                    _id = '', 
                    email = '', 
                    first_name = '', 
                    last_name = '', 
    ...
    def testUpdateUserAccountStatus200Response(self):
        """Test UpdateUserAccountStatus200Response"""
