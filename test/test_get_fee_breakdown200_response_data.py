...
class TestGetFeeBreakdown200ResponseData(unittest.TestCase):
    """GetFeeBreakdown200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeeBreakdown200ResponseData:
        """Test GetFeeBreakdown200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeeBreakdown200ResponseData`
        """
        model = GetFeeBreakdown200ResponseData()
        if include_optional:
            return GetFeeBreakdown200ResponseData(
                amount = 1.337,
                currency = '',
                org_receives = 1.337,
    ...
    def testGetFeeBreakdown200ResponseData(self):
        """Test GetFeeBreakdown200ResponseData"""
