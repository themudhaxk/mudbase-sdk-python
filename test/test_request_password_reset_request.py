...
class TestRequestPasswordResetRequest(unittest.TestCase):
    """RequestPasswordResetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestPasswordResetRequest:
        """Test RequestPasswordResetRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestPasswordResetRequest`
        """
    ...
    def testRequestPasswordResetRequest(self):
        """Test RequestPasswordResetRequest"""
