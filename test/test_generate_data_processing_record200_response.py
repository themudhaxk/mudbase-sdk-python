...
class TestGenerateDataProcessingRecord200Response(unittest.TestCase):
    """GenerateDataProcessingRecord200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateDataProcessingRecord200Response:
        """Test GenerateDataProcessingRecord200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateDataProcessingRecord200Response`
        """
        model = GenerateDataProcessingRecord200Response()
        if include_optional:
            return GenerateDataProcessingRecord200Response(
                record = mudbase.models.generate_data_processing_record_200_response_record.generateDataProcessingRecord_200_response_record(
                    org_id = '', 
                    record_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    data_controller = mudbase.models.data_controller.dataController(), 
    ...
    def testGenerateDataProcessingRecord200Response(self):
        """Test GenerateDataProcessingRecord200Response"""
