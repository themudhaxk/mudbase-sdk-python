...
class TestConfirmAddressVerificationRequest(unittest.TestCase):
    """ConfirmAddressVerificationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfirmAddressVerificationRequest:
        """Test ConfirmAddressVerificationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfirmAddressVerificationRequest`
        """
        model = ConfirmAddressVerificationRequest()
        if include_optional:
            return ConfirmAddressVerificationRequest(
                tx_hash = ''
            )
        else:
            return ConfirmAddressVerificationRequest(
    ...
    def testConfirmAddressVerificationRequest(self):
        """Test ConfirmAddressVerificationRequest"""
