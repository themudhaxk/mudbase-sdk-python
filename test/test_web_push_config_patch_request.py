...
class TestWebPushConfigPatchRequest(unittest.TestCase):
    """WebPushConfigPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushConfigPatchRequest:
        """Test WebPushConfigPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushConfigPatchRequest`
        """
        model = WebPushConfigPatchRequest()
        if include_optional:
            return WebPushConfigPatchRequest(
                enabled = True,
                rotate_keys = True,
                subject = ''
            )
    ...
    def testWebPushConfigPatchRequest(self):
        """Test WebPushConfigPatchRequest"""
