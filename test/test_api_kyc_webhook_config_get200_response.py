...
class TestApiKycWebhookConfigGet200Response(unittest.TestCase):
    """ApiKycWebhookConfigGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycWebhookConfigGet200Response:
        """Test ApiKycWebhookConfigGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycWebhookConfigGet200Response`
        """
        model = ApiKycWebhookConfigGet200Response()
        if include_optional:
    ...
    def testApiKycWebhookConfigGet200Response(self):
        """Test ApiKycWebhookConfigGet200Response"""
