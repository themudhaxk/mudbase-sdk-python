...
class TestProjectSmsByoPublic(unittest.TestCase):
    """ProjectSmsByoPublic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSmsByoPublic:
        """Test ProjectSmsByoPublic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectSmsByoPublic`
        """
        model = ProjectSmsByoPublic()
        if include_optional:
            return ProjectSmsByoPublic(
                enabled = True,
                provider = 'twilio',
                default_from = '',
    ...
    def testProjectSmsByoPublic(self):
        """Test ProjectSmsByoPublic"""
