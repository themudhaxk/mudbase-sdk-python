...
class TestGetPaymentRecords200ResponseDataPagination(unittest.TestCase):
    """GetPaymentRecords200ResponseDataPagination unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentRecords200ResponseDataPagination:
        """Test GetPaymentRecords200ResponseDataPagination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentRecords200ResponseDataPagination`
        """
        model = GetPaymentRecords200ResponseDataPagination()
        if include_optional:
            return GetPaymentRecords200ResponseDataPagination(
                page = 56,
                limit = 56,
                total = 56,
                pages = 56
    ...
    def testGetPaymentRecords200ResponseDataPagination(self):
        """Test GetPaymentRecords200ResponseDataPagination"""
