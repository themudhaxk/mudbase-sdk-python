...
class TestDashboardOverviewDataLatencyTopRoutesByImpactHintInner(unittest.TestCase):
    """DashboardOverviewDataLatencyTopRoutesByImpactHintInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardOverviewDataLatencyTopRoutesByImpactHintInner:
        """Test DashboardOverviewDataLatencyTopRoutesByImpactHintInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardOverviewDataLatencyTopRoutesByImpactHintInner`
        """
        model = DashboardOverviewDataLatencyTopRoutesByImpactHintInner()
        if include_optional:
            return DashboardOverviewDataLatencyTopRoutesByImpactHintInner(
                route_key = '',
                p50_ms = 56,
                p95_ms = 56,
                count = 56,
    ...
    def testDashboardOverviewDataLatencyTopRoutesByImpactHintInner(self):
        """Test DashboardOverviewDataLatencyTopRoutesByImpactHintInner"""
