...
class TestCreatePlanRequestTrial(unittest.TestCase):
    """CreatePlanRequestTrial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePlanRequestTrial:
        """Test CreatePlanRequestTrial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePlanRequestTrial`
        """
        model = CreatePlanRequestTrial()
        if include_optional:
            return CreatePlanRequestTrial(
                enabled = True,
                days = 1.337
            )
        else:
    ...
    def testCreatePlanRequestTrial(self):
        """Test CreatePlanRequestTrial"""
