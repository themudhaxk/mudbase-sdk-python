...
class TestOrgAddDomainResponse(unittest.TestCase):
    """OrgAddDomainResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgAddDomainResponse:
        """Test OrgAddDomainResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgAddDomainResponse`
        """
        model = OrgAddDomainResponse()
        if include_optional:
    ...
    def testOrgAddDomainResponse(self):
        """Test OrgAddDomainResponse"""
