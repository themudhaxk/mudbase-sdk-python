...
class TestGetBillingEstimate200ResponseLineItemsInner(unittest.TestCase):
    """GetBillingEstimate200ResponseLineItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBillingEstimate200ResponseLineItemsInner:
        """Test GetBillingEstimate200ResponseLineItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBillingEstimate200ResponseLineItemsInner`
        """
        model = GetBillingEstimate200ResponseLineItemsInner()
        if include_optional:
            return GetBillingEstimate200ResponseLineItemsInner(
                resource = '',
                units = 1.337,
                amount = 1.337,
                currency = '',
    ...
    def testGetBillingEstimate200ResponseLineItemsInner(self):
        """Test GetBillingEstimate200ResponseLineItemsInner"""
