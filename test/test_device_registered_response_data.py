...
class TestDeviceRegisteredResponseData(unittest.TestCase):
    """DeviceRegisteredResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceRegisteredResponseData:
        """Test DeviceRegisteredResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceRegisteredResponseData`
        """
        model = DeviceRegisteredResponseData()
        if include_optional:
            return DeviceRegisteredResponseData(
                token = '',
                platform = 'ios',
    ...
    def testDeviceRegisteredResponseData(self):
        """Test DeviceRegisteredResponseData"""
