...
class TestRegenerateApiKey200Response(unittest.TestCase):
    """RegenerateApiKey200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegenerateApiKey200Response:
        """Test RegenerateApiKey200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegenerateApiKey200Response`
        """
        model = RegenerateApiKey200Response()
        if include_optional:
    ...
    def testRegenerateApiKey200Response(self):
        """Test RegenerateApiKey200Response"""
