...
class TestInviteTeamMember200Response(unittest.TestCase):
    """InviteTeamMember200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteTeamMember200Response:
        """Test InviteTeamMember200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteTeamMember200Response`
        """
        model = InviteTeamMember200Response()
        if include_optional:
    ...
    def testInviteTeamMember200Response(self):
        """Test InviteTeamMember200Response"""
