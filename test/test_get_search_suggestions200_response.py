...
class TestGetSearchSuggestions200Response(unittest.TestCase):
    """GetSearchSuggestions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSearchSuggestions200Response:
        """Test GetSearchSuggestions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSearchSuggestions200Response`
        """
        model = GetSearchSuggestions200Response()
        if include_optional:
    ...
    def testGetSearchSuggestions200Response(self):
        """Test GetSearchSuggestions200Response"""
