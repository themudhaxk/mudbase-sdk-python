...
class TestGetProjectCaptchaConfig200Response(unittest.TestCase):
    """GetProjectCaptchaConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectCaptchaConfig200Response:
        """Test GetProjectCaptchaConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectCaptchaConfig200Response`
        """
        model = GetProjectCaptchaConfig200Response()
        if include_optional:
            return GetProjectCaptchaConfig200Response(
                captcha = mudbase.models.get_project_captcha_config_200_response_captcha.getProjectCaptchaConfig_200_response_captcha(
                    enabled = True, 
                    version = 'v2', 
                    site_key = '', 
                    min_score = 0, )
    ...
    def testGetProjectCaptchaConfig200Response(self):
        """Test GetProjectCaptchaConfig200Response"""
