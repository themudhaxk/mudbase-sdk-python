...
class TestCheckUserPresence200ResponsePresenceValue(unittest.TestCase):
    """CheckUserPresence200ResponsePresenceValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckUserPresence200ResponsePresenceValue:
        """Test CheckUserPresence200ResponsePresenceValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckUserPresence200ResponsePresenceValue`
        """
        model = CheckUserPresence200ResponsePresenceValue()
        if include_optional:
            return CheckUserPresence200ResponsePresenceValue(
                online = True,
    ...
    def testCheckUserPresence200ResponsePresenceValue(self):
        """Test CheckUserPresence200ResponsePresenceValue"""
