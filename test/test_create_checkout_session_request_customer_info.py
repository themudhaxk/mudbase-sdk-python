...
class TestCreateCheckoutSessionRequestCustomerInfo(unittest.TestCase):
    """CreateCheckoutSessionRequestCustomerInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCheckoutSessionRequestCustomerInfo:
        """Test CreateCheckoutSessionRequestCustomerInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCheckoutSessionRequestCustomerInfo`
        """
        model = CreateCheckoutSessionRequestCustomerInfo()
        if include_optional:
            return CreateCheckoutSessionRequestCustomerInfo(
                email = '',
                name = ''
            )
        else:
    ...
    def testCreateCheckoutSessionRequestCustomerInfo(self):
        """Test CreateCheckoutSessionRequestCustomerInfo"""
