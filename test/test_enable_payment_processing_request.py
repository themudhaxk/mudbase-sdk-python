...
class TestEnablePaymentProcessingRequest(unittest.TestCase):
    """EnablePaymentProcessingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnablePaymentProcessingRequest:
        """Test EnablePaymentProcessingRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnablePaymentProcessingRequest`
        """
        model = EnablePaymentProcessingRequest()
        if include_optional:
            return EnablePaymentProcessingRequest(
                account_bank = '',
                account_number = '',
                country = '',
                business_name = '',
    ...
    def testEnablePaymentProcessingRequest(self):
        """Test EnablePaymentProcessingRequest"""
