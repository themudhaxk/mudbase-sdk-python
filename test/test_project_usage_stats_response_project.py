...
class TestProjectUsageStatsResponseProject(unittest.TestCase):
    """ProjectUsageStatsResponseProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectUsageStatsResponseProject:
        """Test ProjectUsageStatsResponseProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectUsageStatsResponseProject`
        """
        model = ProjectUsageStatsResponseProject()
        if include_optional:
            return ProjectUsageStatsResponseProject(
                id = '',
                name = ''
            )
        else:
    ...
    def testProjectUsageStatsResponseProject(self):
        """Test ProjectUsageStatsResponseProject"""
