...
class TestGenerateDataProcessingRecord200ResponseRecord(unittest.TestCase):
    """GenerateDataProcessingRecord200ResponseRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateDataProcessingRecord200ResponseRecord:
        """Test GenerateDataProcessingRecord200ResponseRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateDataProcessingRecord200ResponseRecord`
        """
        model = GenerateDataProcessingRecord200ResponseRecord()
        if include_optional:
            return GenerateDataProcessingRecord200ResponseRecord(
                org_id = '',
    ...
    def testGenerateDataProcessingRecord200ResponseRecord(self):
        """Test GenerateDataProcessingRecord200ResponseRecord"""
