...
class TestGetOrgOAuthProviders200Response(unittest.TestCase):
    """GetOrgOAuthProviders200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrgOAuthProviders200Response:
        """Test GetOrgOAuthProviders200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrgOAuthProviders200Response`
        """
        model = GetOrgOAuthProviders200Response()
        if include_optional:
            return GetOrgOAuthProviders200Response(
                providers = [
                    mudbase.models.get_org_o_auth_providers_200_response_providers_inner.getOrgOAuthProviders_200_response_providers_inner(
                        name = 'google', 
                        display_name = 'Google', 
                        strategy = 'google', 
    ...
    def testGetOrgOAuthProviders200Response(self):
        """Test GetOrgOAuthProviders200Response"""
