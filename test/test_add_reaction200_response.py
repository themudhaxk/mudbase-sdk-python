...
class TestAddReaction200Response(unittest.TestCase):
    """AddReaction200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddReaction200Response:
        """Test AddReaction200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddReaction200Response`
        """
        model = AddReaction200Response()
        if include_optional:
            return AddReaction200Response(
                success = True,
                data = [
                    mudbase.models.add_reaction_200_response_data_inner.addReaction_200_response_data_inner(
                        emoji = '', 
                        users = [
                            ''
                            ], )
    ...
    def testAddReaction200Response(self):
        """Test AddReaction200Response"""
