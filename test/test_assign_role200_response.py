...
class TestAssignRole200Response(unittest.TestCase):
    """AssignRole200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignRole200Response:
        """Test AssignRole200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignRole200Response`
        """
        model = AssignRole200Response()
        if include_optional:
    ...
    def testAssignRole200Response(self):
        """Test AssignRole200Response"""
