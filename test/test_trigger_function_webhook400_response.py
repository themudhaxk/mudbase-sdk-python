...
class TestTriggerFunctionWebhook400Response(unittest.TestCase):
    """TriggerFunctionWebhook400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerFunctionWebhook400Response:
        """Test TriggerFunctionWebhook400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerFunctionWebhook400Response`
        """
        model = TriggerFunctionWebhook400Response()
        if include_optional:
            return TriggerFunctionWebhook400Response(
                success = False,
                error = ''
            )
        else:
    ...
    def testTriggerFunctionWebhook400Response(self):
        """Test TriggerFunctionWebhook400Response"""
