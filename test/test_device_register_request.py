...
class TestDeviceRegisterRequest(unittest.TestCase):
    """DeviceRegisterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceRegisterRequest:
        """Test DeviceRegisterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceRegisterRequest`
        """
    ...
    def testDeviceRegisterRequest(self):
        """Test DeviceRegisterRequest"""
