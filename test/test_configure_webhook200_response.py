...
class TestConfigureWebhook200Response(unittest.TestCase):
    """ConfigureWebhook200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureWebhook200Response:
        """Test ConfigureWebhook200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureWebhook200Response`
        """
        model = ConfigureWebhook200Response()
        if include_optional:
            return ConfigureWebhook200Response(
                success = True,
                message = '',
                data = mudbase.models.configure_webhook_200_response_data.configureWebhook_200_response_data(
                    webhook_url = '', 
                    webhook_events = [
                        ''
                        ], 
                    webhook_version = '', 
                    transformations = [
                        mudbase.models.configure_webhook_200_response_data_transformations_inner.configureWebhook_200_response_data_transformations_inner(
                            type = 'jsonPath', 
    ...
    def testConfigureWebhook200Response(self):
        """Test ConfigureWebhook200Response"""
