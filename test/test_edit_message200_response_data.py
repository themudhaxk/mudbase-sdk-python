...
class TestEditMessage200ResponseData(unittest.TestCase):
    """EditMessage200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessage200ResponseData:
        """Test EditMessage200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessage200ResponseData`
        """
        model = EditMessage200ResponseData()
        if include_optional:
            return EditMessage200ResponseData(
                id = '',
                content = '',
                is_e2ee = True,
                e2ee = None,
    ...
    def testEditMessage200ResponseData(self):
        """Test EditMessage200ResponseData"""
