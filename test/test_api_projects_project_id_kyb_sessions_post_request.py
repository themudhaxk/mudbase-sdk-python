...
class TestApiProjectsProjectIdKybSessionsPostRequest(unittest.TestCase):
    """ApiProjectsProjectIdKybSessionsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiProjectsProjectIdKybSessionsPostRequest:
        """Test ApiProjectsProjectIdKybSessionsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiProjectsProjectIdKybSessionsPostRequest`
        """
        model = ApiProjectsProjectIdKybSessionsPostRequest()
        if include_optional:
            return ApiProjectsProjectIdKybSessionsPostRequest(
                workflow_id = '',
                vendor_business_id = '',
                vendor_data = '',
                callback = '',
    ...
    def testApiProjectsProjectIdKybSessionsPostRequest(self):
        """Test ApiProjectsProjectIdKybSessionsPostRequest"""
