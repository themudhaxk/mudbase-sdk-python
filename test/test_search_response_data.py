...
class TestSearchResponseData(unittest.TestCase):
    """SearchResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchResponseData:
        """Test SearchResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchResponseData`
        """
        model = SearchResponseData()
        if include_optional:
            return SearchResponseData(
                results = [
                    mudbase.models.search_result.SearchResult(
                        collection = '', 
                        item = mudbase.models.search_result_item.SearchResult_item(
                            _id = '', 
                            score = 1.337, ), 
                        highlight = mudbase.models.highlight.highlight(), )
                    ],
    ...
    def testSearchResponseData(self):
        """Test SearchResponseData"""
