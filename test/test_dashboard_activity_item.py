...
class TestDashboardActivityItem(unittest.TestCase):
    """DashboardActivityItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardActivityItem:
        """Test DashboardActivityItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardActivityItem`
        """
        model = DashboardActivityItem()
        if include_optional:
    ...
    def testDashboardActivityItem(self):
        """Test DashboardActivityItem"""
