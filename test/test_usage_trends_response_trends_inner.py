...
class TestUsageTrendsResponseTrendsInner(unittest.TestCase):
    """UsageTrendsResponseTrendsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageTrendsResponseTrendsInner:
        """Test UsageTrendsResponseTrendsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageTrendsResponseTrendsInner`
        """
        model = UsageTrendsResponseTrendsInner()
        if include_optional:
            return UsageTrendsResponseTrendsInner(
                id = mudbase.models.usage_trends_response_trends_inner__id.UsageTrendsResponse_trends_inner__id(
                    year = 56, 
                    month = 56, 
                    day = 56, ),
                api_calls = 56,
    ...
    def testUsageTrendsResponseTrendsInner(self):
        """Test UsageTrendsResponseTrendsInner"""
