...
class TestRefreshToken400Response(unittest.TestCase):
    """RefreshToken400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RefreshToken400Response:
        """Test RefreshToken400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefreshToken400Response`
        """
        model = RefreshToken400Response()
        if include_optional:
    ...
    def testRefreshToken400Response(self):
        """Test RefreshToken400Response"""
