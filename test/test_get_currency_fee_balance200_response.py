...
class TestGetCurrencyFeeBalance200Response(unittest.TestCase):
    """GetCurrencyFeeBalance200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCurrencyFeeBalance200Response:
        """Test GetCurrencyFeeBalance200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCurrencyFeeBalance200Response`
        """
        model = GetCurrencyFeeBalance200Response()
        if include_optional:
            return GetCurrencyFeeBalance200Response(
                success = True,
                data = mudbase.models.get_currency_fee_balance_200_response_data.getCurrencyFeeBalance_200_response_data(
                    currency = '', 
                    collected_amount = 1.337, 
                    threshold = 1.337, 
                    status = '', )
            )
        else:
    ...
    def testGetCurrencyFeeBalance200Response(self):
        """Test GetCurrencyFeeBalance200Response"""
