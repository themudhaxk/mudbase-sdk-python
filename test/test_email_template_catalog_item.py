...
class TestEmailTemplateCatalogItem(unittest.TestCase):
    """EmailTemplateCatalogItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailTemplateCatalogItem:
        """Test EmailTemplateCatalogItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailTemplateCatalogItem`
        """
        model = EmailTemplateCatalogItem()
        if include_optional:
            return EmailTemplateCatalogItem(
                name = '',
                is_customized = True,
    ...
    def testEmailTemplateCatalogItem(self):
        """Test EmailTemplateCatalogItem"""
