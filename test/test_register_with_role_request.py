...
class TestRegisterWithRoleRequest(unittest.TestCase):
    """RegisterWithRoleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterWithRoleRequest:
        """Test RegisterWithRoleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterWithRoleRequest`
        """
        model = RegisterWithRoleRequest()
        if include_optional:
            return RegisterWithRoleRequest(
                email = '',
                password = '',
                first_name = '',
                last_name = '',
    ...
    def testRegisterWithRoleRequest(self):
        """Test RegisterWithRoleRequest"""
