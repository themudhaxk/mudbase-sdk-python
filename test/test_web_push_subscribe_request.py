...
class TestWebPushSubscribeRequest(unittest.TestCase):
    """WebPushSubscribeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushSubscribeRequest:
        """Test WebPushSubscribeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushSubscribeRequest`
        """
        model = WebPushSubscribeRequest()
        if include_optional:
            return WebPushSubscribeRequest(
                subscription = mudbase.models.web_push_subscription.WebPushSubscription(
                    endpoint = '', 
                    keys = mudbase.models.web_push_subscription_keys.WebPushSubscription_keys(
                        p256dh = '', 
                        auth = '', ), ),
                user_id = '',
                device_id = ''
    ...
    def testWebPushSubscribeRequest(self):
        """Test WebPushSubscribeRequest"""
