...
class TestGetOrganizationUsers200ResponseUsersInner(unittest.TestCase):
    """GetOrganizationUsers200ResponseUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrganizationUsers200ResponseUsersInner:
        """Test GetOrganizationUsers200ResponseUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrganizationUsers200ResponseUsersInner`
        """
        model = GetOrganizationUsers200ResponseUsersInner()
        if include_optional:
            return GetOrganizationUsers200ResponseUsersInner(
                id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testGetOrganizationUsers200ResponseUsersInner(self):
        """Test GetOrganizationUsers200ResponseUsersInner"""
