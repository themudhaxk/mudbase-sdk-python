...
class TestTriggerWebhookRequest(unittest.TestCase):
    """TriggerWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerWebhookRequest:
        """Test TriggerWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerWebhookRequest`
        """
        model = TriggerWebhookRequest()
        if include_optional:
    ...
    def testTriggerWebhookRequest(self):
        """Test TriggerWebhookRequest"""
