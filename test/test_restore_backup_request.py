...
class TestRestoreBackupRequest(unittest.TestCase):
    """RestoreBackupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestoreBackupRequest:
        """Test RestoreBackupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestoreBackupRequest`
        """
        model = RestoreBackupRequest()
        if include_optional:
    ...
    def testRestoreBackupRequest(self):
        """Test RestoreBackupRequest"""
