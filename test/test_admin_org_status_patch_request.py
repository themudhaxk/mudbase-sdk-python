...
class TestAdminOrgStatusPatchRequest(unittest.TestCase):
    """AdminOrgStatusPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminOrgStatusPatchRequest:
        """Test AdminOrgStatusPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminOrgStatusPatchRequest`
        """
        model = AdminOrgStatusPatchRequest()
        if include_optional:
            return AdminOrgStatusPatchRequest(
                is_active = True,
    ...
    def testAdminOrgStatusPatchRequest(self):
        """Test AdminOrgStatusPatchRequest"""
