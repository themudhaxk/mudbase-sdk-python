...
class TestOrgDnsInstructionsResponse(unittest.TestCase):
    """OrgDnsInstructionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgDnsInstructionsResponse:
        """Test OrgDnsInstructionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgDnsInstructionsResponse`
        """
        model = OrgDnsInstructionsResponse()
        if include_optional:
            return OrgDnsInstructionsResponse(
                success = True,
                domain = mudbase.models.org_domain_entry_org_console.OrgDomainEntryOrgConsole(
                    _id = '', 
                    hostname = '', 
                    status = '', 
                    is_primary = True, 
    ...
    def testOrgDnsInstructionsResponse(self):
        """Test OrgDnsInstructionsResponse"""
