...
class TestGetProjectFcmConfig200Response(unittest.TestCase):
    """GetProjectFcmConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectFcmConfig200Response:
        """Test GetProjectFcmConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectFcmConfig200Response`
        """
        model = GetProjectFcmConfig200Response()
        if include_optional:
            return GetProjectFcmConfig200Response(
                success = True,
                data = mudbase.models.get_project_fcm_config_200_response_data.getProjectFcmConfig_200_response_data(
    ...
    def testGetProjectFcmConfig200Response(self):
        """Test GetProjectFcmConfig200Response"""
