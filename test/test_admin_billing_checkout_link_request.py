...
class TestAdminBillingCheckoutLinkRequest(unittest.TestCase):
    """AdminBillingCheckoutLinkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminBillingCheckoutLinkRequest:
        """Test AdminBillingCheckoutLinkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminBillingCheckoutLinkRequest`
        """
        model = AdminBillingCheckoutLinkRequest()
        if include_optional:
            return AdminBillingCheckoutLinkRequest(
                plan = 'starter',
    ...
    def testAdminBillingCheckoutLinkRequest(self):
        """Test AdminBillingCheckoutLinkRequest"""
