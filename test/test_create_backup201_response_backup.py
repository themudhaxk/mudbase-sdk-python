...
class TestCreateBackup201ResponseBackup(unittest.TestCase):
    """CreateBackup201ResponseBackup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateBackup201ResponseBackup:
        """Test CreateBackup201ResponseBackup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateBackup201ResponseBackup`
        """
        model = CreateBackup201ResponseBackup()
        if include_optional:
            return CreateBackup201ResponseBackup(
                id = '',
                project = '',
                description = '',
                status = 'in_progress',
    ...
    def testCreateBackup201ResponseBackup(self):
        """Test CreateBackup201ResponseBackup"""
