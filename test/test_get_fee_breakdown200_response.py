...
class TestGetFeeBreakdown200Response(unittest.TestCase):
    """GetFeeBreakdown200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeeBreakdown200Response:
        """Test GetFeeBreakdown200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeeBreakdown200Response`
        """
        model = GetFeeBreakdown200Response()
        if include_optional:
            return GetFeeBreakdown200Response(
                success = True,
                data = mudbase.models.get_fee_breakdown_200_response_data.getFeeBreakdown_200_response_data(
                    amount = 1.337, 
                    currency = '', 
                    org_receives = 1.337, 
    ...
    def testGetFeeBreakdown200Response(self):
        """Test GetFeeBreakdown200Response"""
