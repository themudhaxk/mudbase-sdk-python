...
class TestDashboardOverviewDataActiveUsers(unittest.TestCase):
    """DashboardOverviewDataActiveUsers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashboardOverviewDataActiveUsers:
        """Test DashboardOverviewDataActiveUsers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashboardOverviewDataActiveUsers`
        """
        model = DashboardOverviewDataActiveUsers()
        if include_optional:
            return DashboardOverviewDataActiveUsers(
                last24h = 56,
                last7d = 56,
                last30d = 56,
                change_pct7d = 1.337,
    ...
    def testDashboardOverviewDataActiveUsers(self):
        """Test DashboardOverviewDataActiveUsers"""
