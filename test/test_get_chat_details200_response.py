...
class TestGetChatDetails200Response(unittest.TestCase):
    """GetChatDetails200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChatDetails200Response:
        """Test GetChatDetails200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChatDetails200Response`
        """
        model = GetChatDetails200Response()
        if include_optional:
            return GetChatDetails200Response(
                success = True,
                data = mudbase.models.get_chat_details_200_response_data.getChatDetails_200_response_data(
                    _id = '', 
                    name = '', 
                    participants = [
                        mudbase.models.get_chat_details_200_response_data_participants_inner.getChatDetails_200_response_data_participants_inner(
                            user_id = '', 
                            role = '', )
                        ], )
            )
    ...
    def testGetChatDetails200Response(self):
        """Test GetChatDetails200Response"""
