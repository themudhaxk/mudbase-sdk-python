...
class TestGetIntegrations200Response(unittest.TestCase):
    """GetIntegrations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIntegrations200Response:
        """Test GetIntegrations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIntegrations200Response`
        """
        model = GetIntegrations200Response()
        if include_optional:
            return GetIntegrations200Response(
                integrations = [
                    mudbase.models.get_integrations_200_response_integrations_inner.getIntegrations_200_response_integrations_inner(
                        _id = '', 
                        name = '', 
                        provider = '', 
                        status = '', )
    ...
    def testGetIntegrations200Response(self):
        """Test GetIntegrations200Response"""
