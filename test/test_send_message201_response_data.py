...
class TestSendMessage201ResponseData(unittest.TestCase):
    """SendMessage201ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendMessage201ResponseData:
        """Test SendMessage201ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendMessage201ResponseData`
        """
        model = SendMessage201ResponseData()
        if include_optional:
            return SendMessage201ResponseData(
                id = '',
                content = '',
                sender = '',
    ...
    def testSendMessage201ResponseData(self):
        """Test SendMessage201ResponseData"""
