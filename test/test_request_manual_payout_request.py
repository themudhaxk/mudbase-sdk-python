...
class TestRequestManualPayoutRequest(unittest.TestCase):
    """RequestManualPayoutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestManualPayoutRequest:
        """Test RequestManualPayoutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestManualPayoutRequest`
        """
        model = RequestManualPayoutRequest()
        if include_optional:
            return RequestManualPayoutRequest(
                currency = ''
            )
        else:
            return RequestManualPayoutRequest(
    ...
    def testRequestManualPayoutRequest(self):
        """Test RequestManualPayoutRequest"""
