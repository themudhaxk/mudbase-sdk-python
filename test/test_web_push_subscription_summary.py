...
class TestWebPushSubscriptionSummary(unittest.TestCase):
    """WebPushSubscriptionSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushSubscriptionSummary:
        """Test WebPushSubscriptionSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushSubscriptionSummary`
        """
        model = WebPushSubscriptionSummary()
        if include_optional:
            return WebPushSubscriptionSummary(
                endpoint = '',
                user_id = '',
                device_id = '',
                user_agent = '',
    ...
    def testWebPushSubscriptionSummary(self):
        """Test WebPushSubscriptionSummary"""
