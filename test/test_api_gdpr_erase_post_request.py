...
class TestApiGdprErasePostRequest(unittest.TestCase):
    """ApiGdprErasePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiGdprErasePostRequest:
        """Test ApiGdprErasePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiGdprErasePostRequest`
        """
        model = ApiGdprErasePostRequest()
        if include_optional:
            return ApiGdprErasePostRequest(
                confirm = 'DELETE',
    ...
    def testApiGdprErasePostRequest(self):
        """Test ApiGdprErasePostRequest"""
