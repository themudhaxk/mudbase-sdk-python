...
class TestGetOAuthProviderConfig200ResponseConfig(unittest.TestCase):
    """GetOAuthProviderConfig200ResponseConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOAuthProviderConfig200ResponseConfig:
        """Test GetOAuthProviderConfig200ResponseConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOAuthProviderConfig200ResponseConfig`
        """
        model = GetOAuthProviderConfig200ResponseConfig()
        if include_optional:
            return GetOAuthProviderConfig200ResponseConfig(
    ...
    def testGetOAuthProviderConfig200ResponseConfig(self):
        """Test GetOAuthProviderConfig200ResponseConfig"""
