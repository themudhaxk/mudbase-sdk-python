...
class TestGetBillingEstimate200ResponseSpendLimits(unittest.TestCase):
    """GetBillingEstimate200ResponseSpendLimits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBillingEstimate200ResponseSpendLimits:
        """Test GetBillingEstimate200ResponseSpendLimits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBillingEstimate200ResponseSpendLimits`
        """
        model = GetBillingEstimate200ResponseSpendLimits()
        if include_optional:
            return GetBillingEstimate200ResponseSpendLimits(
    ...
    def testGetBillingEstimate200ResponseSpendLimits(self):
        """Test GetBillingEstimate200ResponseSpendLimits"""
