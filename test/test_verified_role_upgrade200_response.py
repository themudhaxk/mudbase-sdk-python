...
class TestVerifiedRoleUpgrade200Response(unittest.TestCase):
    """VerifiedRoleUpgrade200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifiedRoleUpgrade200Response:
        """Test VerifiedRoleUpgrade200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifiedRoleUpgrade200Response`
        """
        model = VerifiedRoleUpgrade200Response()
        if include_optional:
    ...
    def testVerifiedRoleUpgrade200Response(self):
        """Test VerifiedRoleUpgrade200Response"""
