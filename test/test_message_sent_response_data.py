...
class TestMessageSentResponseData(unittest.TestCase):
    """MessageSentResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSentResponseData:
        """Test MessageSentResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSentResponseData`
        """
        model = MessageSentResponseData()
        if include_optional:
            return MessageSentResponseData(
                id = '',
                type = '',
                status = '',
                recipients = 56,
    ...
    def testMessageSentResponseData(self):
        """Test MessageSentResponseData"""
