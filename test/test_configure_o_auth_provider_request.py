...
class TestConfigureOAuthProviderRequest(unittest.TestCase):
    """ConfigureOAuthProviderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureOAuthProviderRequest:
        ...
        """
        model = ConfigureOAuthProviderRequest()
        if include_optional:
            return ConfigureOAuthProviderRequest(
                enabled = True,
    ...
    def testConfigureOAuthProviderRequest(self):
        """Test ConfigureOAuthProviderRequest"""
