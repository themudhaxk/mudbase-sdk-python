...
class TestFunctionLogsResponse(unittest.TestCase):
    """FunctionLogsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionLogsResponse:
        """Test FunctionLogsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionLogsResponse`
        """
        model = FunctionLogsResponse()
        if include_optional:
            return FunctionLogsResponse(
                success = True,
                data = mudbase.models.function_logs_response_data.FunctionLogsResponse_data(
                    executions = [
                        mudbase.models.function_execution.FunctionExecution(
                            _id = '', 
    ...
    def testFunctionLogsResponse(self):
        """Test FunctionLogsResponse"""
