...
class TestUpdateProjectRoleRequest(unittest.TestCase):
    """UpdateProjectRoleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateProjectRoleRequest:
        """Test UpdateProjectRoleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateProjectRoleRequest`
        """
    ...
    def testUpdateProjectRoleRequest(self):
        """Test UpdateProjectRoleRequest"""
