...
class TestCreatePlanRequestLimitsCustomLimitsInner(unittest.TestCase):
    """CreatePlanRequestLimitsCustomLimitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePlanRequestLimitsCustomLimitsInner:
        """Test CreatePlanRequestLimitsCustomLimitsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePlanRequestLimitsCustomLimitsInner`
        """
        model = CreatePlanRequestLimitsCustomLimitsInner()
        if include_optional:
            return CreatePlanRequestLimitsCustomLimitsInner(
                name = '',
                value = 1.337
            )
        else:
    ...
    def testCreatePlanRequestLimitsCustomLimitsInner(self):
        """Test CreatePlanRequestLimitsCustomLimitsInner"""
