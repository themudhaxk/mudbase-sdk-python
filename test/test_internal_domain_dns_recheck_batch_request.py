...
class TestInternalDomainDnsRecheckBatchRequest(unittest.TestCase):
    """InternalDomainDnsRecheckBatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalDomainDnsRecheckBatchRequest:
        """Test InternalDomainDnsRecheckBatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalDomainDnsRecheckBatchRequest`
        """
        model = InternalDomainDnsRecheckBatchRequest()
        if include_optional:
            return InternalDomainDnsRecheckBatchRequest(
                max_orgs = 56,
                recheck_older_than_hours = 56
            )
        else:
            return InternalDomainDnsRecheckBatchRequest(
        )
    ...
    def testInternalDomainDnsRecheckBatchRequest(self):
        """Test InternalDomainDnsRecheckBatchRequest"""
