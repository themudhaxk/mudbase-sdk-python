...
class TestGetFeeBalances200Response(unittest.TestCase):
    """GetFeeBalances200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFeeBalances200Response:
        """Test GetFeeBalances200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFeeBalances200Response`
        """
        model = GetFeeBalances200Response()
        if include_optional:
            return GetFeeBalances200Response(
                success = True,
                data = [
                    mudbase.models.get_fee_balances_200_response_data_inner.getFeeBalances_200_response_data_inner(
                        currency = '', 
    ...
    def testGetFeeBalances200Response(self):
        """Test GetFeeBalances200Response"""
