...
class TestGenerateSignedUrlRequest(unittest.TestCase):
    """GenerateSignedUrlRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateSignedUrlRequest:
        """Test GenerateSignedUrlRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateSignedUrlRequest`
        """
        model = GenerateSignedUrlRequest()
        if include_optional:
    ...
    def testGenerateSignedUrlRequest(self):
        """Test GenerateSignedUrlRequest"""
