...
class TestEraseUserData409Response(unittest.TestCase):
    """EraseUserData409Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EraseUserData409Response:
        """Test EraseUserData409Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EraseUserData409Response`
        """
        model = EraseUserData409Response()
        if include_optional:
            return EraseUserData409Response(
                error = '',
                sole_owned_orgs = [
                    ''
                    ]
    ...
    def testEraseUserData409Response(self):
        """Test EraseUserData409Response"""
