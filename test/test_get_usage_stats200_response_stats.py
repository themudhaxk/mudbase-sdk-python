...
class TestGetUsageStats200ResponseStats(unittest.TestCase):
    """GetUsageStats200ResponseStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUsageStats200ResponseStats:
        """Test GetUsageStats200ResponseStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUsageStats200ResponseStats`
        """
        model = GetUsageStats200ResponseStats()
        if include_optional:
            return GetUsageStats200ResponseStats(
                total_calls = 56,
                success_calls = 56,
                failed_calls = 56
            )
    ...
    def testGetUsageStats200ResponseStats(self):
        """Test GetUsageStats200ResponseStats"""
