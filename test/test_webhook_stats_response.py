...
class TestWebhookStatsResponse(unittest.TestCase):
    """WebhookStatsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookStatsResponse:
        """Test WebhookStatsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookStatsResponse`
        """
        model = WebhookStatsResponse()
        if include_optional:
            return WebhookStatsResponse(
                status_stats = [
                    mudbase.models.webhook_stats_response_status_stats_inner.WebhookStatsResponse_statusStats_inner(
                        _id = '', 
                        count = 56, 
                        avg_duration = 1.337, )
                    ],
                event_stats = [
                    mudbase.models.webhook_stats_response_event_stats_inner.WebhookStatsResponse_eventStats_inner(
                        _id = '', 
                        count = 56, 
                        success_rate = 1.337, )
                    ],
    ...
    def testWebhookStatsResponse(self):
        """Test WebhookStatsResponse"""
