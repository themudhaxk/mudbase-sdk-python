...
class TestSystemStatusResponseDataDatabase(unittest.TestCase):
    """SystemStatusResponseDataDatabase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemStatusResponseDataDatabase:
        """Test SystemStatusResponseDataDatabase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemStatusResponseDataDatabase`
        """
        model = SystemStatusResponseDataDatabase()
        if include_optional:
            return SystemStatusResponseDataDatabase(
                connections = 56,
                max_connections = 56,
                response_time = 56
            )
    ...
    def testSystemStatusResponseDataDatabase(self):
        """Test SystemStatusResponseDataDatabase"""
