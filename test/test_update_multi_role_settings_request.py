...
class TestUpdateMultiRoleSettingsRequest(unittest.TestCase):
    """UpdateMultiRoleSettingsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMultiRoleSettingsRequest:
        """Test UpdateMultiRoleSettingsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMultiRoleSettingsRequest`
        """
        model = UpdateMultiRoleSettingsRequest()
        if include_optional:
            return UpdateMultiRoleSettingsRequest(
                is_enabled = True,
                default_role = 'customer',
                settings = mudbase.models.update_multi_role_settings_request_settings.updateMultiRoleSettings_request_settings(
                    allow_multiple_roles = True, 
                    require_role_selection = True, 
                    auto_assign_default = True, 
                    data_owner_field = 'createdBy', )
            )
        else:
            return UpdateMultiRoleSettingsRequest(
        )
    ...
    def testUpdateMultiRoleSettingsRequest(self):
        """Test UpdateMultiRoleSettingsRequest"""
