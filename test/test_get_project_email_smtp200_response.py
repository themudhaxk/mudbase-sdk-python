...
class TestGetProjectEmailSmtp200Response(unittest.TestCase):
    """GetProjectEmailSmtp200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProjectEmailSmtp200Response:
        """Test GetProjectEmailSmtp200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProjectEmailSmtp200Response`
        """
        model = GetProjectEmailSmtp200Response()
        if include_optional:
            return GetProjectEmailSmtp200Response(
                success = True,
                data = mudbase.models.project_smtp_settings_public.ProjectSmtpSettingsPublic(
                    enabled = True, 
                    host = '', 
                    port = 56, 
                    secure = True, 
                    ...
                    from_name = '', 
                    from_email = '', 
                    domain_verified_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
            )
        else:
            return GetProjectEmailSmtp200Response(
        )
    ...
    def testGetProjectEmailSmtp200Response(self):
        """Test GetProjectEmailSmtp200Response"""
