...
class TestTestWebhookTransformation200Response(unittest.TestCase):
    """TestWebhookTransformation200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestWebhookTransformation200Response:
        """Test TestWebhookTransformation200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestWebhookTransformation200Response`
        """
        model = TestWebhookTransformation200Response()
        if include_optional:
            return TestWebhookTransformation200Response(
                success = True,
                data = mudbase.models.test_webhook_transformation_200_response_data.testWebhookTransformation_200_response_data(
                    original = mudbase.models.original.original(), 
                    transformed = mudbase.models.transformed.transformed(), )
            )
        else:
            return TestWebhookTransformation200Response(
        )
    ...
    def testTestWebhookTransformation200Response(self):
        """Test TestWebhookTransformation200Response"""
