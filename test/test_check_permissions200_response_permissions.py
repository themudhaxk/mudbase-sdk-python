...
class TestCheckPermissions200ResponsePermissions(unittest.TestCase):
    """CheckPermissions200ResponsePermissions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckPermissions200ResponsePermissions:
        """Test CheckPermissions200ResponsePermissions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckPermissions200ResponsePermissions`
        """
        model = CheckPermissions200ResponsePermissions()
        if include_optional:
            return CheckPermissions200ResponsePermissions(
                system = [
                    ''
                    ],
                custom = [
    ...
    def testCheckPermissions200ResponsePermissions(self):
        """Test CheckPermissions200ResponsePermissions"""
