...
class TestConfigureOAuthProvider200Response(unittest.TestCase):
    """ConfigureOAuthProvider200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConfigureOAuthProvider200Response:
        """Test ConfigureOAuthProvider200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigureOAuthProvider200Response`
        """
        model = ConfigureOAuthProvider200Response()
        if include_optional:
            return ConfigureOAuthProvider200Response(
                message = 'google OAuth configuration updated',
                provider = mudbase.models.configure_o_auth_provider_200_response_provider.configureOAuthProvider_200_response_provider(
                    name = 'google', 
                    enabled = True, 
    ...
    def testConfigureOAuthProvider200Response(self):
        """Test ConfigureOAuthProvider200Response"""
