...
class TestEnablePaymentProcessing200Response(unittest.TestCase):
    """EnablePaymentProcessing200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnablePaymentProcessing200Response:
        """Test EnablePaymentProcessing200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnablePaymentProcessing200Response`
        """
        model = EnablePaymentProcessing200Response()
        if include_optional:
            return EnablePaymentProcessing200Response(
                success = True,
                message = '',
                data = mudbase.models.enable_payment_processing_200_response_data.enablePaymentProcessing_200_response_data(
                    subaccount_id = '', 
    ...
    def testEnablePaymentProcessing200Response(self):
        """Test EnablePaymentProcessing200Response"""
