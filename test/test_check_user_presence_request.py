...
class TestCheckUserPresenceRequest(unittest.TestCase):
    """CheckUserPresenceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckUserPresenceRequest:
        """Test CheckUserPresenceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckUserPresenceRequest`
        """
        model = CheckUserPresenceRequest()
        if include_optional:
            return CheckUserPresenceRequest(
                user_ids = ["685acbe0e129932fbb7a0fc2","685acbe0e129932fbb7a0fc3"]
            )
        else:
            return CheckUserPresenceRequest(
                user_ids = ["685acbe0e129932fbb7a0fc2","685acbe0e129932fbb7a0fc3"],
    ...
    def testCheckUserPresenceRequest(self):
        """Test CheckUserPresenceRequest"""
