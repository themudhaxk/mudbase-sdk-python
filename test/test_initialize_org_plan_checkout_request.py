...
class TestInitializeOrgPlanCheckoutRequest(unittest.TestCase):
    """InitializeOrgPlanCheckoutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitializeOrgPlanCheckoutRequest:
        """Test InitializeOrgPlanCheckoutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitializeOrgPlanCheckoutRequest`
        """
        model = InitializeOrgPlanCheckoutRequest()
        if include_optional:
            return InitializeOrgPlanCheckoutRequest(
                plan_name = 'starter',
    ...
    def testInitializeOrgPlanCheckoutRequest(self):
        """Test InitializeOrgPlanCheckoutRequest"""
