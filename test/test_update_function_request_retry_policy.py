...
class TestUpdateFunctionRequestRetryPolicy(unittest.TestCase):
    """UpdateFunctionRequestRetryPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFunctionRequestRetryPolicy:
        """Test UpdateFunctionRequestRetryPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFunctionRequestRetryPolicy`
        """
        model = UpdateFunctionRequestRetryPolicy()
        if include_optional:
            return UpdateFunctionRequestRetryPolicy(
                enabled = True,
                max_retries = 56,
                backoff_ms = 56
            )
    ...
    def testUpdateFunctionRequestRetryPolicy(self):
        """Test UpdateFunctionRequestRetryPolicy"""
