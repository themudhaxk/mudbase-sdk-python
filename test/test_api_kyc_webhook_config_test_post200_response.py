...
class TestApiKycWebhookConfigTestPost200Response(unittest.TestCase):
    """ApiKycWebhookConfigTestPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKycWebhookConfigTestPost200Response:
        """Test ApiKycWebhookConfigTestPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKycWebhookConfigTestPost200Response`
        """
        model = ApiKycWebhookConfigTestPost200Response()
        if include_optional:
    ...
    def testApiKycWebhookConfigTestPost200Response(self):
        """Test ApiKycWebhookConfigTestPost200Response"""
