...
class TestOrgDnsRecord(unittest.TestCase):
    """OrgDnsRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgDnsRecord:
        """Test OrgDnsRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgDnsRecord`
        """
        model = OrgDnsRecord()
        if include_optional:
            return OrgDnsRecord(
