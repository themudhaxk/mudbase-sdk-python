...
class TestFunctionExecutionResponse(unittest.TestCase):
    """FunctionExecutionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionExecutionResponse:
        """Test FunctionExecutionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionExecutionResponse`
        """
        model = FunctionExecutionResponse()
        if include_optional:
            return FunctionExecutionResponse(
                success = True,
                data = mudbase.models.function_execution_response_data.FunctionExecutionResponse_data(
                    execution_id = '', 
                    status = 'queued', )
            )
        else:
    ...
    def testFunctionExecutionResponse(self):
        """Test FunctionExecutionResponse"""
