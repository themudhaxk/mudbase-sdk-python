...
class TestCreateCheckoutSession200Response(unittest.TestCase):
    """CreateCheckoutSession200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCheckoutSession200Response:
        """Test CreateCheckoutSession200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCheckoutSession200Response`
        """
        model = CreateCheckoutSession200Response()
        if include_optional:
            return CreateCheckoutSession200Response(
                success = True,
                data = mudbase.models.create_checkout_session_200_response_data.createCheckoutSession_200_response_data(
                    checkout_url = '', 
                    authorization_url = '', 
                    access_code = '', 
                    reference = '', 
    ...
    def testCreateCheckoutSession200Response(self):
        """Test CreateCheckoutSession200Response"""
