...
class TestProjectSmsByoPatchRequest(unittest.TestCase):
    """ProjectSmsByoPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSmsByoPatchRequest:
        """Test ProjectSmsByoPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectSmsByoPatchRequest`
        """
        model = ProjectSmsByoPatchRequest()
        if include_optional:
            return ProjectSmsByoPatchRequest(
                enabled = True,
                provider = 'twilio',
                default_from = '',
                config = { }
    ...
    def testProjectSmsByoPatchRequest(self):
        """Test ProjectSmsByoPatchRequest"""
