...
class TestGetOrganizationUsers200ResponseUsersInnerProject(unittest.TestCase):
    """GetOrganizationUsers200ResponseUsersInnerProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrganizationUsers200ResponseUsersInnerProject:
        """Test GetOrganizationUsers200ResponseUsersInnerProject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrganizationUsers200ResponseUsersInnerProject`
        """
        model = GetOrganizationUsers200ResponseUsersInnerProject()
        if include_optional:
            return GetOrganizationUsers200ResponseUsersInnerProject(
                id = '',
                name = '',
                slug = ''
            )
    ...
    def testGetOrganizationUsers200ResponseUsersInnerProject(self):
        """Test GetOrganizationUsers200ResponseUsersInnerProject"""
