...
class TestGetOAuthProviderConfig200Response(unittest.TestCase):
    """GetOAuthProviderConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOAuthProviderConfig200Response:
        """Test GetOAuthProviderConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOAuthProviderConfig200Response`
        """
        model = GetOAuthProviderConfig200Response()
        if include_optional:
            return GetOAuthProviderConfig200Response(
                name = 'google',
                enabled = True,
                display_name = 'Sign in with Google',
                config = mudbase.models.get_o_auth_provider_config_200_response_config.getOAuthProviderConfig_200_response_config(
    ...
    def testGetOAuthProviderConfig200Response(self):
        """Test GetOAuthProviderConfig200Response"""
