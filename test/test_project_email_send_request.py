...
class TestProjectEmailSendRequest(unittest.TestCase):
    """ProjectEmailSendRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectEmailSendRequest:
        """Test ProjectEmailSendRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectEmailSendRequest`
        """
        model = ProjectEmailSendRequest()
        if include_optional:
            return ProjectEmailSendRequest(
                template = '',
                to = None,
                data = { },
                subject = '',
    ...
    def testProjectEmailSendRequest(self):
        """Test ProjectEmailSendRequest"""
