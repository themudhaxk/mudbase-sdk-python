...
class TestAcceptInvite201ResponseUser(unittest.TestCase):
    """AcceptInvite201ResponseUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptInvite201ResponseUser:
        """Test AcceptInvite201ResponseUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptInvite201ResponseUser`
        """
        model = AcceptInvite201ResponseUser()
        if include_optional:
            return AcceptInvite201ResponseUser(
                id = '',
                email = '',
                first_name = '',
                last_name = '',
    ...
    def testAcceptInvite201ResponseUser(self):
        """Test AcceptInvite201ResponseUser"""
