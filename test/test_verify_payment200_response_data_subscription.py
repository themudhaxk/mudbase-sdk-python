...
class TestVerifyPayment200ResponseDataSubscription(unittest.TestCase):
    """VerifyPayment200ResponseDataSubscription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyPayment200ResponseDataSubscription:
        """Test VerifyPayment200ResponseDataSubscription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyPayment200ResponseDataSubscription`
        """
        model = VerifyPayment200ResponseDataSubscription()
        if include_optional:
            return VerifyPayment200ResponseDataSubscription(
                id = '',
                status = 'active',
                plan = '',
    ...
    def testVerifyPayment200ResponseDataSubscription(self):
        """Test VerifyPayment200ResponseDataSubscription"""
