...
class TestGetComplianceSummary200ResponseComplianceSecurity(unittest.TestCase):
    """GetComplianceSummary200ResponseComplianceSecurity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetComplianceSummary200ResponseComplianceSecurity:
        """Test GetComplianceSummary200ResponseComplianceSecurity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetComplianceSummary200ResponseComplianceSecurity`
        """
        model = GetComplianceSummary200ResponseComplianceSecurity()
        if include_optional:
            return GetComplianceSummary200ResponseComplianceSecurity(
                password_policy = '',
                virus_scanning = True,
    ...
    def testGetComplianceSummary200ResponseComplianceSecurity(self):
        """Test GetComplianceSummary200ResponseComplianceSecurity"""
