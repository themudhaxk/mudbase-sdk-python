...
class TestGetOrganizationUsage200ResponseAllOfSuborgsInner(unittest.TestCase):
    """GetOrganizationUsage200ResponseAllOfSuborgsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrganizationUsage200ResponseAllOfSuborgsInner:
        """Test GetOrganizationUsage200ResponseAllOfSuborgsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrganizationUsage200ResponseAllOfSuborgsInner`
        """
        model = GetOrganizationUsage200ResponseAllOfSuborgsInner()
        if include_optional:
            return GetOrganizationUsage200ResponseAllOfSuborgsInner(
                id = '',
                name = '',
                slug = '',
    ...
    def testGetOrganizationUsage200ResponseAllOfSuborgsInner(self):
        """Test GetOrganizationUsage200ResponseAllOfSuborgsInner"""
