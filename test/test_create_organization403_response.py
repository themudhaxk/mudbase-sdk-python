...
class TestCreateOrganization403Response(unittest.TestCase):
    """CreateOrganization403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrganization403Response:
        """Test CreateOrganization403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrganization403Response`
        """
        model = CreateOrganization403Response()
        if include_optional:
            return CreateOrganization403Response(
    ...
    def testCreateOrganization403Response(self):
        """Test CreateOrganization403Response"""
