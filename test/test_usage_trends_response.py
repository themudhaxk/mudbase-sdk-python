    ...
    def make_instance(self, include_optional) -> UsageTrendsResponse:
        ...
        if include_optional:
            return UsageTrendsResponse(
                trends = [
                    mudbase.models.usage_trends_response_trends_inner.UsageTrendsResponse_trends_inner(
                        _id = mudbase.models.usage_trends_response_trends_inner__id.UsageTrendsResponse_trends_inner__id(
                            year = 56, 
                            month = 56, 
                            day = 56, ), 
                        api_calls = 56, 
