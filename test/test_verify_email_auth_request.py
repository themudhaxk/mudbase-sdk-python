...
class TestVerifyEmailAuthRequest(unittest.TestCase):
    """VerifyEmailAuthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyEmailAuthRequest:
        """Test VerifyEmailAuthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyEmailAuthRequest`
        """
        model = VerifyEmailAuthRequest()
        if include_optional:
            return VerifyEmailAuthRequest(
                token = '',
                project_id = ''
            )
        else:
    ...
    def testVerifyEmailAuthRequest(self):
        """Test VerifyEmailAuthRequest"""
