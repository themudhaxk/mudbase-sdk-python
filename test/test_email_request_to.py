...
class TestEmailRequestTo(unittest.TestCase):
    """EmailRequestTo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailRequestTo:
        """Test EmailRequestTo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailRequestTo`
        """
        model = EmailRequestTo()
        if include_optional:
