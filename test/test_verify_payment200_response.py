...
class TestVerifyPayment200Response(unittest.TestCase):
    """VerifyPayment200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerifyPayment200Response:
        """Test VerifyPayment200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerifyPayment200Response`
        """
        model = VerifyPayment200Response()
        if include_optional:
            return VerifyPayment200Response(
                success = True,
                message = '',
                data = mudbase.models.verify_payment_200_response_data.verifyPayment_200_response_data(
    ...
    def testVerifyPayment200Response(self):
        """Test VerifyPayment200Response"""
