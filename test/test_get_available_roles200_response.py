...
class TestGetAvailableRoles200Response(unittest.TestCase):
    """GetAvailableRoles200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAvailableRoles200Response:
        """Test GetAvailableRoles200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAvailableRoles200Response`
        """
        model = GetAvailableRoles200Response()
        if include_optional:
            return GetAvailableRoles200Response(
                success = True,
                data = [
                    mudbase.models.get_available_roles_200_response_data_inner.getAvailableRoles_200_response_data_inner(
                        slug = '', 
                        name = '', 
                        description = '', 
                        signup_endpoint = '', 
    ...
    def testGetAvailableRoles200Response(self):
        """Test GetAvailableRoles200Response"""
