...
class TestGetSubscriptionTiers200ResponsePlansInner(unittest.TestCase):
    """GetSubscriptionTiers200ResponsePlansInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSubscriptionTiers200ResponsePlansInner:
        """Test GetSubscriptionTiers200ResponsePlansInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSubscriptionTiers200ResponsePlansInner`
        """
        model = GetSubscriptionTiers200ResponsePlansInner()
        if include_optional:
            return GetSubscriptionTiers200ResponsePlansInner(
                id = 'starter',
                name = 'Starter',
                description = '',
                price = 2900,
    ...
    def testGetSubscriptionTiers200ResponsePlansInner(self):
        """Test GetSubscriptionTiers200ResponsePlansInner"""
