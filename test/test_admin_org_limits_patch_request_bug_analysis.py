...
class TestAdminOrgLimitsPatchRequestBugAnalysis(unittest.TestCase):
    """AdminOrgLimitsPatchRequestBugAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminOrgLimitsPatchRequestBugAnalysis:
        """Test AdminOrgLimitsPatchRequestBugAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminOrgLimitsPatchRequestBugAnalysis`
        """
        model = AdminOrgLimitsPatchRequestBugAnalysis()
        if include_optional:
            return AdminOrgLimitsPatchRequestBugAnalysis(
                scans_per_month = 0,
                max_upload_bytes = 0,
    ...
    def testAdminOrgLimitsPatchRequestBugAnalysis(self):
        """Test AdminOrgLimitsPatchRequestBugAnalysis"""
