...
class TestUpdateFunctionRequestLimits(unittest.TestCase):
    """UpdateFunctionRequestLimits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFunctionRequestLimits:
        """Test UpdateFunctionRequestLimits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFunctionRequestLimits`
        """
        model = UpdateFunctionRequestLimits()
        if include_optional:
            return UpdateFunctionRequestLimits(
                timeout = 56,
                max_payload_size = 56,
    ...
    def testUpdateFunctionRequestLimits(self):
        """Test UpdateFunctionRequestLimits"""
