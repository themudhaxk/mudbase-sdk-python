...
class TestOrgSslValidationRecord(unittest.TestCase):
    """OrgSslValidationRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgSslValidationRecord:
        """Test OrgSslValidationRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgSslValidationRecord`
        """
        model = OrgSslValidationRecord()
        if include_optional:
            return OrgSslValidationRecord(
                txt_name = '',
                txt_value = '',
                http_url = '',
                http_body = '',
    ...
    def testOrgSslValidationRecord(self):
        """Test OrgSslValidationRecord"""
