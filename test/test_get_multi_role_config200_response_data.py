...
class TestGetMultiRoleConfig200ResponseData(unittest.TestCase):
    """GetMultiRoleConfig200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMultiRoleConfig200ResponseData:
        """Test GetMultiRoleConfig200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMultiRoleConfig200ResponseData`
        """
        model = GetMultiRoleConfig200ResponseData()
        if include_optional:
            return GetMultiRoleConfig200ResponseData(
                is_enabled = True,
                default_role = '',
                settings = None,
                roles = [
    ...
    def testGetMultiRoleConfig200ResponseData(self):
        """Test GetMultiRoleConfig200ResponseData"""
