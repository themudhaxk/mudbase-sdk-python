...
class TestFunctionLogsResponseData(unittest.TestCase):
    """FunctionLogsResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionLogsResponseData:
        """Test FunctionLogsResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionLogsResponseData`
        """
        model = FunctionLogsResponseData()
        if include_optional:
            return FunctionLogsResponseData(
                executions = [
    ...
    def testFunctionLogsResponseData(self):
        """Test FunctionLogsResponseData"""
