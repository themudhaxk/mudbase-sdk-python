...
class TestCreateIntegration201Response(unittest.TestCase):
    """CreateIntegration201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIntegration201Response:
        """Test CreateIntegration201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIntegration201Response`
        """
        model = CreateIntegration201Response()
        if include_optional:
    ...
    def testCreateIntegration201Response(self):
        """Test CreateIntegration201Response"""
