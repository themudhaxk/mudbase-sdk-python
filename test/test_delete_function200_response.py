...
class TestDeleteFunction200Response(unittest.TestCase):
    """DeleteFunction200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteFunction200Response:
        """Test DeleteFunction200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteFunction200Response`
        """
        model = DeleteFunction200Response()
        if include_optional:
    ...
    def testDeleteFunction200Response(self):
        """Test DeleteFunction200Response"""
