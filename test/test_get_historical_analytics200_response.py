...
class TestGetHistoricalAnalytics200Response(unittest.TestCase):
    """GetHistoricalAnalytics200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetHistoricalAnalytics200Response:
        """Test GetHistoricalAnalytics200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHistoricalAnalytics200Response`
        """
        model = GetHistoricalAnalytics200Response()
        if include_optional:
            return GetHistoricalAnalytics200Response(
                project_id = '',
                period = '',
                data = [
                    mudbase.models.get_historical_analytics_200_response_data_inner.getHistoricalAnalytics_200_response_data_inner(
    ...
    def testGetHistoricalAnalytics200Response(self):
        """Test GetHistoricalAnalytics200Response"""
