...
class TestUsageTrendsResponseTrendsInnerId(unittest.TestCase):
    """UsageTrendsResponseTrendsInnerId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageTrendsResponseTrendsInnerId:
        """Test UsageTrendsResponseTrendsInnerId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageTrendsResponseTrendsInnerId`
        """
        model = UsageTrendsResponseTrendsInnerId()
        if include_optional:
            return UsageTrendsResponseTrendsInnerId(
                year = 56,
                month = 56,
                day = 56
            )
    ...
    def testUsageTrendsResponseTrendsInnerId(self):
        """Test UsageTrendsResponseTrendsInnerId"""
