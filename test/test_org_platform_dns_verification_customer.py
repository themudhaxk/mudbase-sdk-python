...
class TestOrgPlatformDnsVerificationCustomer(unittest.TestCase):
    """OrgPlatformDnsVerificationCustomer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgPlatformDnsVerificationCustomer:
        """Test OrgPlatformDnsVerificationCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgPlatformDnsVerificationCustomer`
        """
        model = OrgPlatformDnsVerificationCustomer()
        if include_optional:
            return OrgPlatformDnsVerificationCustomer(
                record_type = '',
                record_name = '',
                record_value = '',
                ttl_seconds = 56,
    ...
    def testOrgPlatformDnsVerificationCustomer(self):
        """Test OrgPlatformDnsVerificationCustomer"""
