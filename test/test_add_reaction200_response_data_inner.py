...
class TestAddReaction200ResponseDataInner(unittest.TestCase):
    """AddReaction200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddReaction200ResponseDataInner:
        """Test AddReaction200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddReaction200ResponseDataInner`
        """
        model = AddReaction200ResponseDataInner()
        if include_optional:
            return AddReaction200ResponseDataInner(
                emoji = '',
                users = [
                    ''
                    ]
    ...
    def testAddReaction200ResponseDataInner(self):
        """Test AddReaction200ResponseDataInner"""
