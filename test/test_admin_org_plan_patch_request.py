...
class TestAdminOrgPlanPatchRequest(unittest.TestCase):
    """AdminOrgPlanPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminOrgPlanPatchRequest:
        """Test AdminOrgPlanPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminOrgPlanPatchRequest`
        """
        model = AdminOrgPlanPatchRequest()
        if include_optional:
            return AdminOrgPlanPatchRequest(
                plan = 'free',
                reason = '',
                tx_plan = 'starter'
            )
    ...
    def testAdminOrgPlanPatchRequest(self):
        """Test AdminOrgPlanPatchRequest"""
