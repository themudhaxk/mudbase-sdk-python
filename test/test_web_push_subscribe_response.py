...
class TestWebPushSubscribeResponse(unittest.TestCase):
    """WebPushSubscribeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushSubscribeResponse:
        """Test WebPushSubscribeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushSubscribeResponse`
        """
        model = WebPushSubscribeResponse()
        if include_optional:
            return WebPushSubscribeResponse(
                success = True,
                data = mudbase.models.web_push_subscribe_response_data.WebPushSubscribeResponse_data(
                    endpoint = '', 
                    user_id = '', 
    ...
    def testWebPushSubscribeResponse(self):
        """Test WebPushSubscribeResponse"""
