...
class TestPutChatE2eeKey200ResponseData(unittest.TestCase):
    """PutChatE2eeKey200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutChatE2eeKey200ResponseData:
        """Test PutChatE2eeKey200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutChatE2eeKey200ResponseData`
        """
        model = PutChatE2eeKey200ResponseData()
        if include_optional:
            return PutChatE2eeKey200ResponseData(
                identity_public_key = '',
                key_version = 56,
    ...
    def testPutChatE2eeKey200ResponseData(self):
        """Test PutChatE2eeKey200ResponseData"""
