...
class TestFunctionExecutionStatusResponse(unittest.TestCase):
    """FunctionExecutionStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionExecutionStatusResponse:
        """Test FunctionExecutionStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionExecutionStatusResponse`
        """
        model = FunctionExecutionStatusResponse()
        if include_optional:
            return FunctionExecutionStatusResponse(
                success = True,
                data = mudbase.models.function_execution_status_response_data.FunctionExecutionStatusResponse_data(
                    execution_id = '', 
                    status = 'queued', 
                    duration_ms = 56, 
                    result = mudbase.models.result.result(), 
                    error = '', 
                    error_class = '', 
                    logs = mudbase.models.function_execution_status_response_data_logs.FunctionExecutionStatusResponse_data_logs(
                        stdout = '', 
                        stderr = '', 
                        truncated = True, 
                        bytes = 56, ), 
                    machine = mudbase.models.machine.machine(), 
    ...
    def testFunctionExecutionStatusResponse(self):
        """Test FunctionExecutionStatusResponse"""
