...
class TestMessageStatsResponseDataByStatus(unittest.TestCase):
    """MessageStatsResponseDataByStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageStatsResponseDataByStatus:
        """Test MessageStatsResponseDataByStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageStatsResponseDataByStatus`
        """
        model = MessageStatsResponseDataByStatus()
        if include_optional:
            return MessageStatsResponseDataByStatus(
                sent = 56,
                failed = 56,
                pending = 56
            )
    ...
    def testMessageStatsResponseDataByStatus(self):
        """Test MessageStatsResponseDataByStatus"""
