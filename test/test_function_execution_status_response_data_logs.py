...
class TestFunctionExecutionStatusResponseDataLogs(unittest.TestCase):
    """FunctionExecutionStatusResponseDataLogs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionExecutionStatusResponseDataLogs:
        """Test FunctionExecutionStatusResponseDataLogs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionExecutionStatusResponseDataLogs`
        """
        model = FunctionExecutionStatusResponseDataLogs()
        if include_optional:
            return FunctionExecutionStatusResponseDataLogs(
                stdout = '',
                stderr = '',
                truncated = True,
                bytes = 56
    ...
    def testFunctionExecutionStatusResponseDataLogs(self):
        """Test FunctionExecutionStatusResponseDataLogs"""
