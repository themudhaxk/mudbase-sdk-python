...
class TestCreateCheckoutSession200ResponseData(unittest.TestCase):
    """CreateCheckoutSession200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCheckoutSession200ResponseData:
        """Test CreateCheckoutSession200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCheckoutSession200ResponseData`
        """
        model = CreateCheckoutSession200ResponseData()
        if include_optional:
            return CreateCheckoutSession200ResponseData(
                checkout_url = '',
                authorization_url = '',
                access_code = '',
                reference = '',
    ...
    def testCreateCheckoutSession200ResponseData(self):
        """Test CreateCheckoutSession200ResponseData"""
