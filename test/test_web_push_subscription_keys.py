...
class TestWebPushSubscriptionKeys(unittest.TestCase):
    """WebPushSubscriptionKeys unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebPushSubscriptionKeys:
        """Test WebPushSubscriptionKeys
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebPushSubscriptionKeys`
        """
        model = WebPushSubscriptionKeys()
        if include_optional:
    ...
    def testWebPushSubscriptionKeys(self):
        """Test WebPushSubscriptionKeys"""
