...
class TestAddCustomRoleRequestDefaultPermissionsInner(unittest.TestCase):
    """AddCustomRoleRequestDefaultPermissionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddCustomRoleRequestDefaultPermissionsInner:
        """Test AddCustomRoleRequestDefaultPermissionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCustomRoleRequestDefaultPermissionsInner`
        """
        model = AddCustomRoleRequestDefaultPermissionsInner()
        if include_optional:
            return AddCustomRoleRequestDefaultPermissionsInner(
                resource = '',
                actions = [
                    ''
                    ]
    ...
    def testAddCustomRoleRequestDefaultPermissionsInner(self):
        """Test AddCustomRoleRequestDefaultPermissionsInner"""
