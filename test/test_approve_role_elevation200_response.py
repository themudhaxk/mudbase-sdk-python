...
class TestApproveRoleElevation200Response(unittest.TestCase):
    """ApproveRoleElevation200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApproveRoleElevation200Response:
        """Test ApproveRoleElevation200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApproveRoleElevation200Response`
        """
        model = ApproveRoleElevation200Response()
        if include_optional:
    ...
    def testApproveRoleElevation200Response(self):
        """Test ApproveRoleElevation200Response"""
