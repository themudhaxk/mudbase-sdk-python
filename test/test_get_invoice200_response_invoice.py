...
class TestGetInvoice200ResponseInvoice(unittest.TestCase):
    """GetInvoice200ResponseInvoice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInvoice200ResponseInvoice:
        """Test GetInvoice200ResponseInvoice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInvoice200ResponseInvoice`
        """
        model = GetInvoice200ResponseInvoice()
        if include_optional:
            return GetInvoice200ResponseInvoice(
                id = '',
                invoice_number = '',
                status = '',
                total = 1.337,
    ...
    def testGetInvoice200ResponseInvoice(self):
        """Test GetInvoice200ResponseInvoice"""
