...
class BucketsApi:
    ...
    def create_bucket(
        ...
        :type project_id: str
        :param create_bucket_request: (required)
    ...
    def _create_bucket_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/bucket/projects/{projectId}/buckets',
    ...
    def _delete_bucket_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/bucket/projects/{projectId}/buckets/{bucketId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_buckets_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BucketListResponse]:
        """List buckets in a project
    ...
    def update_bucket(
        ...
        :param bucket_id: (required)
        :type bucket_id: str
        :param update_bucket_request: (required)
    ...
    def _update_bucket_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_bucket_request is not None:
            _body_params = update_bucket_request
