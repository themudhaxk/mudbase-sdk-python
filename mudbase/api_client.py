...
from mudbase.configuration import Configuration
from mudbase.api_response import ApiResponse, T as ApiResponseT
import mudbase.models
from mudbase import rest
from mudbase.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.3.16/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mudbase.models, klass)
