...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "OrgBearerAuth": BearerFormatAuthSetting,
        "ProjectBearerAuth": BearerFormatAuthSetting,
        "ApiKeyAuth": APIKeyAuthSetting,
        "InternalApiKey": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = mudbase.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://cloud.mudbase.dev" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("mudbase")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'InternalApiKey' in self.api_key:
            auth['InternalApiKey'] = {
                'type': 'api_key',
                'in': 'header',
    ...
    def to_debug_report(self) -> str:
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1.3.16\n"\
               "SDK Package Version: 1.3.16".\
