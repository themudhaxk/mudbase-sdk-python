...
class UpdateFunctionRequest(BaseModel):
    ...
    trigger: Optional[FunctionTrigger] = None
    environment: Optional[Dict[str, Any]] = None
    is_active: Optional[StrictBool] = Field(default=None, alias="isActive")
    limits: Optional[UpdateFunctionRequestLimits] = None
    retry_policy: Optional[UpdateFunctionRequestRetryPolicy] = Field(default=None, alias="retryPolicy")
    version_comment: Optional[StrictStr] = Field(default=None, description="Comment for version when code is updated", alias="versionComment")
    __properties: ClassVar[List[str]] = ["name", "description", "code", "trigger", "environment", "isActive", "limits", "retryPolicy", "versionComment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "trigger": FunctionTrigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None,
            "environment": obj.get("environment"),
            "isActive": obj.get("isActive"),
            "limits": UpdateFunctionRequestLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "retryPolicy": UpdateFunctionRequestRetryPolicy.from_dict(obj["retryPolicy"]) if obj.get("retryPolicy") is not None else None,
