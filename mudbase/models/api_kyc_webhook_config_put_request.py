...
class ApiKycWebhookConfigPutRequest(BaseModel):
    """
    ApiKycWebhookConfigPutRequest
    """ # noqa: E501
    webhook_url: Optional[StrictStr] = Field(default=None, description="Destination URL. Send null or empty string to clear.", alias="webhookUrl")
    webhook_secret: Optional[Annotated[str, Field(min_length=16, strict=True)]] = Field(default=None, description="Explicit signing secret (min 16 chars). Send null or empty string to clear.", alias="webhookSecret")
    generate_secret: Optional[StrictBool] = Field(default=None, description="When true, the server generates a new secret and returns it once.", alias="generateSecret")
    __properties: ClassVar[List[str]] = ["webhookUrl", "webhookSecret", "generateSecret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "generateSecret": obj.get("generateSecret")
        })
        return _obj
