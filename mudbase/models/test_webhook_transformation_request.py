...
class TestWebhookTransformationRequest(BaseModel):
    """
    TestWebhookTransformationRequest
    """ # noqa: E501
    payload: Dict[str, Any] = Field(description="Sample payload to transform")
    transformations: List[GetWebhookConfig200ResponseDataTransformationsInner] = Field(description="Transformation rules to apply")
    __properties: ClassVar[List[str]] = ["payload", "transformations"]
