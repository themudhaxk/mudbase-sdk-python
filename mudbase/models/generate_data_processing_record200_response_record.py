...
class GenerateDataProcessingRecord200ResponseRecord(BaseModel):
    """
    ...
    data_controller: Optional[Dict[str, Any]] = Field(default=None, alias="dataController")
    processing_activities: Optional[List[Dict[str, Any]]] = Field(default=None, alias="processingActivities")
    data_subjects: Optional[List[StrictStr]] = Field(default=None, alias="dataSubjects")
    generated_at: Optional[datetime] = Field(default=None, alias="generatedAt")
    __properties: ClassVar[List[str]] = ["orgId", "recordDate", "dataController", "processingActivities", "dataSubjects", "generatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataController": obj.get("dataController"),
            "processingActivities": obj.get("processingActivities"),
            "dataSubjects": obj.get("dataSubjects"),
