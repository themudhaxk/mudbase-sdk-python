...
class ResendVerificationAuthRequest(BaseModel):
    """
    ResendVerificationAuthRequest
    """ # noqa: E501
    email: StrictStr
    project_id: Optional[StrictStr] = Field(default=None, description="Optional; for project-scoped signup (sends link with project context)", alias="projectId")
