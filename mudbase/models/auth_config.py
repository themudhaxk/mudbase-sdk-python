...
class AuthConfig(BaseModel):
    ...
    notify_on_new_sign_in: Optional[StrictBool] = Field(default=False, description="When true, a \"new sign-in detected\" email is sent to the user on each project-based sign-in (local or OAuth). Counts against the org's messaging/email plan quota. Default false. Organization-based sign-in always sends this email (no quota deduction). ", alias="notifyOnNewSignIn")
    __properties: ClassVar[List[str]] = ["providers", "notifyOnNewSignIn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notifyOnNewSignIn": obj.get("notifyOnNewSignIn") if obj.get("notifyOnNewSignIn") is not None else False
        })
        return _obj
