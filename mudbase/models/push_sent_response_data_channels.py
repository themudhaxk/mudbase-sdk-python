...
class PushSentResponseDataChannels(BaseModel):
    """
    PushSentResponseDataChannels
    """ # noqa: E501
    fcm: Optional[PushSentResponseDataChannelsFcm] = None
    web_push: Optional[PushSentResponseDataChannelsWebPush] = Field(default=None, alias="webPush")
    __properties: ClassVar[List[str]] = ["fcm", "webPush"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.web_push:
            _dict['webPush'] = self.web_push.to_dict()
        # set to None if fcm (nullable) is None
        # and model_fields_set contains the field
        if self.fcm is None and "fcm" in self.model_fields_set:
            _dict['fcm'] = None

        # set to None if web_push (nullable) is None
        # and model_fields_set contains the field
        if self.web_push is None and "web_push" in self.model_fields_set:
            _dict['webPush'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fcm": PushSentResponseDataChannelsFcm.from_dict(obj["fcm"]) if obj.get("fcm") is not None else None,
            "webPush": PushSentResponseDataChannelsWebPush.from_dict(obj["webPush"]) if obj.get("webPush") is not None else None
        })
        return _obj
