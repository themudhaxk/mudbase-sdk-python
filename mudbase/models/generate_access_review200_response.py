...
class GenerateAccessReview200Response(BaseModel):
    """
    GenerateAccessReview200Response
    """ # noqa: E501
    report: Optional[GenerateAccessReview200ResponseReport] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateAccessReview200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateAccessReview200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "report": GenerateAccessReview200ResponseReport.from_dict(obj["report"]) if obj.get("report") is not None else None
        })
        return _obj
