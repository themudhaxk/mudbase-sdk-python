...
class WebhookStatsResponseEventStatsInner(BaseModel):
    """
    WebhookStatsResponseEventStatsInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Event name", alias="_id")
    count: Optional[StrictInt] = None
    success_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Fraction of logs with status success (0–1)", alias="successRate")
    __properties: ClassVar[List[str]] = ["_id", "count", "successRate"]
