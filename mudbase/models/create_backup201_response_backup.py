...
class CreateBackup201ResponseBackup(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "project", "description", "status", "size", "collections", "createdAt", "estimatedCompletion"]
