...
class ApiFilesDownloadFileIdGet200Response(BaseModel):
    """
    ApiFilesDownloadFileIdGet200Response
    """ # noqa: E501
    url: Optional[StrictStr] = None
    expires_in: Optional[StrictInt] = Field(default=None, description="Seconds until the signed URL expires; null for public files.", alias="expiresIn")
    is_public: Optional[StrictBool] = Field(default=None, description="Present and true only when the file is public.", alias="isPublic")
    warning: Optional[StrictStr] = Field(default=None, description="Present only for public files — explains the URL is permanent and unprotected.")
    __properties: ClassVar[List[str]] = ["url", "expiresIn", "isPublic", "warning"]
