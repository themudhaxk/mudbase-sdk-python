...
class RegisterLocalUser201Response(BaseModel):
    ...
    require_verification: Optional[StrictBool] = Field(default=None, description="true when email verification is required; no token in response", alias="requireVerification")
    token: Optional[StrictStr] = Field(default=None, description="Present only when requireEmailVerification is false")
    refresh_token: Optional[StrictStr] = Field(default=None, description="Present only when requireEmailVerification is false", alias="refreshToken")
    expires_in: Optional[StrictInt] = Field(default=None, description="Present only when token is returned", alias="expiresIn")
    user: Optional[RegisterLocalUser201ResponseUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": RegisterLocalUser201ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
