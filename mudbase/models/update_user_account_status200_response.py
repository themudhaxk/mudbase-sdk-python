...
class UpdateUserAccountStatus200Response(BaseModel):
    """
    UpdateUserAccountStatus200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    user: Optional[UpdateUserAccountStatus200ResponseUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": UpdateUserAccountStatus200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
