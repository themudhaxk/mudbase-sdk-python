...
class TriggerWebhookResponse(BaseModel):
    ...
    """ # noqa: E501
    message: StrictStr
    webhook_id: StrictStr = Field(description="WebhookLog._id for this delivery; use in POST /api/webhooks/retry/{webhookId}", alias="webhookId")
    __properties: ClassVar[List[str]] = ["message", "webhookId"]
