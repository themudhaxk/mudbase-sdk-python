...
class EditMessage200Response(BaseModel):
    """
    EditMessage200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[EditMessage200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": EditMessage200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
