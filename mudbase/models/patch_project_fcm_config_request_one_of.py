...
class PatchProjectFcmConfigRequestOneOf(BaseModel):
    """
    PatchProjectFcmConfigRequestOneOf
    """ # noqa: E501
    service_account_json: Dict[str, Any] = Field(description="Firebase service account JSON (client_email, private_key, etc.)", alias="serviceAccountJson")
    __properties: ClassVar[List[str]] = ["serviceAccountJson"]
