...
class PutChatE2eeKeyRequest(BaseModel):
    """
    PutChatE2eeKeyRequest
    """ # noqa: E501
    identity_public_key: StrictStr = Field(description="Base64-encoded public key (algorithm defined by client; opaque to server)", alias="identityPublicKey")
    key_version: Optional[StrictInt] = Field(default=None, description="Optional; defaults to incrementing stored version", alias="keyVersion")
    __properties: ClassVar[List[str]] = ["identityPublicKey", "keyVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identityPublicKey": obj.get("identityPublicKey"),
