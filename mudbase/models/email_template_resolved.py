...
class EmailTemplateResolved(BaseModel):
    """
    ...
    is_project_override: Optional[StrictBool] = Field(default=None, alias="isProjectOverride")
    effective_source: Optional[StrictStr] = Field(default=None, alias="effectiveSource")
    __properties: ClassVar[List[str]] = ["name", "subject", "htmlBody", "textBody", "variables", "updatedAt", "version", "isProjectOverride", "effectiveSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isProjectOverride": obj.get("isProjectOverride"),
