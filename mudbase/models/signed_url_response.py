...
class SignedUrlResponse(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="Signed URL for file access")
    expires_at: Optional[datetime] = Field(default=None, description="Expiration time of the signed URL (optional - some endpoints return expiresIn instead)", alias="expiresAt")
    expires_in: Optional[StrictInt] = Field(default=None, description="Time-to-live in seconds for the signed URL (optional)", alias="expiresIn")
    __properties: ClassVar[List[str]] = ["success", "url", "expiresAt", "expiresIn"]
