...
class PreviewProjectEmailTemplateRequest(BaseModel):
    """
    PreviewProjectEmailTemplateRequest
    """ # noqa: E501
    sample_data: Optional[Dict[str, Any]] = Field(default=None, alias="sampleData")
    __properties: ClassVar[List[str]] = ["sampleData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PreviewProjectEmailTemplateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PreviewProjectEmailTemplateRequest from a dict"""
        if obj is None:
            return None
