...
class GenerateAccessReview200ResponseReport(BaseModel):
    """
    GenerateAccessReview200ResponseReport
    """ # noqa: E501
    org_id: Optional[StrictStr] = Field(default=None, alias="orgId")
    review_period: Optional[Dict[str, Any]] = Field(default=None, alias="reviewPeriod")
    ...
    __properties: ClassVar[List[str]] = ["orgId", "reviewPeriod", "users", "summary", "recommendations", "generatedAt"]
