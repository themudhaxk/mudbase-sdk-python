...
class CreateApiKey201Response(BaseModel):
    """
    CreateApiKey201Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    api_key: Optional[ApiKeyWithSecret] = Field(default=None, alias="apiKey")
    __properties: ClassVar[List[str]] = ["message", "apiKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiKey": ApiKeyWithSecret.from_dict(obj["apiKey"]) if obj.get("apiKey") is not None else None
        })
        return _obj
