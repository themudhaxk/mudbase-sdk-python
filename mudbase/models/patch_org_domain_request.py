...
class PatchOrgDomainRequest(BaseModel):
    """
    PatchOrgDomainRequest
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Org self-serve reset only; go-live is via admin activate.")
    regenerate_token: Optional[StrictBool] = Field(default=None, alias="regenerateToken")
    __properties: ClassVar[List[str]] = ["status", "regenerateToken"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['pending', 'failed']):
            raise ValueError("must be one of enum values ('pending', 'failed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regenerateToken": obj.get("regenerateToken")
        })
        return _obj
