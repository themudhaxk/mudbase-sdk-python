...
class LogSecurityEventRequest(BaseModel):
    ...
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unauthorized_access_attempt', 'brute_force_attempt', 'suspicious_api_activity', 'private_key_export', 'bulk_data_export', 'admin_privilege_escalation', 'data_breach_detected', 'mfa_bypass_attempt']):
            raise ValueError("must be one of enum values ('unauthorized_access_attempt', 'brute_force_attempt', 'suspicious_api_activity', 'private_key_export', 'bulk_data_export', 'admin_privilege_escalation', 'data_breach_detected', 'mfa_bypass_attempt')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": LogSecurityEventRequestDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
