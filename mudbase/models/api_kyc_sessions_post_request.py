...
class ApiKycSessionsPostRequest(BaseModel):
    """
    ApiKycSessionsPostRequest
    """ # noqa: E501
    language: Optional[StrictStr] = Field(default=None, description="Optional ISO language code for the verification UI.")
