...
class GetUserChats200ResponseDataChatsInner(BaseModel):
    ...
    last_message: Optional[GetUserChats200ResponseDataChatsInnerLastMessage] = Field(default=None, alias="lastMessage")
    unread_count: Optional[StrictInt] = Field(default=None, alias="unreadCount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type"),
            "lastMessage": GetUserChats200ResponseDataChatsInnerLastMessage.from_dict(obj["lastMessage"]) if obj.get("lastMessage") is not None else None,
