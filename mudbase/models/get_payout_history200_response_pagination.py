...
class GetPayoutHistory200ResponsePagination(BaseModel):
    """
    ...
    has_previous_page: Optional[StrictBool] = Field(default=None, alias="hasPreviousPage")
    __properties: ClassVar[List[str]] = ["page", "limit", "count", "total", "totalPages", "hasNextPage", "hasPreviousPage"]
