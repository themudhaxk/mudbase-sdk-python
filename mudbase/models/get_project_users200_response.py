...
class GetProjectUsers200Response(BaseModel):
    ...
    """ # noqa: E501
    users: Optional[List[GetOrganizationUsers200ResponseUsersInner]] = None
    total: Optional[StrictInt] = None
    project: Optional[GetOrganizationUsers200ResponseUsersInnerProject] = None
    __properties: ClassVar[List[str]] = ["users", "total", "project"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [GetOrganizationUsers200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "total": obj.get("total"),
