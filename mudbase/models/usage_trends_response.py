...
class UsageTrendsResponse(BaseModel):
    ...
    UsageTrendsResponse
    """ # noqa: E501
    trends: Optional[List[UsageTrendsResponseTrendsInner]] = None
    period: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["trends", "period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trends": [UsageTrendsResponseTrendsInner.from_dict(_item) for _item in obj["trends"]] if obj.get("trends") is not None else None,
