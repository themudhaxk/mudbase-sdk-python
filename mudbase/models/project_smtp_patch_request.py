...
class ProjectSmtpPatchRequest(BaseModel):
    """
    ...
    auth_pass: Optional[StrictStr] = Field(default=None, description="SMTP password; stored encrypted, never returned on GET", alias="authPass")
    ...
    domain_verified_at: Optional[datetime] = Field(default=None, alias="domainVerifiedAt")
    __properties: ClassVar[List[str]] = ["enabled", "host", "port", "secure", "authUser", "authPass", "fromName", "fromEmail", "domainVerifiedAt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if domain_verified_at (nullable) is None
        # and model_fields_set contains the field
        if self.domain_verified_at is None and "domain_verified_at" in self.model_fields_set:
            _dict['domainVerifiedAt'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domainVerifiedAt": obj.get("domainVerifiedAt")
        })
        return _obj
