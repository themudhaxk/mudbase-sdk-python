...
class VerifiedRoleUpgrade200Response(BaseModel):
    """
    VerifiedRoleUpgrade200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    role: Optional[StrictStr] = None
    previous_role: Optional[StrictStr] = Field(default=None, alias="previousRole")
    upgrade_log: Optional[StrictStr] = Field(default=None, alias="upgradeLog")
    __properties: ClassVar[List[str]] = ["message", "role", "previousRole", "upgradeLog"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "previousRole": obj.get("previousRole"),
            "upgradeLog": obj.get("upgradeLog")
        })
        return _obj
