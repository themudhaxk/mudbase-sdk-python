...
class WebPushSubscription(BaseModel):
    ...
    """ # noqa: E501
    endpoint: StrictStr = Field(description="The push-service endpoint URL returned by `pushManager.subscribe()`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keys": WebPushSubscriptionKeys.from_dict(obj["keys"]) if obj.get("keys") is not None else None
        })
        return _obj
