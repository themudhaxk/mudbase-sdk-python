...
class GetChatMessages200ResponseDataMessagesInner(BaseModel):
    """
    GetChatMessages200ResponseDataMessagesInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    content: Optional[StrictStr] = None
    sender: Optional[GetChatMessages200ResponseDataMessagesInnerSender] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["_id", "content", "sender", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sender": GetChatMessages200ResponseDataMessagesInnerSender.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
