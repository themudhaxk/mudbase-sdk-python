...
class InitializeOrgPlanCheckout200ResponseData(BaseModel):
    """
    InitializeOrgPlanCheckout200ResponseData
    """ # noqa: E501
    link: Optional[StrictStr] = Field(default=None, description="Payment URL")
    tx_ref: Optional[StrictStr] = Field(default=None, description="Reference for verify-payment (mudbase_org_...)", alias="txRef")
    provider_ref: Optional[StrictStr] = Field(default=None, alias="providerRef")
    billing_cycle: Optional[StrictStr] = Field(default=None, alias="billingCycle")
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    amount_cents: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="amountCents")
    __properties: ClassVar[List[str]] = ["link", "txRef", "providerRef", "billingCycle", "amount", "amountCents"]
