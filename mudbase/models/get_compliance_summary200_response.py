...
class GetComplianceSummary200Response(BaseModel):
    """
    GetComplianceSummary200Response
    """ # noqa: E501
    compliance: Optional[GetComplianceSummary200ResponseCompliance] = None
    __properties: ClassVar[List[str]] = ["compliance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compliance": GetComplianceSummary200ResponseCompliance.from_dict(obj["compliance"]) if obj.get("compliance") is not None else None
        })
        return _obj
