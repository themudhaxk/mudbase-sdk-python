...
class Billing(BaseModel):
    ...
    Billing
    """ # noqa: E501
    next_billing_date: Optional[datetime] = Field(default=None, alias="nextBillingDate")
    payment_method: Optional[StrictStr] = Field(default=None, alias="paymentMethod")
    last_payment: Optional[BillingLastPayment] = Field(default=None, alias="lastPayment")
    __properties: ClassVar[List[str]] = ["nextBillingDate", "paymentMethod", "lastPayment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastPayment": BillingLastPayment.from_dict(obj["lastPayment"]) if obj.get("lastPayment") is not None else None
        })
        return _obj
