...
class SimulateAppPermissionsRequest(BaseModel):
    """
    SimulateAppPermissionsRequest
    """ # noqa: E501
    role: StrictStr = Field(description="App role slug (same as `roleSlug` elsewhere)")
    role_slug: Optional[StrictStr] = Field(default=None, description="Alias for `role`", alias="roleSlug")
    operation_id: Optional[StrictStr] = Field(default=None, description="OpenAPI operationId (e.g. `sendEmail`, `executeIntegration`). When set, path simulation is optional.", alias="operationId")
    method: Optional[StrictStr] = None
    pathname: Optional[StrictStr] = Field(default=None, description="Full path e.g. `/api/messaging/projects/{id}/messaging/email`")
    path: Optional[StrictStr] = Field(default=None, description="Alias for `pathname`")
