...
class GetComplianceSummary200ResponseComplianceGdpr(BaseModel):
    """
    GetComplianceSummary200ResponseComplianceGdpr
    """ # noqa: E501
    data_export_enabled: Optional[StrictBool] = Field(default=None, alias="dataExportEnabled")
    data_erasure_enabled: Optional[StrictBool] = Field(default=None, alias="dataErasureEnabled")
    consent_management: Optional[StrictBool] = Field(default=None, alias="consentManagement")
    __properties: ClassVar[List[str]] = ["dataExportEnabled", "dataErasureEnabled", "consentManagement"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataExportEnabled": obj.get("dataExportEnabled"),
            "dataErasureEnabled": obj.get("dataErasureEnabled"),
            "consentManagement": obj.get("consentManagement")
        })
        return _obj
