...
class WebPushSubscriptionKeys(BaseModel):
    ...
    """ # noqa: E501
    p256dh: StrictStr = Field(description="The subscription's P-256 ECDH public key (base64url).")
    auth: StrictStr = Field(description="The subscription's auth secret (base64url).")
