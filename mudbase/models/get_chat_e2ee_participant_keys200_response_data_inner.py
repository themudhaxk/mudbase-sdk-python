...
class GetChatE2eeParticipantKeys200ResponseDataInner(BaseModel):
    """
    GetChatE2eeParticipantKeys200ResponseDataInner
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    identity_public_key: Optional[StrictStr] = Field(default=None, alias="identityPublicKey")
    key_version: Optional[StrictInt] = Field(default=None, alias="keyVersion")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["userId", "identityPublicKey", "keyVersion", "updatedAt"]
