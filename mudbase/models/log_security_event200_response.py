...
class LogSecurityEvent200Response(BaseModel):
    """
    LogSecurityEvent200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    event: Optional[LogSecurityEvent200ResponseEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": LogSecurityEvent200ResponseEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
