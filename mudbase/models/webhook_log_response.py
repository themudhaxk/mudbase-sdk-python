...
class WebhookLogResponse(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[StrictInt] = Field(default=None, description="HTTP status code from your endpoint")
    body: Optional[Dict[str, Any]] = Field(default=None, description="Parsed JSON when possible; otherwise structure varies")
    headers: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["status", "body", "headers"]
