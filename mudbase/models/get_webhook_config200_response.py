...
class GetWebhookConfig200Response(BaseModel):
    """
    GetWebhookConfig200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[GetWebhookConfig200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetWebhookConfig200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
