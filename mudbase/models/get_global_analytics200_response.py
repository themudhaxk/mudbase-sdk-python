...
class GetGlobalAnalytics200Response(BaseModel):
    """
    GetGlobalAnalytics200Response
    """ # noqa: E501
    active_connections: Optional[StrictInt] = Field(default=None, alias="activeConnections")
    peak_connections: Optional[StrictInt] = Field(default=None, alias="peakConnections")
    total_events: Optional[StrictInt] = Field(default=None, alias="totalEvents")
    events_per_minute: Optional[StrictInt] = Field(default=None, alias="eventsPerMinute")
    __properties: ClassVar[List[str]] = ["activeConnections", "peakConnections", "totalEvents", "eventsPerMinute"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "peakConnections": obj.get("peakConnections"),
            "totalEvents": obj.get("totalEvents"),
            "eventsPerMinute": obj.get("eventsPerMinute")
        })
        return _obj
