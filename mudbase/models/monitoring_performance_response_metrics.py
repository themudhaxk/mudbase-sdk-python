...
class MonitoringPerformanceResponseMetrics(BaseModel):
    """
    MonitoringPerformanceResponseMetrics
    """ # noqa: E501
    total_requests: Optional[StrictInt] = Field(default=None, alias="totalRequests")
    avg_response_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="avgResponseTime")
    min_response_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minResponseTime")
    max_response_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxResponseTime")
    ...
    latency_source: Optional[StrictStr] = Field(default=None, description="usage_stat when filled from UsageStat", alias="latencySource")
    __properties: ClassVar[List[str]] = ["totalRequests", "avgResponseTime", "minResponseTime", "maxResponseTime", "errorCount", "successCount", "successRate", "errorRate", "latencySource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minResponseTime": obj.get("minResponseTime"),
            ...
            "latencySource": obj.get("latencySource")
        })
        return _obj
