...
class EraseUserData200ResponseData(BaseModel):
    """
    EraseUserData200ResponseData
    """ # noqa: E501
    already_erased: Optional[StrictBool] = Field(default=None, alias="alreadyErased")
    subject_id: Optional[StrictStr] = Field(default=None, alias="subjectId")
    anonymized: Optional[StrictBool] = None
    sessions_revoked: Optional[StrictBool] = Field(default=None, alias="sessionsRevoked")
    __properties: ClassVar[List[str]] = ["alreadyErased", "subjectId", "anonymized", "sessionsRevoked"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alreadyErased": obj.get("alreadyErased"),
            "subjectId": obj.get("subjectId"),
            "anonymized": obj.get("anonymized"),
            "sessionsRevoked": obj.get("sessionsRevoked")
        })
        return _obj
