...
class ExportUserData200Response(BaseModel):
    """
    ...
    api_keys: Optional[List[Dict[str, Any]]] = Field(default=None, alias="apiKeys")
    __properties: ClassVar[List[str]] = ["exportedAt", "user", "projects", "wallets", "transactions", "files", "integrations", "apiKeys"]
