...
class CreateBucketRequest(BaseModel):
    ...
    CreateBucketRequest
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the bucket")
    is_public: Optional[StrictBool] = Field(default=False, description="Whether the bucket is publicly accessible", alias="isPublic")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Additional bucket settings")
