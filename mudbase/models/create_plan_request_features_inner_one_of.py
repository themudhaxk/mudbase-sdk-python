...
class CreatePlanRequestFeaturesInnerOneOf(BaseModel):
    """
    CreatePlanRequestFeaturesInnerOneOf
    """ # noqa: E501
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    included: Optional[StrictBool] = True
    limit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Usage cap for this feature; omit or null for unlimited.")
    __properties: ClassVar[List[str]] = ["name", "description", "included", "limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "included": obj.get("included") if obj.get("included") is not None else True,
            "limit": obj.get("limit")
        })
        return _obj
