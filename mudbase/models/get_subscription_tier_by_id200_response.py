...
class GetSubscriptionTierById200Response(BaseModel):
    """
    GetSubscriptionTierById200Response
    """ # noqa: E501
    plan: Optional[GetSubscriptionTierById200ResponsePlan] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan": GetSubscriptionTierById200ResponsePlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
