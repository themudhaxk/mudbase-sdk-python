...
class CheckPermissions200ResponsePermissions(BaseModel):
    """
    CheckPermissions200ResponsePermissions
    """ # noqa: E501
    system: Optional[List[StrictStr]] = None
    custom: Optional[List[StrictStr]] = None
    combined: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["system", "custom", "combined"]
