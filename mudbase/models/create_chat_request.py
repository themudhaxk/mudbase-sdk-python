...
class CreateChatRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "type", "participants", "settings"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['direct', 'group', 'channel', 'broadcast']):
            raise ValueError("must be one of enum values ('direct', 'group', 'channel', 'broadcast')")
        return value
