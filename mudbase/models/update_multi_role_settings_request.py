...
class UpdateMultiRoleSettingsRequest(BaseModel):
    """
    ...
    settings: Optional[UpdateMultiRoleSettingsRequestSettings] = None
    __properties: ClassVar[List[str]] = ["isEnabled", "defaultRole", "settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "settings": UpdateMultiRoleSettingsRequestSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
