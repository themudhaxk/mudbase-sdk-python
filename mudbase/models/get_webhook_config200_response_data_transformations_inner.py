...
class GetWebhookConfig200ResponseDataTransformationsInner(BaseModel):
    """
    GetWebhookConfig200ResponseDataTransformationsInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    config: Optional[Dict[str, Any]] = Field(default=None, description="Transformation-specific configuration (shape depends on `type`)")
