...
class GetDashboard200Response(BaseModel):
    """
    GetDashboard200Response
    """ # noqa: E501
    revenue: Optional[Union[StrictFloat, StrictInt]] = None
    subscriptions: Optional[StrictInt] = None
    active_plans: Optional[StrictInt] = Field(default=None, alias="activePlans")
    __properties: ClassVar[List[str]] = ["revenue", "subscriptions", "activePlans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activePlans": obj.get("activePlans")
        })
        return _obj
