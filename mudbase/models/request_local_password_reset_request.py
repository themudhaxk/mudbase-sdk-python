...
class RequestLocalPasswordResetRequest(BaseModel):
    """
    RequestLocalPasswordResetRequest
    """ # noqa: E501
    email: StrictStr
    project_id: Optional[StrictStr] = Field(default=None, description="Required for project-based reset (sends OTP). Omit for org token link.", alias="projectId")
    __properties: ClassVar[List[str]] = ["email", "projectId"]
