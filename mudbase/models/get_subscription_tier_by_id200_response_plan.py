...
class GetSubscriptionTierById200ResponsePlan(BaseModel):
    """
    ...
    price_yearly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="priceYearly")
    currency: Optional[StrictStr] = None
    limits: Optional[Dict[str, Any]] = None
    overages: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "price", "priceYearly", "currency", "limits", "overages"]
