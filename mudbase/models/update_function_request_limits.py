...
class UpdateFunctionRequestLimits(BaseModel):
    """
    UpdateFunctionRequestLimits
    """ # noqa: E501
    timeout: Optional[StrictInt] = Field(default=None, description="Max execution time in ms (default 30000)")
    max_payload_size: Optional[StrictInt] = Field(default=None, description="Max payload size in bytes (default 1MB)", alias="maxPayloadSize")
    max_executions_per_minute: Optional[StrictInt] = Field(default=None, alias="maxExecutionsPerMinute")
    max_executions_per_hour: Optional[StrictInt] = Field(default=None, alias="maxExecutionsPerHour")
    __properties: ClassVar[List[str]] = ["timeout", "maxPayloadSize", "maxExecutionsPerMinute", "maxExecutionsPerHour"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxExecutionsPerMinute": obj.get("maxExecutionsPerMinute"),
            "maxExecutionsPerHour": obj.get("maxExecutionsPerHour")
        })
        return _obj
