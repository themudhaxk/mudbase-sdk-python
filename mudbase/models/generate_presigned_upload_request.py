...
class GeneratePresignedUploadRequest(BaseModel):
    ...
    bucket: Optional[StrictStr] = 'default'
    original_name: StrictStr = Field(alias="originalName")
    content_type: Optional[StrictStr] = Field(default=None, alias="contentType")
    is_public: Optional[StrictBool] = Field(default=False, alias="isPublic")
    __properties: ClassVar[List[str]] = ["projectId", "bucket", "originalName", "contentType", "isPublic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bucket": obj.get("bucket") if obj.get("bucket") is not None else 'default',
