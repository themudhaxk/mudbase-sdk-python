...
class AddOrgDomainRequest(BaseModel):
    """
    AddOrgDomainRequest
    """ # noqa: E501
    hostname: StrictStr
    set_primary: Optional[StrictBool] = Field(default=None, alias="setPrimary")
    __properties: ClassVar[List[str]] = ["hostname", "setPrimary"]
