...
class EnablePaymentProcessing200ResponseData(BaseModel):
    """
    EnablePaymentProcessing200ResponseData
    """ # noqa: E501
    subaccount_id: Optional[StrictStr] = Field(default=None, alias="subaccountId")
    already_enabled: Optional[StrictBool] = Field(default=None, alias="alreadyEnabled")
    __properties: ClassVar[List[str]] = ["subaccountId", "alreadyEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alreadyEnabled": obj.get("alreadyEnabled")
        })
        return _obj
