...
class CreateCheckoutSession200ResponseData(BaseModel):
    """
    CreateCheckoutSession200ResponseData
    """ # noqa: E501
    checkout_url: Optional[StrictStr] = Field(default=None, description="Hosted payment URL (same as authorizationUrl)", alias="checkoutUrl")
    authorization_url: Optional[StrictStr] = Field(default=None, description="Hosted payment URL", alias="authorizationUrl")
    access_code: Optional[StrictStr] = Field(default=None, description="Gateway access code", alias="accessCode")
    reference: Optional[StrictStr] = Field(default=None, description="Transaction reference (mudbase_...) for verify-payment")
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["checkoutUrl", "authorizationUrl", "accessCode", "reference", "amount", "currency"]
