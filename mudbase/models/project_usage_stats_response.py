...
class ProjectUsageStatsResponse(BaseModel):
    """
    ProjectUsageStatsResponse
    """ # noqa: E501
    project: Optional[ProjectUsageStatsResponseProject] = None
    usage: Optional[ProjectUsage] = None
    period: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["project", "usage", "period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project": ProjectUsageStatsResponseProject.from_dict(obj["project"]) if obj.get("project") is not None else None,
