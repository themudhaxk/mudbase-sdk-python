...
class InitializePaymentRequest(BaseModel):
    ...
    """ # noqa: E501
    amount: Union[Annotated[float, Field(strict=True, ge=0.01)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="Payment amount (e.g. USD)")
    currency: Optional[StrictStr] = 'USD'
    project_id: Optional[StrictStr] = Field(default=None, description="Optional project scope", alias="projectId")
    customer: InitializePaymentRequestCustomer
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="title, description, redirectUrl, etc.")
    __properties: ClassVar[List[str]] = ["amount", "currency", "projectId", "customer", "metadata"]
