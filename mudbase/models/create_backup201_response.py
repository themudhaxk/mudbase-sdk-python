...
class CreateBackup201Response(BaseModel):
    """
    CreateBackup201Response
    """ # noqa: E501
    backup: Optional[CreateBackup201ResponseBackup] = None
    __properties: ClassVar[List[str]] = ["backup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backup": CreateBackup201ResponseBackup.from_dict(obj["backup"]) if obj.get("backup") is not None else None
        })
        return _obj
