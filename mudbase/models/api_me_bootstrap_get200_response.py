...
class ApiMeBootstrapGet200Response(BaseModel):
    """
    ApiMeBootstrapGet200Response
    """ # noqa: E501
    user: Optional[Dict[str, Any]] = None
    organizations: Optional[List[Dict[str, Any]]] = None
    default_org: Optional[Dict[str, Any]] = Field(default=None, alias="defaultOrg")
    projects: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["user", "organizations", "defaultOrg", "projects"]
