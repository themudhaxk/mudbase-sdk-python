...
class PushSentResponseDataChannelsWebPush(BaseModel):
    """
    ...
    pruned: Optional[StrictInt] = Field(default=None, description="Subscriptions the push service reported as gone (404/410) and that were pruned during this send. ")
    __properties: ClassVar[List[str]] = ["successCount", "failureCount", "pruned"]
