...
class InternalDomainDnsRecheckBatchRequest(BaseModel):
    """
    InternalDomainDnsRecheckBatchRequest
    """ # noqa: E501
    max_orgs: Optional[StrictInt] = Field(default=None, alias="maxOrgs")
    recheck_older_than_hours: Optional[StrictInt] = Field(default=None, alias="recheckOlderThanHours")
    __properties: ClassVar[List[str]] = ["maxOrgs", "recheckOlderThanHours"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxOrgs": obj.get("maxOrgs"),
            "recheckOlderThanHours": obj.get("recheckOlderThanHours")
        })
        return _obj
