...
class SimulateFunctionTriggerRequest(BaseModel):
    """
    SimulateFunctionTriggerRequest
    """ # noqa: E501
    trigger: Optional[Dict[str, Any]] = Field(default=None, description="Simulated trigger (type, event)")
    event_context: Optional[Dict[str, Any]] = Field(default=None, description="Simulated event context (document, file, webhook, message)", alias="eventContext")
    payload: Optional[Dict[str, Any]] = Field(default=None, description="Additional payload")
    __properties: ClassVar[List[str]] = ["trigger", "eventContext", "payload"]
