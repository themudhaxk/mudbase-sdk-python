...
class GetComplianceSummary200ResponseComplianceSoc2(BaseModel):
    """
    GetComplianceSummary200ResponseComplianceSoc2
    """ # noqa: E501
    access_reviews_enabled: Optional[StrictBool] = Field(default=None, alias="accessReviewsEnabled")
    audit_logging_enabled: Optional[StrictBool] = Field(default=None, alias="auditLoggingEnabled")
    encryption_enabled: Optional[StrictBool] = Field(default=None, alias="encryptionEnabled")
    __properties: ClassVar[List[str]] = ["accessReviewsEnabled", "auditLoggingEnabled", "encryptionEnabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetComplianceSummary200ResponseComplianceSoc2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetComplianceSummary200ResponseComplianceSoc2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accessReviewsEnabled": obj.get("accessReviewsEnabled"),
            "auditLoggingEnabled": obj.get("auditLoggingEnabled"),
