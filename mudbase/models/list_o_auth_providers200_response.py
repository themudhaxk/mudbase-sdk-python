...
class ListOAuthProviders200Response(BaseModel):
    """
    ListOAuthProviders200Response
    """ # noqa: E501
    providers: Optional[List[ListOAuthProviders200ResponseProvidersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [ListOAuthProviders200ResponseProvidersInner.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
