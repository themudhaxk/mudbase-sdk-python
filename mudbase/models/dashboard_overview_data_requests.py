...
class DashboardOverviewDataRequests(BaseModel):
    """
    DashboardOverviewDataRequests
    """ # noqa: E501
    today: Optional[StrictInt] = Field(default=None, description="Billing trackApiCall count (UTC day)")
    yesterday: Optional[StrictInt] = None
    latency_tracked_today: Optional[StrictInt] = Field(default=None, description="UsageStat latencyCount for this project (middleware-metered responses)", alias="latencyTrackedToday")
    latency_tracked_yesterday: Optional[StrictInt] = Field(default=None, alias="latencyTrackedYesterday")
    metering_note: Optional[StrictStr] = Field(default=None, alias="meteringNote")
    change_pct: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="changePct")
    direction: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["today", "yesterday", "latencyTrackedToday", "latencyTrackedYesterday", "meteringNote", "changePct", "direction"]
    ...
    def direction_validate_enum(cls, value):
        ...
        if value not in set(['up', 'down', 'flat']):
            raise ValueError("must be one of enum values ('up', 'down', 'flat')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latencyTrackedToday": obj.get("latencyTrackedToday"),
            "latencyTrackedYesterday": obj.get("latencyTrackedYesterday"),
            "meteringNote": obj.get("meteringNote"),
