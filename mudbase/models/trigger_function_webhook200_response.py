...
class TriggerFunctionWebhook200Response(BaseModel):
    """
    TriggerFunctionWebhook200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    triggered: Optional[StrictInt] = Field(default=None, description="Number of functions triggered")
    results: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["success", "triggered", "results"]
