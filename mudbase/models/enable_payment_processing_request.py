...
class EnablePaymentProcessingRequest(BaseModel):
    """
    EnablePaymentProcessingRequest
    """ # noqa: E501
    account_bank: StrictStr = Field(description="Bank code (from GET /v3/banks/{country})", alias="accountBank")
    account_number: StrictStr = Field(description="Org bank account number", alias="accountNumber")
    country: StrictStr = Field(description="Country code (e.g. US, NG)")
    business_name: StrictStr = Field(alias="businessName")
    business_mobile: Optional[StrictStr] = Field(default=None, alias="businessMobile")
    bvn: Optional[StrictStr] = Field(default=None, description="Required only when country is NG (Nigeria)")
    __properties: ClassVar[List[str]] = ["accountBank", "accountNumber", "country", "businessName", "businessMobile", "bvn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountBank": obj.get("accountBank"),
            "accountNumber": obj.get("accountNumber"),
            "country": obj.get("country"),
            "businessName": obj.get("businessName"),
            "businessMobile": obj.get("businessMobile"),
            "bvn": obj.get("bvn")
        })
        return _obj
