...
class GetSubscriptionTiers200Response(BaseModel):
    """
    GetSubscriptionTiers200Response
    """ # noqa: E501
    plans: Optional[List[GetSubscriptionTiers200ResponsePlansInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plans": [GetSubscriptionTiers200ResponsePlansInner.from_dict(_item) for _item in obj["plans"]] if obj.get("plans") is not None else None
        })
        return _obj
