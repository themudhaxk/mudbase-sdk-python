...
class GetOrgOAuthProviders200Response(BaseModel):
    """
    GetOrgOAuthProviders200Response
    """ # noqa: E501
    providers: Optional[List[GetOrgOAuthProviders200ResponseProvidersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [GetOrgOAuthProviders200ResponseProvidersInner.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None,
            "total": obj.get("total")
        })
        return _obj
