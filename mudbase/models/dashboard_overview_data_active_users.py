...
class DashboardOverviewDataActiveUsers(BaseModel):
    """
    DashboardOverviewDataActiveUsers
    """ # noqa: E501
    last24h: Optional[StrictInt] = None
    last7d: Optional[StrictInt] = None
    last30d: Optional[StrictInt] = None
    change_pct7d: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="changePct7d")
    direction7d: Optional[StrictStr] = None
    realtime_connected: Optional[StrictInt] = Field(default=None, alias="realtimeConnected")
    __properties: ClassVar[List[str]] = ["last24h", "last7d", "last30d", "changePct7d", "direction7d", "realtimeConnected"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "last24h": obj.get("last24h"),
            "last7d": obj.get("last7d"),
            "last30d": obj.get("last30d"),
            "changePct7d": obj.get("changePct7d"),
            "direction7d": obj.get("direction7d"),
            "realtimeConnected": obj.get("realtimeConnected")
        })
        return _obj
