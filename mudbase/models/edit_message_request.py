...
class EditMessageRequest(BaseModel):
    ...
    EditMessageRequest
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="New plaintext (non-E2EE messages only)")
    e2ee: Optional[EditMessageRequestE2ee] = None
    __properties: ClassVar[List[str]] = ["content", "e2ee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e2ee": EditMessageRequestE2ee.from_dict(obj["e2ee"]) if obj.get("e2ee") is not None else None
        })
        return _obj
