...
class VerifyOrgPlanPayment200Response(BaseModel):
    """
    VerifyOrgPlanPayment200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    data: Optional[VerifyOrgPlanPayment200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": VerifyOrgPlanPayment200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
