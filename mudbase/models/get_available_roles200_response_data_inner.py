...
class GetAvailableRoles200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["slug", "name", "description", "signupEndpoint", "requiresApproval", "requiresPayment", "requiresKYC"]
