...
class GetFeeBreakdown200ResponseData(BaseModel):
    """
    GetFeeBreakdown200ResponseData
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    org_receives: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="orgReceives")
    platform_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="platformPercent")
    platform_fixed: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="platformFixed")
    processing_fee: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="processingFee")
    __properties: ClassVar[List[str]] = ["amount", "currency", "orgReceives", "platformPercent", "platformFixed", "processingFee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orgReceives": obj.get("orgReceives"),
            "platformPercent": obj.get("platformPercent"),
            "platformFixed": obj.get("platformFixed"),
            "processingFee": obj.get("processingFee")
        })
        return _obj
