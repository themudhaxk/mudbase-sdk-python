...
class GenerateAccessReviewRequest(BaseModel):
    """
    GenerateAccessReviewRequest
    """ # noqa: E501
    org_id: StrictStr = Field(alias="orgId")
    review_period: GenerateAccessReviewRequestReviewPeriod = Field(alias="reviewPeriod")
    __properties: ClassVar[List[str]] = ["orgId", "reviewPeriod"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of review_period
        if self.review_period:
            _dict['reviewPeriod'] = self.review_period.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orgId": obj.get("orgId"),
            "reviewPeriod": GenerateAccessReviewRequestReviewPeriod.from_dict(obj["reviewPeriod"]) if obj.get("reviewPeriod") is not None else None
        })
        return _obj
