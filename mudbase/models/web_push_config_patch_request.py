...
class WebPushConfigPatchRequest(BaseModel):
    """
    ...
    rotate_keys: Optional[StrictBool] = Field(default=None, alias="rotateKeys")
    subject: Optional[StrictStr] = Field(default=None, description="A `mailto:` address or an `https` URL.")
    __properties: ClassVar[List[str]] = ["enabled", "rotateKeys", "subject"]
