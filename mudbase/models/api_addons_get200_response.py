...
class ApiAddonsGet200Response(BaseModel):
    """
    ApiAddonsGet200Response
    """ # noqa: E501
    addons: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["addons"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiAddonsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiAddonsGet200Response from a dict"""
        if obj is None:
            return None
