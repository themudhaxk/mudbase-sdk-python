...
class UploadVerificationDocumentsRequest(BaseModel):
    """
    UploadVerificationDocumentsRequest
    """ # noqa: E501
    role_slug: StrictStr = Field(alias="roleSlug")
    documents: List[UploadVerificationDocumentsRequestDocumentsInner]
    __properties: ClassVar[List[str]] = ["roleSlug", "documents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roleSlug": obj.get("roleSlug"),
            "documents": [UploadVerificationDocumentsRequestDocumentsInner.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
