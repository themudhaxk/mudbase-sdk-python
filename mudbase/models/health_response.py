...
class HealthResponse(BaseModel):
    ...
    services: Optional[HealthResponseServices] = None
    version: Optional[StrictStr] = None
    uptime: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["status", "timestamp", "services", "version", "uptime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": HealthResponseServices.from_dict(obj["services"]) if obj.get("services") is not None else None,
