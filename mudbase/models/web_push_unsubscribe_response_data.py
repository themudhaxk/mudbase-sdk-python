...
class WebPushUnsubscribeResponseData(BaseModel):
    """
    WebPushUnsubscribeResponseData
    """ # noqa: E501
    removed: Optional[StrictBool] = Field(default=None, description="True if a matching subscription was removed; false if none was registered. ")
