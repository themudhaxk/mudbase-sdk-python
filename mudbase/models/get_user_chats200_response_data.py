...
class GetUserChats200ResponseData(BaseModel):
    """
    GetUserChats200ResponseData
    """ # noqa: E501
    chats: Optional[List[GetUserChats200ResponseDataChatsInner]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["chats", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chats": [GetUserChats200ResponseDataChatsInner.from_dict(_item) for _item in obj["chats"]] if obj.get("chats") is not None else None,
            "total": obj.get("total")
        })
        return _obj
