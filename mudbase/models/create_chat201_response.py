...
class CreateChat201Response(BaseModel):
    """
    CreateChat201Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[CreateChat201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateChat201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
