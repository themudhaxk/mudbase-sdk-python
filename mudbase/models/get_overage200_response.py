...
class GetOverage200Response(BaseModel):
    """
    GetOverage200Response
    """ # noqa: E501
    overage: Optional[List[GetOverage200ResponseOverageInner]] = None
    __properties: ClassVar[List[str]] = ["overage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in overage (list)
        _items = []
        if self.overage:
            for _item_overage in self.overage:
                if _item_overage:
                    _items.append(_item_overage.to_dict())
            _dict['overage'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "overage": [GetOverage200ResponseOverageInner.from_dict(_item) for _item in obj["overage"]] if obj.get("overage") is not None else None
        })
        return _obj
