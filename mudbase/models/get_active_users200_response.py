...
class GetActiveUsers200Response(BaseModel):
    """
    GetActiveUsers200Response
    """ # noqa: E501
    users: Optional[List[GetActiveUsers200ResponseUsersInner]] = None
    count: Optional[StrictInt] = None
    timestamp: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["users", "count", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [GetActiveUsers200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "count": obj.get("count"),
