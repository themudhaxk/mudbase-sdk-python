...
class CreateOrUpdateFeeSettingsRequest(BaseModel):
    """
    CreateOrUpdateFeeSettingsRequest
    """ # noqa: E501
    currency: StrictStr
    enabled: Optional[StrictBool] = None
    fee_amount: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, alias="feeAmount")
    payout_address: Optional[StrictStr] = Field(default=None, alias="payoutAddress")
    payout_threshold: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, alias="payoutThreshold")
    __properties: ClassVar[List[str]] = ["currency", "enabled", "feeAmount", "payoutAddress", "payoutThreshold"]

    @field_validator('currency')
    def currency_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BTC', 'ETH', 'BNB', 'LTC', 'SOL', 'TRX', 'USDT-ETH', 'USDT-BSC', 'USDT-TRX', 'USDT-SOL']):
            raise ValueError("must be one of enum values ('BTC', 'ETH', 'BNB', 'LTC', 'SOL', 'TRX', 'USDT-ETH', 'USDT-BSC', 'USDT-TRX', 'USDT-SOL')")
        return value
