...
class UpdateBucketRequest(BaseModel):
    ...
    UpdateBucketRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Updated name of the bucket")
    is_public: Optional[StrictBool] = Field(default=None, description="Update whether the bucket is publicly accessible", alias="isPublic")
    settings: Optional[Dict[str, Any]] = Field(default=None, description="Updated bucket settings")
    __properties: ClassVar[List[str]] = ["name", "isPublic", "settings"]
