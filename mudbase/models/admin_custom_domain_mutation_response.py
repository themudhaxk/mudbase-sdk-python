...
class AdminCustomDomainMutationResponse(BaseModel):
    """
    AdminCustomDomainMutationResponse
    """ # noqa: E501
    success: StrictBool
    domain: OrgDomainEntryWithDns
    __properties: ClassVar[List[str]] = ["success", "domain"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domain": OrgDomainEntryWithDns.from_dict(obj["domain"]) if obj.get("domain") is not None else None
        })
        return _obj
