...
class FunctionStats(BaseModel):
    ...
    FunctionStats
    """ # noqa: E501
    total_executions: Optional[StrictInt] = Field(default=None, alias="totalExecutions")
    successful_executions: Optional[StrictInt] = Field(default=None, alias="successfulExecutions")
    failed_executions: Optional[StrictInt] = Field(default=None, alias="failedExecutions")
    ...
    __properties: ClassVar[List[str]] = ["totalExecutions", "successfulExecutions", "failedExecutions", "avgExecutionTime", "lastExecution"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failedExecutions": obj.get("failedExecutions"),
