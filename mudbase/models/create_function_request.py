...
class CreateFunctionRequest(BaseModel):
    ...
    code: StrictStr = Field(description="Function body (async, has access to payload, db, files, messaging, utils, env, console)")
    trigger: FunctionTrigger
    environment: Optional[Dict[str, StrictStr]] = Field(default=None, description="Per-function env vars injected into sandbox")
    __properties: ClassVar[List[str]] = ["name", "description", "code", "trigger", "environment"]
