...
class ConfirmUploadResponse(BaseModel):
    ...
    scan: Optional[ConfirmUploadResponseScan] = None
    __properties: ClassVar[List[str]] = ["fileId", "status", "scan"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ok', 'quarantined', 'error']):
            raise ValueError("must be one of enum values ('ok', 'quarantined', 'error')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scan": ConfirmUploadResponseScan.from_dict(obj["scan"]) if obj.get("scan") is not None else None
        })
        return _obj
