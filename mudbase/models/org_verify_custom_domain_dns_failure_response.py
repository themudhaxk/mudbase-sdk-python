...
class OrgVerifyCustomDomainDnsFailureResponse(BaseModel):
    """
    ...
    code: StrictStr
    error: StrictStr
    challenge_host: StrictStr = Field(alias="challengeHost")
    expected_txt: StrictStr = Field(alias="expectedTxt")
    ...
    __properties: ClassVar[List[str]] = ["success", "code", "error", "challengeHost", "expectedTxt", "dnsTxtHost", "dnsTxtValue", "status", "verificationToken"]
