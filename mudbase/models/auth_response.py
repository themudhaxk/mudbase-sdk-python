...
class AuthResponse(BaseModel):
    ...
    token: Optional[StrictStr] = Field(default=None, description="JWT access token (use in Authorization Bearer header)")
    refresh_token: Optional[StrictStr] = Field(default=None, description="JWT refresh token (use with POST /api/auth/refresh to get new token pair)", alias="refreshToken")
    expires_in: Optional[StrictInt] = Field(default=None, description="Access token TTL in seconds (e.g. 1800 for 30 minutes)", alias="expiresIn")
