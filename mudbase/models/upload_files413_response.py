...
class UploadFiles413Response(BaseModel):
    """
    UploadFiles413Response
    """ # noqa: E501
    error: Optional[StrictStr] = None
    max_file_upload_bytes: Optional[StrictInt] = Field(default=None, alias="maxFileUploadBytes")
    __properties: ClassVar[List[str]] = ["error", "maxFileUploadBytes"]
