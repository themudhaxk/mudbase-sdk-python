...
class UpdateUserAccountStatusRequest(BaseModel):
    """
    UpdateUserAccountStatusRequest
    """ # noqa: E501
    account_status: StrictStr = Field(description="active = full access; suspended = blocked from using the app", alias="accountStatus")
    __properties: ClassVar[List[str]] = ["accountStatus"]
