...
class ConfigureOAuthProviderRequest(BaseModel):
    ...
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether the OAuth provider is enabled")
    client_id: StrictStr = Field(description="OAuth client ID from the provider", alias="clientId")
    client_secret: StrictStr = Field(description="OAuth client secret from the provider", alias="clientSecret")
