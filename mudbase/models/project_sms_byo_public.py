...
class ProjectSmsByoPublic(BaseModel):
    """
    ProjectSmsByoPublic
    """ # noqa: E501
    enabled: Optional[StrictBool] = None
    provider: Optional[StrictStr] = None
    default_from: Optional[StrictStr] = Field(default=None, alias="defaultFrom")
    has_credentials: Optional[StrictBool] = Field(default=None, alias="hasCredentials")
    __properties: ClassVar[List[str]] = ["enabled", "provider", "defaultFrom", "hasCredentials"]
