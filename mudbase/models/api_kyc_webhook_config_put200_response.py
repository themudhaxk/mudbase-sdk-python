...
class ApiKycWebhookConfigPut200Response(BaseModel):
    """
    ApiKycWebhookConfigPut200Response
    """ # noqa: E501
    webhook_url: Optional[StrictStr] = Field(default=None, alias="webhookUrl")
    secret_set: Optional[StrictBool] = Field(default=None, alias="secretSet")
    webhook_secret: Optional[StrictStr] = Field(default=None, description="Only present when generateSecret was true.", alias="webhookSecret")
    __properties: ClassVar[List[str]] = ["webhookUrl", "secretSet", "webhookSecret"]
