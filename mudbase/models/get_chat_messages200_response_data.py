...
class GetChatMessages200ResponseData(BaseModel):
    """
    GetChatMessages200ResponseData
    """ # noqa: E501
    messages: Optional[List[GetChatMessages200ResponseDataMessagesInner]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["messages", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [GetChatMessages200ResponseDataMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "total": obj.get("total")
        })
        return _obj
