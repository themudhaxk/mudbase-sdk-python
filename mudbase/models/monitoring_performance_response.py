...
class MonitoringPerformanceResponse(BaseModel):
    ...
    metrics: Optional[MonitoringPerformanceResponseMetrics] = None
    top_endpoints: Optional[List[Dict[str, Any]]] = Field(default=None, alias="topEndpoints")
    __properties: ClassVar[List[str]] = ["period", "metrics", "topEndpoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": MonitoringPerformanceResponseMetrics.from_dict(obj["metrics"]) if obj.get("metrics") is not None else None,
            "topEndpoints": obj.get("topEndpoints")
        })
        return _obj
