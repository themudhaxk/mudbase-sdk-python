...
class UpdateMultiRoleSettings200Response(BaseModel):
    """
    UpdateMultiRoleSettings200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    data: Optional[Dict[str, Any]] = Field(default=None, description="Same shape as GET `/multi-role` — `isEnabled`, `defaultRole`, `settings`, and `roles` (no raw MultiRoleFeature document).")
