...
class LoginLocalUser200Response(BaseModel):
    """
    ...
    user: Optional[LoginLocalUser200ResponseUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": LoginLocalUser200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
