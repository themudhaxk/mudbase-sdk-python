...
class DeviceUnregisteredResponseData(BaseModel):
    """
    DeviceUnregisteredResponseData
    """ # noqa: E501
    removed: Optional[StrictBool] = Field(default=None, description="True if a matching token was removed; false if none was registered.")
