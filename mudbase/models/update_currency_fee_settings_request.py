...
class UpdateCurrencyFeeSettingsRequest(BaseModel):
    """
    ...
    payout_threshold: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="payoutThreshold")
    __properties: ClassVar[List[str]] = ["enabled", "feeAmount", "payoutAddress", "payoutThreshold"]
