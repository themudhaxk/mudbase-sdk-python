...
class ApiGdprErasePostRequest(BaseModel):
    """
    ApiGdprErasePostRequest
    """ # noqa: E501
    confirm: StrictStr = Field(description="Must equal \"DELETE\" to proceed with erasure.")
    ...
    def confirm_validate_enum(cls, value):
        """Validates the enum"""
