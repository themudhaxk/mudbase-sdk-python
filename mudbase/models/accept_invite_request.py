...
class AcceptInviteRequest(BaseModel):
    ...
    AcceptInviteRequest
    """ # noqa: E501
    token: StrictStr = Field(description="Invitation token from the invite email link")
    password: Annotated[str, Field(min_length=8, strict=True)] = Field(description="Password for the new account")
    first_name: StrictStr = Field(alias="firstName")
    last_name: StrictStr = Field(alias="lastName")
    __properties: ClassVar[List[str]] = ["token", "password", "firstName", "lastName"]
