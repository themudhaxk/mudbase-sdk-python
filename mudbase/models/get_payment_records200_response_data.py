...
class GetPaymentRecords200ResponseData(BaseModel):
    """
    GetPaymentRecords200ResponseData
    """ # noqa: E501
    records: Optional[List[GetPaymentRecords200ResponseDataRecordsInner]] = None
    pagination: Optional[GetPaymentRecords200ResponseDataPagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [GetPaymentRecords200ResponseDataRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
            "pagination": GetPaymentRecords200ResponseDataPagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
