...
class VerifyProjectEmailSmtpDomainRequest(BaseModel):
    """
    VerifyProjectEmailSmtpDomainRequest
    """ # noqa: E501
    domain: Optional[StrictStr] = None
    from_email: Optional[StrictStr] = Field(default=None, alias="fromEmail")
    persist: Optional[StrictBool] = Field(default=None, description="If true and checks pass, persist domainVerifiedAt on the project")
    __properties: ClassVar[List[str]] = ["domain", "fromEmail", "persist"]
