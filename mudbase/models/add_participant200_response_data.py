...
class AddParticipant200ResponseData(BaseModel):
    """
    AddParticipant200ResponseData
    """ # noqa: E501
    participants: Optional[List[AddParticipant200ResponseDataParticipantsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "participants": [AddParticipant200ResponseDataParticipantsInner.from_dict(_item) for _item in obj["participants"]] if obj.get("participants") is not None else None
        })
        return _obj
