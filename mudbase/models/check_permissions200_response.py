...
class CheckPermissions200Response(BaseModel):
    """
    CheckPermissions200Response
    """ # noqa: E501
    user: Optional[Dict[str, Any]] = None
    permissions: Optional[CheckPermissions200ResponsePermissions] = None
    __properties: ClassVar[List[str]] = ["user", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": obj.get("user"),
            "permissions": CheckPermissions200ResponsePermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None
        })
        return _obj
