...
class GetSearchAnalytics200Response(BaseModel):
    """
    GetSearchAnalytics200Response
    """ # noqa: E501
    total_searches: Optional[StrictInt] = Field(default=None, alias="totalSearches")
    top_queries: Optional[List[GetSearchAnalytics200ResponseTopQueriesInner]] = Field(default=None, alias="topQueries")
    searches_by_collection: Optional[Dict[str, Any]] = Field(default=None, alias="searchesByCollection")
    average_response_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averageResponseTime")
    __properties: ClassVar[List[str]] = ["totalSearches", "topQueries", "searchesByCollection", "averageResponseTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in top_queries (list)
        _items = []
        if self.top_queries:
            for _item_top_queries in self.top_queries:
                if _item_top_queries:
                    _items.append(_item_top_queries.to_dict())
            _dict['topQueries'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "topQueries": [GetSearchAnalytics200ResponseTopQueriesInner.from_dict(_item) for _item in obj["topQueries"]] if obj.get("topQueries") is not None else None,
            "searchesByCollection": obj.get("searchesByCollection"),
