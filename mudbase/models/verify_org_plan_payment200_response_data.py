...
class VerifyOrgPlanPayment200ResponseData(BaseModel):
    """
    VerifyOrgPlanPayment200ResponseData
    """ # noqa: E501
    plan: Optional[StrictStr] = Field(default=None, description="New plan name (e.g. starter)")
    ...
    __properties: ClassVar[List[str]] = ["plan", "billingCycle", "orgId"]
