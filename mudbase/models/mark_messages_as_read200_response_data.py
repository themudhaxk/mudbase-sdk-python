...
class MarkMessagesAsRead200ResponseData(BaseModel):
    """
    MarkMessagesAsRead200ResponseData
    """ # noqa: E501
    modified_count: Optional[StrictInt] = Field(default=None, alias="modifiedCount")
    __properties: ClassVar[List[str]] = ["modifiedCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarkMessagesAsRead200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarkMessagesAsRead200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "modifiedCount": obj.get("modifiedCount")
        })
        return _obj
