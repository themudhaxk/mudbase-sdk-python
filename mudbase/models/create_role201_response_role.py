...
class CreateRole201ResponseRole(BaseModel):
    """
    ...
    permissions: Optional[List[CreateRole201ResponseRolePermissionsInner]] = None
    hierarchy: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["_id", "name", "slug", "description", "permissions", "hierarchy", "isSystem", "isActive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": [CreateRole201ResponseRolePermissionsInner.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None,
