...
class GetOrganizationMembers200Response(BaseModel):
    """
    GetOrganizationMembers200Response
    """ # noqa: E501
    members: Optional[List[User]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["members", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [User.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "total": obj.get("total")
        })
        return _obj
