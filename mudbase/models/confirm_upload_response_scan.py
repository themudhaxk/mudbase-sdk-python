...
class ConfirmUploadResponseScan(BaseModel):
    """
    Virus scan result (provider, status, detections, raw analysis)
    """ # noqa: E501
    status: Optional[StrictStr] = None
    provider: Optional[StrictStr] = None
    detections: Optional[StrictInt] = None
    analysis: Optional[Dict[str, Any]] = Field(default=None, description="Raw analysis object returned by the scanner (e.g., VirusTotal)")
    __properties: ClassVar[List[str]] = ["status", "provider", "detections", "analysis"]
