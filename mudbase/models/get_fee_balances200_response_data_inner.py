...
class GetFeeBalances200ResponseDataInner(BaseModel):
    """
    GetFeeBalances200ResponseDataInner
    """ # noqa: E501
    currency: Optional[StrictStr] = None
    collected_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="collectedAmount")
    threshold: Optional[Union[StrictFloat, StrictInt]] = None
    status: Optional[StrictStr] = None
    total_collected: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalCollected")
    total_paid_out: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPaidOut")
    __properties: ClassVar[List[str]] = ["currency", "collectedAmount", "threshold", "status", "totalCollected", "totalPaidOut"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collectedAmount": obj.get("collectedAmount"),
            "threshold": obj.get("threshold"),
            "status": obj.get("status"),
            "totalCollected": obj.get("totalCollected"),
            "totalPaidOut": obj.get("totalPaidOut")
        })
        return _obj
