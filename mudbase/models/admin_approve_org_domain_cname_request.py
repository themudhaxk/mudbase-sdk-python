...
class AdminApproveOrgDomainCnameRequest(BaseModel):
    """
    AdminApproveOrgDomainCnameRequest
    """ # noqa: E501
    verify_dns: Optional[StrictBool] = Field(default=None, description="When true, public DNS CNAME chain for hostname must match Fly `dns_requirements.cname` when stored, else `CUSTOM_DOMAIN_API_CNAME_TARGET`.", alias="verifyDns")
    __properties: ClassVar[List[str]] = ["verifyDns"]
