...
class MonitoringLogsResponse(BaseModel):
    ...
    """ # noqa: E501
    logs: Optional[List[MonitoringLogsResponseLogsInner]] = None
    count: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    limit: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    total_pages: Optional[StrictInt] = Field(default=None, alias="totalPages")
    __properties: ClassVar[List[str]] = ["logs", "count", "page", "limit", "total", "totalPages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [MonitoringLogsResponseLogsInner.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
            "count": obj.get("count"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "total": obj.get("total"),
