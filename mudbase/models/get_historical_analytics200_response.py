...
class GetHistoricalAnalytics200Response(BaseModel):
    """
    GetHistoricalAnalytics200Response
    """ # noqa: E501
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    period: Optional[StrictStr] = None
    data: Optional[List[GetHistoricalAnalytics200ResponseDataInner]] = None
    generated_at: Optional[datetime] = Field(default=None, alias="generatedAt")
    __properties: ClassVar[List[str]] = ["projectId", "period", "data", "generatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetHistoricalAnalytics200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
