...
class GetBillingEstimate200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lineItems": [GetBillingEstimate200ResponseLineItemsInner.from_dict(_item) for _item in obj["lineItems"]] if obj.get("lineItems") is not None else None,
            "estimatedOverageCents": obj.get("estimatedOverageCents"),
            "estimatedOverage": obj.get("estimatedOverage"),
            "forecastOverageCents": obj.get("forecastOverageCents"),
            "forecastOverage": obj.get("forecastOverage"),
            "message": obj.get("message"),
            "spendLimits": GetBillingEstimate200ResponseSpendLimits.from_dict(obj["spendLimits"]) if obj.get("spendLimits") is not None else None
        })
        return _obj
