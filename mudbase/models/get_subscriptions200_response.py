...
class GetSubscriptions200Response(BaseModel):
    """
    GetSubscriptions200Response
    """ # noqa: E501
    subscriptions: Optional[List[GetSubscriptions200ResponseSubscriptionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [GetSubscriptions200ResponseSubscriptionsInner.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
        return _obj
