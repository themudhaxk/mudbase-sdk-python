...
class FunctionLogsResponseData(BaseModel):
    """
    FunctionLogsResponseData
    """ # noqa: E501
    executions: Optional[List[FunctionExecution]] = None
    stats: Optional[FunctionStats] = None
    __properties: ClassVar[List[str]] = ["executions", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "executions": [FunctionExecution.from_dict(_item) for _item in obj["executions"]] if obj.get("executions") is not None else None,
            "stats": FunctionStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
