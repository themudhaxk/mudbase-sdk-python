...
class SearchResponseData(BaseModel):
    ...
    search_time: Optional[StrictInt] = Field(default=None, alias="searchTime")
    __properties: ClassVar[List[str]] = ["results", "pagination", "query", "searchTime"]
