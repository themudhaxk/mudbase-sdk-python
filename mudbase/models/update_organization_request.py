...
class UpdateOrganizationRequest(BaseModel):
    ...
    logo: Optional[StrictStr] = Field(default=None, description="Optional logo URL. Not used for emails (org emails use platform logo).")
    website: Optional[StrictStr] = None
    settings: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "logo", "website", "settings"]
