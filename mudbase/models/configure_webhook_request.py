...
class ConfigureWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    webhook_url: Optional[StrictStr] = Field(default=None, description="URL to receive webhook payloads; set to null or omit to disable", alias="webhookUrl")
    webhook_secret: Optional[StrictStr] = Field(default=None, description="Optional secret for signing payloads (e.g. X-Webhook-Signature)", alias="webhookSecret")
    webhook_events: Optional[List[StrictStr]] = Field(default=None, description="Event types to send (e.g. collection.insert, collection.update)", alias="webhookEvents")
    webhook_version: Optional[StrictStr] = Field(default=None, description="Version string for payload format", alias="webhookVersion")
    transformations: Optional[List[GetWebhookConfig200ResponseDataTransformationsInner]] = Field(default=None, description="Transformation rules to apply to payloads before delivery")
    __properties: ClassVar[List[str]] = ["webhookUrl", "webhookSecret", "webhookEvents", "webhookVersion", "transformations"]
