...
class RestoreBackup200Response(BaseModel):
    """
    RestoreBackup200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    restore: Optional[RestoreBackup200ResponseRestore] = None
    __properties: ClassVar[List[str]] = ["message", "restore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "restore": RestoreBackup200ResponseRestore.from_dict(obj["restore"]) if obj.get("restore") is not None else None
        })
        return _obj
