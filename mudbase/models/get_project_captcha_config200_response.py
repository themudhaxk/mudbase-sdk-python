...
class GetProjectCaptchaConfig200Response(BaseModel):
    """
    GetProjectCaptchaConfig200Response
    """ # noqa: E501
    captcha: Optional[GetProjectCaptchaConfig200ResponseCaptcha] = None
    __properties: ClassVar[List[str]] = ["captcha"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "captcha": GetProjectCaptchaConfig200ResponseCaptcha.from_dict(obj["captcha"]) if obj.get("captcha") is not None else None
        })
        return _obj
