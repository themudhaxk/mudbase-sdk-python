...
class GetIntegration200Response(BaseModel):
    """
    GetIntegration200Response
    """ # noqa: E501
    integration: Optional[GetIntegration200ResponseIntegration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": GetIntegration200ResponseIntegration.from_dict(obj["integration"]) if obj.get("integration") is not None else None
        })
        return _obj
