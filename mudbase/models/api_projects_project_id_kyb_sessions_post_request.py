...
class ApiProjectsProjectIdKybSessionsPostRequest(BaseModel):
    """
    ApiProjectsProjectIdKybSessionsPostRequest
    """ # noqa: E501
    workflow_id: Optional[StrictStr] = Field(default=None, description="Overrides the organization's default KYB workflow.", alias="workflowId")
    vendor_business_id: Optional[StrictStr] = Field(default=None, description="Your own identifier for the business being verified.", alias="vendorBusinessId")
    vendor_data: Optional[StrictStr] = Field(default=None, description="Arbitrary reference echoed back on webhooks.", alias="vendorData")
    callback: Optional[StrictStr] = Field(default=None, description="Where to redirect the business user after the hosted flow.")
    language: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["workflowId", "vendorBusinessId", "vendorData", "callback", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vendorBusinessId": obj.get("vendorBusinessId"),
