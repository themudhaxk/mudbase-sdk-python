...
class InitializePayment200ResponseData(BaseModel):
    """
    InitializePayment200ResponseData
    """ # noqa: E501
    link: Optional[StrictStr] = None
    tx_ref: Optional[StrictStr] = Field(default=None, alias="txRef")
    ...
    __properties: ClassVar[List[str]] = ["link", "txRef", "providerRef", "amount", "currency", "orgReceives", "platformPercent", "platformFixed"]
