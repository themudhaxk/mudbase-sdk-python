...
class GenerateDataProcessingRecord200Response(BaseModel):
    """
    GenerateDataProcessingRecord200Response
    """ # noqa: E501
    record: Optional[GenerateDataProcessingRecord200ResponseRecord] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "record": GenerateDataProcessingRecord200ResponseRecord.from_dict(obj["record"]) if obj.get("record") is not None else None
        })
        return _obj
