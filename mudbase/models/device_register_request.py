...
class DeviceRegisterRequest(BaseModel):
    ...
    """ # noqa: E501
    token: StrictStr = Field(description="The device push token issued to your app by its push client.")
    platform: Optional[StrictStr] = Field(default='unknown', description="The device platform. Defaults to `unknown` when omitted or unrecognized.")
    __properties: ClassVar[List[str]] = ["token", "platform"]
    ...
    def platform_validate_enum(cls, value):
        ...
        if value not in set(['ios', 'android', 'web', 'unknown']):
            raise ValueError("must be one of enum values ('ios', 'android', 'web', 'unknown')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": obj.get("token"),
            "platform": obj.get("platform") if obj.get("platform") is not None else 'unknown'
        })
        return _obj
