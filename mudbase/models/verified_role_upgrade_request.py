...
class VerifiedRoleUpgradeRequest(BaseModel):
    """
    VerifiedRoleUpgradeRequest
    """ # noqa: E501
    target_role: StrictStr = Field(alias="targetRole")
    payment_intent_id: Optional[StrictStr] = Field(default=None, description="Payment intent ID from payment provider", alias="paymentIntentId")
    verification_id: Optional[StrictStr] = Field(default=None, description="KYC verification ID (if required)", alias="verificationId")
    __properties: ClassVar[List[str]] = ["targetRole", "paymentIntentId", "verificationId"]
