...
class GetProjectEmailSmtp200Response(BaseModel):
    """
    GetProjectEmailSmtp200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[ProjectSmtpSettingsPublic] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ProjectSmtpSettingsPublic.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
