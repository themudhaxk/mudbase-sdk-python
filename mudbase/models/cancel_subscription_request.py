...
class CancelSubscriptionRequest(BaseModel):
    ...
    """ # noqa: E501
    cancel_immediately: Optional[StrictBool] = Field(default=False, description="If true, cancel immediately; otherwise at period end", alias="cancelImmediately")
    __properties: ClassVar[List[str]] = ["cancelImmediately"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cancelImmediately": obj.get("cancelImmediately") if obj.get("cancelImmediately") is not None else False
        })
        return _obj
