...
class WebPushSubscribeRequest(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="Optional end-user id to associate with this subscription, for targeted sends.", alias="userId")
    device_id: Optional[StrictStr] = Field(default=None, description="Optional client-supplied device identifier.", alias="deviceId")
    __properties: ClassVar[List[str]] = ["subscription", "userId", "deviceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscription": WebPushSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None,
