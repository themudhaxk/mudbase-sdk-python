...
class UsageStatsResponse(BaseModel):
    ...
    percentages: Optional[UsageStatsResponsePercentages] = None
    __properties: ClassVar[List[str]] = ["usage", "limits", "plan", "period", "percentages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of percentages
        if self.percentages:
            _dict['percentages'] = self.percentages.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "percentages": UsageStatsResponsePercentages.from_dict(obj["percentages"]) if obj.get("percentages") is not None else None
        })
        return _obj
