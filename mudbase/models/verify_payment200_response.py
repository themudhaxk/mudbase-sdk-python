...
class VerifyPayment200Response(BaseModel):
    """
    VerifyPayment200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    data: Optional[VerifyPayment200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": VerifyPayment200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
