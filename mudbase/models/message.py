...
class Message(BaseModel):
    ...
    recipients: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["_id", "type", "title", "body", "subject", "recipients", "successCount", "failureCount", "status", "sentAt"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['push', 'email', 'sms']):
            raise ValueError("must be one of enum values ('push', 'email', 'sms')")
        return value
