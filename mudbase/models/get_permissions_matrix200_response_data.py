...
class GetPermissionsMatrix200ResponseData(BaseModel):
    """
    GetPermissionsMatrix200ResponseData
    """ # noqa: E501
    collections: Optional[List[Dict[str, Any]]] = None
    roles: Optional[List[Dict[str, Any]]] = None
    features: Optional[List[Dict[str, Any]]] = Field(default=None, description="Per-role featurePermissions for app JWT gates")
    __properties: ClassVar[List[str]] = ["collections", "roles", "features"]
