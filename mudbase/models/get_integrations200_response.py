...
class GetIntegrations200Response(BaseModel):
    """
    GetIntegrations200Response
    """ # noqa: E501
    integrations: Optional[List[GetIntegrations200ResponseIntegrationsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [GetIntegrations200ResponseIntegrationsInner.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
