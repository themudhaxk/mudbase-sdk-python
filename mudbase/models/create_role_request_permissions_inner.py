...
class CreateRoleRequestPermissionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["resource", "actions", "conditions"]
    ...
    def resource_validate_enum(cls, value):
        ...
        if value not in set(['project', 'collection', 'data', 'file', 'api_key', 'org', 'member', 'role']):
            raise ValueError("must be one of enum values ('project', 'collection', 'data', 'file', 'api_key', 'org', 'member', 'role')")
        return value
    ...
    def actions_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['create', 'read', 'update', 'delete', 'manage']):
                raise ValueError("each list item must be one of ('create', 'read', 'update', 'delete', 'manage')")
        return value
