...
class UpsertProjectEmailTemplateRequest(BaseModel):
    """
    UpsertProjectEmailTemplateRequest
    """ # noqa: E501
    subject: StrictStr
    html_body: StrictStr = Field(alias="htmlBody")
    text_body: Optional[StrictStr] = Field(default=None, alias="textBody")
    variables: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["subject", "htmlBody", "textBody", "variables"]
