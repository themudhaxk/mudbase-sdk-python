...
class GetOverage200ResponseOverageInner(BaseModel):
    """
    GetOverage200ResponseOverageInner
    """ # noqa: E501
    resource: Optional[StrictStr] = Field(default=None, description="e.g. storage, apiCalls, realtimeMessages")
    units: Optional[Union[StrictFloat, StrictInt]] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resource", "units", "amount", "currency", "unit"]
