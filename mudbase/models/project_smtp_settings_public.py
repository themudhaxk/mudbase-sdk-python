...
class ProjectSmtpSettingsPublic(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enabled", "host", "port", "secure", "authUser", "hasPassword", "fromName", "fromEmail", "domainVerifiedAt"]
