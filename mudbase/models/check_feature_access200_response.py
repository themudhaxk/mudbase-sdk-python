...
class CheckFeatureAccess200Response(BaseModel):
    """
    CheckFeatureAccess200Response
    """ # noqa: E501
    has_access: Optional[StrictBool] = Field(default=None, alias="hasAccess")
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["hasAccess", "reason"]
