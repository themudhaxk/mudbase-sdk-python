...
class GetUsageWarnings200Response(BaseModel):
    """
    GetUsageWarnings200Response
    """ # noqa: E501
    warnings: Optional[List[GetUsageWarnings200ResponseWarningsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "warnings": [GetUsageWarnings200ResponseWarningsInner.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
