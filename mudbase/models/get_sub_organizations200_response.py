...
class GetSubOrganizations200Response(BaseModel):
    """
    GetSubOrganizations200Response
    """ # noqa: E501
    suborgs: Optional[List[Organization]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["suborgs", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "suborgs": [Organization.from_dict(_item) for _item in obj["suborgs"]] if obj.get("suborgs") is not None else None,
            "total": obj.get("total")
        })
        return _obj
