...
class AdminOrgStatusPatchRequest(BaseModel):
    """
    AdminOrgStatusPatchRequest
    """ # noqa: E501
    is_active: StrictBool = Field(alias="isActive")
    platform_suspended_reason: Optional[StrictStr] = Field(default=None, alias="platformSuspendedReason")
    platform_admin_note: Optional[StrictStr] = Field(default=None, alias="platformAdminNote")
    reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["isActive", "platformSuspendedReason", "platformAdminNote", "reason"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if platform_suspended_reason (nullable) is None
        # and model_fields_set contains the field
        if self.platform_suspended_reason is None and "platform_suspended_reason" in self.model_fields_set:
            _dict['platformSuspendedReason'] = None

        # set to None if platform_admin_note (nullable) is None
        # and model_fields_set contains the field
        if self.platform_admin_note is None and "platform_admin_note" in self.model_fields_set:
            _dict['platformAdminNote'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "platformSuspendedReason": obj.get("platformSuspendedReason"),
            "platformAdminNote": obj.get("platformAdminNote"),
