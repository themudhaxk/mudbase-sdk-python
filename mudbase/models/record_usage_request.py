...
class RecordUsageRequest(BaseModel):
    ...
    metric: StrictStr = Field(description="Usage metric name (e.g. api_calls, storage_mb)")
    quantity: Union[StrictFloat, StrictInt] = Field(description="Quantity to record")
    __properties: ClassVar[List[str]] = ["email", "metric", "quantity"]
