...
class GetComplianceSummary200ResponseComplianceSecurity(BaseModel):
    """
    GetComplianceSummary200ResponseComplianceSecurity
    """ # noqa: E501
    password_policy: Optional[StrictStr] = Field(default=None, alias="passwordPolicy")
    virus_scanning: Optional[StrictBool] = Field(default=None, alias="virusScanning")
    encryption_at_rest: Optional[StrictBool] = Field(default=None, alias="encryptionAtRest")
    __properties: ClassVar[List[str]] = ["passwordPolicy", "virusScanning", "encryptionAtRest"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "virusScanning": obj.get("virusScanning"),
            "encryptionAtRest": obj.get("encryptionAtRest")
        })
        return _obj
