...
class RemoveReaction200Response(BaseModel):
    """
    RemoveReaction200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[RemoveReaction200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [RemoveReaction200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
