...
class ProjectSmtpTestRequest(BaseModel):
    """
    ProjectSmtpTestRequest
    """ # noqa: E501
    to: StrictStr = Field(description="Recipient for verification and test message")
    use_saved: Optional[StrictBool] = Field(default=True, description="When true, use saved SMTP config; otherwise supply host/auth fields below", alias="useSaved")
    ...
    __properties: ClassVar[List[str]] = ["to", "useSaved", "host", "port", "secure", "authUser", "authPass", "fromEmail", "fromName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "to": obj.get("to"),
            "useSaved": obj.get("useSaved") if obj.get("useSaved") is not None else True,
            "host": obj.get("host"),
            "port": obj.get("port"),
