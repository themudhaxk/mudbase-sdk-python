...
class AcceptInvite201Response(BaseModel):
    """
    AcceptInvite201Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    token: Optional[StrictStr] = Field(default=None, description="JWT for the new user session")
    user: Optional[AcceptInvite201ResponseUser] = None
    __properties: ClassVar[List[str]] = ["message", "token", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": obj.get("token"),
            "user": AcceptInvite201ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
