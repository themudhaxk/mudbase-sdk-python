...
class WebPushSubscriptionListResponse(BaseModel):
    """
    WebPushSubscriptionListResponse
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[WebPushSubscriptionSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [WebPushSubscriptionSummary.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
