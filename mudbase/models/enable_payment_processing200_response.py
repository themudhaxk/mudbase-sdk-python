...
class EnablePaymentProcessing200Response(BaseModel):
    """
    EnablePaymentProcessing200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    data: Optional[EnablePaymentProcessing200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": EnablePaymentProcessing200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
