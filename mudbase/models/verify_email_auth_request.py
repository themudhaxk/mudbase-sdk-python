...
class VerifyEmailAuthRequest(BaseModel):
    """
    VerifyEmailAuthRequest
    """ # noqa: E501
    token: StrictStr = Field(description="Verification token from the email link")
    project_id: Optional[StrictStr] = Field(default=None, description="Optional; for project signup context (redirect hint)", alias="projectId")
    __properties: ClassVar[List[str]] = ["token", "projectId"]
