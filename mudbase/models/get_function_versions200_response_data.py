...
class GetFunctionVersions200ResponseData(BaseModel):
    """
    GetFunctionVersions200ResponseData
    """ # noqa: E501
    versions: Optional[List[GetFunctionVersions200ResponseDataVersionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [GetFunctionVersions200ResponseDataVersionsInner.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
