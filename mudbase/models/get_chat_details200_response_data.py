...
class GetChatDetails200ResponseData(BaseModel):
    """
    GetChatDetails200ResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    name: Optional[StrictStr] = None
    participants: Optional[List[GetChatDetails200ResponseDataParticipantsInner]] = None
    __properties: ClassVar[List[str]] = ["_id", "name", "participants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "name": obj.get("name"),
            "participants": [GetChatDetails200ResponseDataParticipantsInner.from_dict(_item) for _item in obj["participants"]] if obj.get("participants") is not None else None
        })
        return _obj
