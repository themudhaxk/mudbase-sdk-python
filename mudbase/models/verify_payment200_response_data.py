...
class VerifyPayment200ResponseData(BaseModel):
    """
    VerifyPayment200ResponseData
    """ # noqa: E501
    subscription: Optional[VerifyPayment200ResponseDataSubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscription": VerifyPayment200ResponseDataSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
