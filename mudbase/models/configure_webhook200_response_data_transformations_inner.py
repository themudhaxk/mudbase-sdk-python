...
class ConfigureWebhook200ResponseDataTransformationsInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['jsonPath', 'template', 'fieldMap', 'filter', 'flatten', 'version']):
            raise ValueError("must be one of enum values ('jsonPath', 'template', 'fieldMap', 'filter', 'flatten', 'version')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigureWebhook200ResponseDataTransformationsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigureWebhook200ResponseDataTransformationsInner from a dict"""
        if obj is None:
            return None
