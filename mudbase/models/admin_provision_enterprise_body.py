...
class AdminProvisionEnterpriseBody(BaseModel):
    """
    AdminProvisionEnterpriseBody
    """ # noqa: E501
    provision_request_id: StrictStr = Field(alias="provisionRequestId")
    api_base_url: StrictStr = Field(alias="apiBaseUrl")
    db_ref: StrictStr = Field(alias="dbRef")
    server_id: StrictStr = Field(alias="serverId")
    region: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    force_override: Optional[StrictBool] = Field(default=None, alias="forceOverride")
    __properties: ClassVar[List[str]] = ["provisionRequestId", "apiBaseUrl", "dbRef", "serverId", "region", "version", "forceOverride"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "provisionRequestId": obj.get("provisionRequestId"),
