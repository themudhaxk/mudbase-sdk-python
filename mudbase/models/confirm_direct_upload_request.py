...
class ConfirmDirectUploadRequest(BaseModel):
    """
    ConfirmDirectUploadRequest
    """ # noqa: E501
    key: StrictStr = Field(description="The object key returned when the presigned PUT URL was issued")
    ...
    __properties: ClassVar[List[str]] = ["key", "projectId", "originalName", "contentType", "size", "bucket", "isPublic"]
