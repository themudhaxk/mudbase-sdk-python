...
class FunctionExecutionStatusResponse(BaseModel):
    """
    FunctionExecutionStatusResponse
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[FunctionExecutionStatusResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FunctionExecutionStatusResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
