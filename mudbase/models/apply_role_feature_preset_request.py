...
class ApplyRoleFeaturePresetRequest(BaseModel):
    """
    ...
    def preset_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['admin', 'user', 'viewer']):
            raise ValueError("must be one of enum values ('admin', 'user', 'viewer')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplyRoleFeaturePresetRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplyRoleFeaturePresetRequest from a dict"""
        if obj is None:
            return None
