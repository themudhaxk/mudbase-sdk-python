...
class ApproveRoleElevationRequest(BaseModel):
    """
    ApproveRoleElevationRequest
    """ # noqa: E501
    approved: StrictBool
    reason: Optional[StrictStr] = Field(default=None, description="Required if approved is false")
    __properties: ClassVar[List[str]] = ["approved", "reason"]
