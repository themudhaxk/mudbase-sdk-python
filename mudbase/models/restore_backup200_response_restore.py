...
class RestoreBackup200ResponseRestore(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "status", "restoreMode", "startedAt", "estimatedCompletion"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['in_progress', 'completed', 'failed']):
