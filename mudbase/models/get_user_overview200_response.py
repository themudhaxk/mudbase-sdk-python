...
class GetUserOverview200Response(BaseModel):
    """
    GetUserOverview200Response
    """ # noqa: E501
    user: Optional[Dict[str, Any]] = Field(default=None, description="User profile (metadata only)")
    footprint: Optional[GetUserOverview200ResponseFootprint] = None
    __properties: ClassVar[List[str]] = ["user", "footprint"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": obj.get("user"),
            "footprint": GetUserOverview200ResponseFootprint.from_dict(obj["footprint"]) if obj.get("footprint") is not None else None
        })
        return _obj
