...
class EraseUserData409Response(BaseModel):
    """
    EraseUserData409Response
    """ # noqa: E501
    error: Optional[StrictStr] = None
    sole_owned_orgs: Optional[List[StrictStr]] = Field(default=None, alias="soleOwnedOrgs")
    __properties: ClassVar[List[str]] = ["error", "soleOwnedOrgs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": obj.get("error"),
            "soleOwnedOrgs": obj.get("soleOwnedOrgs")
        })
        return _obj
