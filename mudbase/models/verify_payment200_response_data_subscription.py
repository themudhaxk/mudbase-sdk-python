...
class VerifyPayment200ResponseDataSubscription(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "status", "plan", "currentPeriodEnd"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'cancelled', 'past_due']):
            raise ValueError("must be one of enum values ('active', 'cancelled', 'past_due')")
        return value
