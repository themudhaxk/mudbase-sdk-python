...
class WebPushPublicKeyResponseData(BaseModel):
    """
    WebPushPublicKeyResponseData
    """ # noqa: E501
    enabled: Optional[StrictBool] = None
    public_key: Optional[StrictStr] = Field(default=None, description="The VAPID application-server public key, or null when native Web Push is not enabled. ", alias="publicKey")
    __properties: ClassVar[List[str]] = ["enabled", "publicKey"]
