...
class GetUsageStats200ResponseStats(BaseModel):
    """
    GetUsageStats200ResponseStats
    """ # noqa: E501
    total_calls: Optional[StrictInt] = Field(default=None, alias="totalCalls")
    success_calls: Optional[StrictInt] = Field(default=None, alias="successCalls")
    failed_calls: Optional[StrictInt] = Field(default=None, alias="failedCalls")
    __properties: ClassVar[List[str]] = ["totalCalls", "successCalls", "failedCalls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalCalls": obj.get("totalCalls"),
            "successCalls": obj.get("successCalls"),
