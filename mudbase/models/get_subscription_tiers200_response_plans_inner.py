...
class GetSubscriptionTiers200ResponsePlansInner(BaseModel):
    ...
    price_yearly: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Yearly price in cents (2 months free, ~16.67% off)", alias="priceYearly")
    currency: Optional[StrictStr] = None
    price_id: Optional[StrictStr] = Field(default=None, alias="priceId")
    limits: Optional[Dict[str, Any]] = None
    overages: Optional[Dict[str, Any]] = None
    enforcement: Optional[Dict[str, Any]] = Field(default=None, description="Per-resource enforcement (blocking, billing_only, etc.)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": obj.get("price"),
            "priceYearly": obj.get("priceYearly"),
            "currency": obj.get("currency"),
            "priceId": obj.get("priceId"),
            "limits": obj.get("limits"),
            "overages": obj.get("overages"),
