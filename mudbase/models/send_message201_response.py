...
class SendMessage201Response(BaseModel):
    """
    SendMessage201Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[SendMessage201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SendMessage201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
