...
class GetActiveUsers200ResponseUsersInner(BaseModel):
    """
    GetActiveUsers200ResponseUsersInner
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    connected_at: Optional[datetime] = Field(default=None, alias="connectedAt")
    socket_id: Optional[StrictStr] = Field(default=None, alias="socketId")
    __properties: ClassVar[List[str]] = ["userId", "connectedAt", "socketId"]
