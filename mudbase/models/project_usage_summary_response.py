...
class ProjectUsageSummaryResponse(BaseModel):
    ...
    data: Optional[Dict[str, Any]] = Field(default=None, description="Contains requests, activeUsers, requestVolume14d, latency, platformUptimePct30d, platformUptimeSamples")
