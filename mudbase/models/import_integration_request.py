...
class ImportIntegrationRequest(BaseModel):
    """
    ImportIntegrationRequest
    """ # noqa: E501
    integration_data: Dict[str, Any] = Field(alias="integrationData")
    __properties: ClassVar[List[str]] = ["integrationData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportIntegrationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportIntegrationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "integrationData": obj.get("integrationData")
        })
        return _obj
