...
class MonitoringAnalyticsResponseTotals(BaseModel):
    """
    MonitoringAnalyticsResponseTotals
    """ # noqa: E501
    total_api_calls: Optional[StrictInt] = Field(default=None, alias="totalApiCalls")
    total_db_reads: Optional[StrictInt] = Field(default=None, alias="totalDbReads")
    total_db_writes: Optional[StrictInt] = Field(default=None, alias="totalDbWrites")
    total_storage: Optional[StrictInt] = Field(default=None, alias="totalStorage")
    total_bandwidth: Optional[StrictInt] = Field(default=None, alias="totalBandwidth")
    __properties: ClassVar[List[str]] = ["totalApiCalls", "totalDbReads", "totalDbWrites", "totalStorage", "totalBandwidth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalApiCalls": obj.get("totalApiCalls"),
            "totalDbReads": obj.get("totalDbReads"),
            "totalDbWrites": obj.get("totalDbWrites"),
            "totalStorage": obj.get("totalStorage"),
            "totalBandwidth": obj.get("totalBandwidth")
        })
        return _obj
