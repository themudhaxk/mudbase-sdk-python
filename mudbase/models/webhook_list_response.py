...
class WebhookListResponse(BaseModel):
    ...
    WebhookListResponse
    """ # noqa: E501
    webhooks: Optional[List[WebhookLog]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    limit: Optional[StrictInt] = None
    total_pages: Optional[StrictInt] = Field(default=None, alias="totalPages")
    __properties: ClassVar[List[str]] = ["webhooks", "total", "page", "limit", "totalPages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [WebhookLog.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
