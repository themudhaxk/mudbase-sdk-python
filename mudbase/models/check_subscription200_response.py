...
class CheckSubscription200Response(BaseModel):
    """
    CheckSubscription200Response
    """ # noqa: E501
    has_subscription: Optional[StrictBool] = Field(default=None, alias="hasSubscription")
    subscription: Optional[CheckSubscription200ResponseSubscription] = None
    __properties: ClassVar[List[str]] = ["hasSubscription", "subscription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscription": CheckSubscription200ResponseSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
