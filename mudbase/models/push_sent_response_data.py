...
class PushSentResponseData(BaseModel):
    """
    PushSentResponseData
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="True when at least one recipient across any channel was delivered to.")
    ...
    channels: Optional[PushSentResponseDataChannels] = None
    rejected_tokens: Optional[List[StrictStr]] = Field(default=None, description="Device tokens that were passed but are not registered to the project, and so were dropped. Omitted when empty. ", alias="rejectedTokens")
    __properties: ClassVar[List[str]] = ["success", "messageId", "successCount", "failureCount", "channels", "rejectedTokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "channels": PushSentResponseDataChannels.from_dict(obj["channels"]) if obj.get("channels") is not None else None,
            "rejectedTokens": obj.get("rejectedTokens")
        })
        return _obj
