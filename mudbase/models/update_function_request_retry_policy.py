...
class UpdateFunctionRequestRetryPolicy(BaseModel):
    """
    UpdateFunctionRequestRetryPolicy
    """ # noqa: E501
    enabled: Optional[StrictBool] = None
    max_retries: Optional[StrictInt] = Field(default=None, alias="maxRetries")
    backoff_ms: Optional[StrictInt] = Field(default=None, alias="backoffMs")
    __properties: ClassVar[List[str]] = ["enabled", "maxRetries", "backoffMs"]
