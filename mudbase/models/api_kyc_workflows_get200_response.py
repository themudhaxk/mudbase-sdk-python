...
class ApiKycWorkflowsGet200Response(BaseModel):
    """
    ApiKycWorkflowsGet200Response
    """ # noqa: E501
    workflows: Optional[List[ApiKycWorkflowsGet200ResponseWorkflowsInner]] = None
    kyc: Optional[List[Dict[str, Any]]] = None
    kyb: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["workflows", "kyc", "kyb"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workflows": [ApiKycWorkflowsGet200ResponseWorkflowsInner.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None,
            "kyc": obj.get("kyc"),
            "kyb": obj.get("kyb")
        })
        return _obj
