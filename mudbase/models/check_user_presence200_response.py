...
class CheckUserPresence200Response(BaseModel):
    """
    CheckUserPresence200Response
    """ # noqa: E501
    presence: Optional[Dict[str, CheckUserPresence200ResponsePresenceValue]] = None
    timestamp: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["presence", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "presence": dict(
                (_k, CheckUserPresence200ResponsePresenceValue.from_dict(_v))
